...
Internal use only.
    ...
    def __recv(self, timeout):
        try:
            ...
            if len(rsocks) == 0: return # select will throw an exception on windows if given empty args
    ...
    def __toggle_broadcast(self, v):
        if v == 3 and self.broadcast == None:
            ...
            addr = '' if _os.name == "nt" else "<broadcast>"
            self.broadcast.bind((addr, 8500 + self.__port_offset))
