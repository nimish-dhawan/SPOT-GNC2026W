...
if isempty(file) || strcmp(file," ")
    ...
    dat = load("VIS_GNC_Success_2_2.mat");
end
...
addpath 'C:\Users\sukri\OneDrive\Documents\SPOT-GNC2026W\Projects\GNC2026W\Saved Data\VIS_GNC_Success_2';
dat = load("VIS_GNC_Success_2_2.mat");
t = dat.dataClass_rt.Time_s;
[time,inds,~] = unique(t);
...
load('VIS_GNC_Success_2_2.mat');
subplot(3,1,1)
plot(dataClass_rt.isValid.Time,dataClass_rt.isValid.Data,'r')
% title('Measurement Validity')
ylabel('Validity Flag')
ylim([0 1.5])
ax = gca();
ax.FontSize = 10;
ax.FontName = "Times New Roman";
...
subplot(3,1,2)
plot(dataClass_rt.filterConfidence.Time,dataClass_rt.filterConfidence.Data, 'r')
% title('Filter Confidence')
ylabel('Confidence Flag')
ylim([0 1.5])
ax = gca();
ax.FontSize = 10;
ax.FontName = "Times New Roman";
...
subplot(3,1,3)
plot(dataClass_rt.RED_Control_Law_Enabler.Time,dataClass_rt.RED_Control_Law_Enabler.Data, 'r')
% title('Control Mode')
ylabel('Control Mode')
ylim([0 3.5])
%ylabel('Pose'); xlabel('Time [s]')
