###########################################################################
## Makefile generated for component 'SPOTSim_UKE_V4_1_DataReceiverOnly'. 
## 
## Makefile     : SPOTSim_UKE_V4_1_DataReceiverOnly.mk
## Generated on : Mon Jan 12 12:30:58 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SPOTSim_UKE_V4_1_DataReceiverOnly.elf
...
PRODUCT_NAME              = SPOTSim_UKE_V4_1_DataReceiverOnly
MAKEFILE                  = SPOTSim_UKE_V4_1_DataReceiverOnly.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SPOTSim_UKE_V4_1_DataReceiverOnly.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/include -I$(START_DIR)/SPOTSim_UKE_V4_1_DataReceiverOnly_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/nvidia/include -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/nvidia/sources/utils -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_STANDARD = -DMODEL=SPOTSim_UKE_V4_1_DataReceiverOnly -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = DAHostLib_Network.c.o DAHostLib_rtw.c.o SPOTSim_UKE_V4_1_DataReceiverOnly.cpp.o SPOTSim_UKE_V4_1_DataReceiverOnly_data.cpp.o rtGetInf.cpp.o rtGetNaN.cpp.o rt_nonfinite.cpp.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o MW_nvidia_init.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o linuxinitialize.cpp.o linuxUDP.c.o
...
%.c.o : $(START_DIR)/SPOTSim_UKE_V4_1_DataReceiverOnly_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/SPOTSim_UKE_V4_1_DataReceiverOnly_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/SPOTSim_UKE_V4_1_DataReceiverOnly_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.cpp.o : $(START_DIR)/SPOTSim_UKE_V4_1_DataReceiverOnly_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


SPOTSim_UKE_V4_1_DataReceiverOnly.cpp.o : $(START_DIR)/SPOTSim_UKE_V4_1_DataReceiverOnly_ert_rtw/SPOTSim_UKE_V4_1_DataReceiverOnly.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


SPOTSim_UKE_V4_1_DataReceiverOnly_data.cpp.o : $(START_DIR)/SPOTSim_UKE_V4_1_DataReceiverOnly_ert_rtw/SPOTSim_UKE_V4_1_DataReceiverOnly_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetInf.cpp.o : $(START_DIR)/SPOTSim_UKE_V4_1_DataReceiverOnly_ert_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetNaN.cpp.o : $(START_DIR)/SPOTSim_UKE_V4_1_DataReceiverOnly_ert_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.cpp.o : $(START_DIR)/SPOTSim_UKE_V4_1_DataReceiverOnly_ert_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
