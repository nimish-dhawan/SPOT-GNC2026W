...
struct DW_ChangeBLACKBehavior_GNC202_T {
  real_T UDPSend_NetworkLib[137];      // '<S206>/UDP Send'
};

// Block states (default storage) for system '<S256>/Change BLACK Behavior'
struct DW_ChangeBLACKBehavior_GNC2_l_T {
  real_T UDPSendGUI_NetworkLib[137];   // '<S257>/UDP Send (GUI)'
};

// Block signals for system '<S262>/Enabled Subsystem'
struct B_EnabledSubsystem_GNC2026W_T {
  real_T Delay[3];                     // '<S277>/Delay'
  real_T ema[3];                       // '<S277>/MATLAB Function'
};

// Block states (default storage) for system '<S262>/Enabled Subsystem'
struct DW_EnabledSubsystem_GNC2026W_T {
  real_T Delay_DSTATE[3];              // '<S277>/Delay'
  boolean_T EnabledSubsystem_MODE;     // '<S262>/Enabled Subsystem'
};

// Block signals for system '<S263>/Enabled Subsystem'
struct B_EnabledSubsystem_GNC2026W_h_T {
  real_T Delay[3];                     // '<S279>/Delay'
  real_T ema[3];                       // '<S279>/MATLAB Function'
};

// Block states (default storage) for system '<S263>/Enabled Subsystem'
struct DW_EnabledSubsystem_GNC2026_c_T {
  real_T Delay_DSTATE[3];              // '<S279>/Delay'
  boolean_T EnabledSubsystem_MODE;     // '<S263>/Enabled Subsystem'
};

// Block signals for system '<S317>/Pseudoinverse1'
struct B_Pseudoinverse1_GNC2026W_T {
  real_T Pseudoinverse1[24];           // '<S317>/Pseudoinverse1'
};

// Block states (default storage) for system '<S317>/Pseudoinverse1'
struct DW_Pseudoinverse1_GNC2026W_T {
  dsp_simulink_Pseudoinverse_GN_T obj; // '<S317>/Pseudoinverse1'
  boolean_T objisempty;                // '<S317>/Pseudoinverse1'
};

// Block signals for system '<S19>/Change BLACK Behavior'
struct B_ChangeBLACKBehavior_GNC20_m_T {
  real_T Clock1;                       // '<S350>/Clock1'
};

// Block states (default storage) for system '<S19>/Change BLACK Behavior'
struct DW_ChangeBLACKBehavior_GNC2_g_T {
  real_T UDPSendClock_NetworkLib[137]; // '<S350>/UDP Send (Clock)'
};
...
struct B_GNC2026W_T {
  ...
  real_T duty_cycles[8];               // '<S338>/MATLAB Function5'
  real_T ThrustPer_Final[8];           // '<S346>/ThrustPer_Final'
  real_T In1;                          // '<S345>/In1'
  real_T duty_cycles_j[8];             // '<S326>/MATLAB Function5'
  real_T ThrustPer_Final_h[8];         // '<S334>/ThrustPer_Final'
  real_T In1_g;                        // '<S333>/In1'
  real_T duty_cycles_m[8];             // '<S314>/MATLAB Function5'
  real_T ThrustPer_Final_h5[8];        // '<S322>/ThrustPer_Final'
  real_T In1_g2;                       // '<S321>/In1'
  real_T TmpSignalConversionAtUDPSendI_o[2];
  real_T TmpSignalConversionAtUDPSend_og[28];
  real_T ReceivePhaseSpaceData_o1[19]; // '<S248>/Receive PhaseSpace Data'
  real_T ConvertBLAXfrommmtom;        // '<S249>/Convert BLAX from [mm] to [m]'
  real_T ConvertBLUXfrommmtom;        // '<S250>/Convert BLUX from [mm] to [m]'
  real_T ConvertREDXfrommmtom;        // '<S251>/Convert REDX from [mm] to [m]'
  real_T UDPReceiveREDClock_o1;        // '<S252>/UDP Receive (RED Clock)'
  real_T UDPReceiveBLACKClock_o1;      // '<S252>/UDP Receive (BLACK Clock)'
  real_T UDPReceiveBLUEClock_o1;       // '<S252>/UDP Receive (BLUE Clock)'
  real_T dy[3];                        // '<S299>/MATLAB Function'
  real_T dy_h[3];                      // '<S297>/MATLAB Function'
  real_T y2y1;                         // '<S295>/y2-y1'
  real_T dy_c[3];                      // '<S289>/MATLAB Function'
  real_T dy_d[3];                      // '<S287>/MATLAB Function'
  real_T y2y1_o;                       // '<S285>/y2-y1'
  real_T dy_p[3];                      // '<S279>/MATLAB Function'
  real_T dy_g[3];                      // '<S277>/MATLAB Function'
  real_T y;                            // '<S275>/MATLAB Function'
  real_T u_next;                       // '<S275>/MATLAB Function'
  real_T y2y1_ob;                      // '<S265>/y2-y1'
  real_T In1_g20;                      // '<S253>/In1'
  real_T Merge_k[6];                   // '<S218>/Merge'
  real_T Merge_d[3];                   // '<S230>/Merge'
  real_T Merge_b[3];                   // '<S239>/Merge'
  real_T In1_g20a[3];                  // '<S141>/In1'
  real32_T UDPReceive_o1;              // '<S304>/UDP Receive'
  real32_T UDPReceive_o1_a[4];         // '<S302>/UDP Receive'
  uint8_T StringtoASCII[31];           // '<S215>/String to ASCII'
  uint8_T StringtoASCII2[31];          // '<S214>/String to ASCII2'
  uint8_T StringtoASCII1[31];          // '<S213>/String to ASCII1'
  ...
  B_Pseudoinverse1_GNC2026W_T Pseudoinverse1_pn;// '<S317>/Pseudoinverse1'
  B_Pseudoinverse1_GNC2026W_T Pseudoinverse1_p;// '<S317>/Pseudoinverse1'
  B_Pseudoinverse1_GNC2026W_T Pseudoinverse1;// '<S317>/Pseudoinverse1'
  B_EnabledSubsystem_GNC2026W_h_T EnabledSubsystem_l1;// '<S293>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_T EnabledSubsystem_k;// '<S292>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_h_T EnabledSubsystem_d;// '<S283>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_T EnabledSubsystem_l;// '<S282>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_h_T EnabledSubsystem_g;// '<S263>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_T EnabledSubsystem_i;// '<S262>/Enabled Subsystem' 
};
...
struct DW_GNC2026W_T {
  ...
  GPIO_Write_GNC2026W_T obj_l;         // '<S216>/GPIO Write1'
  ReadArm_Position_Rates_GNC202_T obj_d;
                     // '<S217>/Read Joint Positions using  Dynamixel Encoders'
  IdentifyPlatform_GNC2026W_T obj_dk;  // '<S301>/WhoAmI'
  CustomDataLogger_GNC2026W_T obj_f;   // '<S209>/MATLAB System'
  real_T Delay_DSTATE;                 // '<S340>/Delay'
  real_T Delay_DSTATE_k;               // '<S328>/Delay'
  real_T Delay_DSTATE_kz;              // '<S316>/Delay'
  real_T Delay2_DSTATE;                // '<S260>/Delay2'
  real_T Delay1_DSTATE;                // '<S260>/Delay1'
  real_T Delay1_DSTATE_g[3];           // '<S263>/Delay1'
  real_T Delay1_DSTATE_b[3];           // '<S262>/Delay1'
  real_T Delay_DSTATE_h;               // '<S275>/Delay'
  real_T Delay1_DSTATE_f;              // '<S275>/Delay1'
  real_T Delay2_DSTATE_l;              // '<S281>/Delay2'
  real_T Delay1_DSTATE_l;              // '<S281>/Delay1'
  real_T Delay1_DSTATE_m[3];           // '<S283>/Delay1'
  real_T Delay1_DSTATE_lv[3];          // '<S282>/Delay1'
  real_T Delay2_DSTATE_l0;             // '<S291>/Delay2'
  real_T Delay1_DSTATE_ld;             // '<S291>/Delay1'
  real_T Delay1_DSTATE_c[3];           // '<S293>/Delay1'
  real_T Delay1_DSTATE_cq[3];          // '<S292>/Delay1'
  real_T Delay_DSTATE_c;               // '<S225>/Delay'
  real_T Delay1_DSTATE_g0;             // '<S225>/Delay1'
  real_T Delay_DSTATE_j;               // '<S231>/Delay'
  real_T Delay1_DSTATE_d;              // '<S231>/Delay1'
  real_T Delay_DSTATE_b;               // '<S240>/Delay'
  real_T Delay1_DSTATE_a;              // '<S240>/Delay1'
  real_T Delay_DSTATE_o;               // '<S217>/Delay'
  real_T Delay1_DSTATE_cg;             // '<S217>/Delay1'
  real_T Delay2_DSTATE_h;              // '<S217>/Delay2'
  real_T UD_DSTATE;                    // '<S188>/UD'
  real_T UD_DSTATE_e;                  // '<S189>/UD'
  real_T UD_DSTATE_a;                  // '<S190>/UD'
  real_T UD_DSTATE_l;                  // '<S174>/UD'
  real_T UD_DSTATE_k;                  // '<S175>/UD'
  real_T UD_DSTATE_h;                  // '<S176>/UD'
  real_T UD_DSTATE_o;                  // '<S197>/UD'
  real_T UD_DSTATE_n;                  // '<S198>/UD'
  real_T UD_DSTATE_hu;                 // '<S199>/UD'
  real_T UD_DSTATE_j;                  // '<S169>/UD'
  real_T UD_DSTATE_c;                  // '<S170>/UD'
  real_T UD_DSTATE_d;                  // '<S171>/UD'
  real_T UD_DSTATE_eh;                 // '<S192>/UD'
  real_T UD_DSTATE_hv;                 // '<S193>/UD'
  real_T UD_DSTATE_kv;                 // '<S194>/UD'
  real_T Delay_DSTATE_l;               // '<S165>/Delay'
  real_T Delay1_DSTATE_ba;             // '<S165>/Delay1'
  real_T Delay_DSTATE_c5;              // '<S164>/Delay'
  real_T Delay1_DSTATE_ag;             // '<S164>/Delay1'
  real_T UD_DSTATE_aq;                 // '<S179>/UD'
  real_T UD_DSTATE_p;                  // '<S180>/UD'
  real_T UD_DSTATE_pr;                 // '<S181>/UD'
  real_T UD_DSTATE_eg;                 // '<S202>/UD'
  real_T UD_DSTATE_cd;                 // '<S203>/UD'
  real_T UD_DSTATE_hd;                 // '<S204>/UD'
  real_T Delay_DSTATE_h0;              // '<S142>/Delay'
  real_T Delay1_DSTATE_lo;             // '<S142>/Delay1'
  creal_T q;                           // '<S220>/MEKF'
  ...
  real_T L_act;                        // '<Root>/Data Store Memory5'
  ...
  real_T UDPSend_NetworkLib_f[137];    // '<S308>/UDP Send'
  real_T set;                          // '<S308>/MATLAB Function'
  real_T UDPSend_NetworkLib_m[137];    // '<S307>/UDP Send'
  real_T UDPReceive_NetworkLib[137];   // '<S304>/UDP Receive'
  real_T UDPReceive_NetworkLib_i[137]; // '<S302>/UDP Receive'
  real_T ReceivePhaseSpaceData_NetworkLi[137];// '<S248>/Receive PhaseSpace Data' 
  real_T UDPReceiveREDClock_NetworkLib[137];// '<S252>/UDP Receive (RED Clock)'
  real_T UDPReceiveBLACKClock_NetworkLib[137];// '<S252>/UDP Receive (BLACK Clock)' 
  real_T UDPReceiveBLUEClock_NetworkLib[137];// '<S252>/UDP Receive (BLUE Clock)' 
  real_T k;                            // '<S261>/Sample and Hold'
  real_T y_hold[3];                    // '<S261>/Sample and Hold'
  real_T k_h;                          // '<S267>/MATLAB Function1'
  real_T x[6];                         // '<S219>/EKF'
  real_T P[36];                        // '<S219>/EKF'
  real_T theta;                        // '<S219>/EKF'
  real_T theta_prev;                   // '<S219>/EKF'
  real_T x_m[5];                       // '<S220>/MEKF'
  real_T P_h[36];                      // '<S220>/MEKF'
  real_T theta_prev_a;                 // '<S220>/MEKF'
  real_T theta_cont;                   // '<S220>/MEKF'
  real_T converge;                     // '<S220>/MEKF'
  real_T k_i;                          // '<S220>/MEKF'
  real_T converge_j;                   // '<S221>/Unscented Kalman Filter'
  real_T x_i[6];                       // '<S221>/Unscented Kalman Filter'
  real_T P_f[36];                      // '<S221>/Unscented Kalman Filter'
  real_T k_c;                          // '<S221>/Unscented Kalman Filter'
  real_T UDPSend3_NetworkLib[137];     // '<S215>/UDP Send3'
  real_T UDPSend2_NetworkLib[137];     // '<S214>/UDP Send2'
  real_T UDPSend1_NetworkLib[137];     // '<S213>/UDP Send1'
  real_T l1;                           // '<S149>/MATLAB Function2'
  real_T l2;                           // '<S149>/MATLAB Function2'
  real_T x_k[3];                       // '<S149>/MATLAB Function2'
  real_T P_i[9];                       // '<S149>/MATLAB Function2'
  ...
  uint32_T method;                     // '<S261>/CV Noise'
  uint32_T state;                      // '<S261>/CV Noise'
  uint32_T state_g[2];                 // '<S261>/CV Noise'
  uint32_T state_j[625];               // '<S261>/CV Noise'
  ...
  // '<S256>/This IF block determines whether or not to run the BLACK sim//exp'
  int8_T ThisIFblockdetermineswhether_cs;
  // '<S256>/This IF block determines whether or not to run the BLUE sim//exp'
  int8_T ThisIFblockdetermineswhethero_d;
  // '<S256>/This IF block determines whether or not to run the RED sim//exp '
  boolean_T k_not_empty;               // '<S261>/Sample and Hold'
  boolean_T initial_theta;             // '<S219>/EKF'
  boolean_T x_not_empty;               // '<S149>/MATLAB Function2'
  ...
  DW_Pseudoinverse1_GNC2026W_T Pseudoinverse1_pn;// '<S317>/Pseudoinverse1'
  DW_Pseudoinverse1_GNC2026W_T Pseudoinverse1_p;// '<S317>/Pseudoinverse1'
  DW_Pseudoinverse1_GNC2026W_T Pseudoinverse1;// '<S317>/Pseudoinverse1'
  DW_EnabledSubsystem_GNC2026_c_T EnabledSubsystem_l1;// '<S293>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026W_T EnabledSubsystem_k;// '<S292>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026_c_T EnabledSubsystem_d;// '<S283>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026W_T EnabledSubsystem_l;// '<S282>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026_c_T EnabledSubsystem_g;// '<S263>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026W_T EnabledSubsystem_i;// '<S262>/Enabled Subsystem' 
  DW_ChangeBLACKBehavior_GNC2_l_T ChangeREDBehavior_d;// '<S256>/Change RED Behavior' 
  DW_ChangeBLACKBehavior_GNC2_l_T ChangeBLUEBehavior_f;// '<S256>/Change BLUE Behavior' 
  DW_ChangeBLACKBehavior_GNC2_l_T ChangeBLACKBehavior_e;// '<S256>/Change BLACK Behavior' 
...
struct P_GNC2026W_T_ {
  ...
  P_EnabledSubsystem_GNC2026W_c_T EnabledSubsystem_l1;// '<S293>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_T EnabledSubsystem_k;// '<S292>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_c_T EnabledSubsystem_d;// '<S283>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_T EnabledSubsystem_l;// '<S282>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_c_T EnabledSubsystem_g;// '<S263>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_T EnabledSubsystem_i;// '<S262>/Enabled Subsystem' 
  P_ChangeBLACKBehavior_GNC20_p_T ChangeREDBehavior_d;// '<S256>/Change RED Behavior' 
  P_ChangeBLACKBehavior_GNC20_p_T ChangeBLUEBehavior_f;// '<S256>/Change BLUE Behavior' 
  P_ChangeBLACKBehavior_GNC20_p_T ChangeBLACKBehavior_e;// '<S256>/Change BLACK Behavior' 
...
//  Block '<S218>/Scope1' : Unused code path elimination
//  Block '<S221>/Scope3' : Unused code path elimination
...
//  Block '<S261>/Scope4' : Unused code path elimination
...
//  Block '<S308>/Scope4' : Unused code path elimination
//  Block '<S308>/Scope5' : Unused code path elimination
...
//  Block '<S308>/Data Type Conversion1' : Eliminate redundant data type conversion
...
//  '<S77>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Red Control Logic/If Action Subsystem'
//  '<S78>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Red Control Logic/If Action Subsystem1'
//  '<S79>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Red Control Logic/If Action Subsystem2'
//  '<S80>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Red Control Logic/If Action Subsystem3'
//  '<S81>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Red Control Logic/If Action Subsystem4'
//  '<S82>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Red Control Logic/If Action Subsystem5'
//  '<S83>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Joint Angles RED'
//  '<S84>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK'
//  '<S85>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLUE'
//  '<S86>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED'
//  '<S87>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK/BLACK_Rz Desired'
//  '<S88>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK/Subsystem'
//  '<S89>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK/Wrap'
//  '<S90>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK/BLACK_Rz Desired/Subsystem'
//  '<S91>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK/Subsystem/Subsystem'
//  '<S92>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK/Subsystem/Subsystem1'
//  '<S93>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLUE/Calculate Circular Tracking'
//  '<S94>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLUE/Calculate Time since Phase #3 Start'
//  '<S95>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLUE/Wrap'
//  '<S96>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLUE/Calculate Time since Phase #3 Start/Subsystem'
//  '<S97>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED/Calculate Circular Tracking'
//  '<S98>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED/Calculate Time since Phase #3 Start'
//  '<S99>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED/Stand-off Distance'
//  '<S100>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED/Wrap'
//  '<S101>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED/Calculate Time since Phase #3 Start/Subsystem'
//  '<S102>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Joint Angles RED'
//  '<S103>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLACK'
//  '<S104>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLUE'
//  '<S105>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED'
//  '<S106>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLACK/BLACK_Rz Desired'
//  '<S107>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLACK/Wrap'
//  '<S108>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLACK/BLACK_Rz Desired/Subsystem'
//  '<S109>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLUE/Calculate Circular Tracking'
//  '<S110>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLUE/Calculate Time since Phase #3 Start'
//  '<S111>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLUE/Wrap'
//  '<S112>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLUE/Calculate Time since Phase #3 Start/Subsystem'
//  '<S113>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED/Calculate Circular Tracking'
//  '<S114>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED/Calculate Time since Phase #3 Start'
//  '<S115>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED/Stand-off Distance'
//  '<S116>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED/Wrap'
//  '<S117>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED/Calculate Time since Phase #3 Start/Subsystem'
//  '<S118>' : 'GNC2026W/1 - Experiment Logic/Phase #4: Return Home/Desired Joint Angles RED'
//  '<S119>' : 'GNC2026W/1 - Experiment Logic/Phase #4: Return Home/Desired Position BLACK'
//  '<S120>' : 'GNC2026W/1 - Experiment Logic/Phase #4: Return Home/Desired Position BLUE'
//  '<S121>' : 'GNC2026W/1 - Experiment Logic/Phase #4: Return Home/Desired Position RED'
//  '<S122>' : 'GNC2026W/1 - Experiment Logic/Phase #5: Hold Home/Desired Joint Angles RED'
//  '<S123>' : 'GNC2026W/1 - Experiment Logic/Phase #5: Hold Home/Desired Position BLACK'
//  '<S124>' : 'GNC2026W/1 - Experiment Logic/Phase #5: Hold Home/Desired Position BLUE'
//  '<S125>' : 'GNC2026W/1 - Experiment Logic/Phase #5: Hold Home/Desired Position RED'
//  '<S126>' : 'GNC2026W/2 - Guidance/Custom PPL (ARM)'
//  '<S127>' : 'GNC2026W/2 - Guidance/Custom PPL (BLACK)'
//  '<S128>' : 'GNC2026W/2 - Guidance/Custom PPL (BLUE)'
//  '<S129>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)'
//  '<S130>' : 'GNC2026W/2 - Guidance/Disable PPL (ARM)'
//  '<S131>' : 'GNC2026W/2 - Guidance/Disable PPL (BLACK)'
//  '<S132>' : 'GNC2026W/2 - Guidance/Disable PPL (BLUE)'
//  '<S133>' : 'GNC2026W/2 - Guidance/Disable PPL (RED)'
//  '<S134>' : 'GNC2026W/2 - Guidance/Custom PPL (ARM)/Desired Position'
//  '<S135>' : 'GNC2026W/2 - Guidance/Custom PPL (BLACK)/Desired Position'
//  '<S136>' : 'GNC2026W/2 - Guidance/Custom PPL (BLUE)/Desired Position'
//  '<S137>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Grab Logic'
//  '<S138>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/LOS Calculation'
//  '<S139>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/MATLAB Function4'
//  '<S140>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Unwrap1'
//  '<S141>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Grab Logic/Enabled Subsystem'
//  '<S142>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Unwrap1/Unwrap'
//  '<S143>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Unwrap1/Unwrap/MATLAB Function'
//  '<S144>' : 'GNC2026W/2 - Guidance/Disable PPL (ARM)/Desired Position'
//  '<S145>' : 'GNC2026W/2 - Guidance/Disable PPL (BLACK)/Desired Position'
//  '<S146>' : 'GNC2026W/2 - Guidance/Disable PPL (BLUE)/Desired Position'
//  '<S147>' : 'GNC2026W/2 - Guidance/Disable PPL (RED)/Desired Position'
//  '<S148>' : 'GNC2026W/3 - Control/Custom Control (ARM)'
//  '<S149>' : 'GNC2026W/3 - Control/Custom Control (RED)'
//  '<S150>' : 'GNC2026W/3 - Control/Default LQR Control (BLACK)'
//  '<S151>' : 'GNC2026W/3 - Control/Default LQR Control (BLUE)'
//  '<S152>' : 'GNC2026W/3 - Control/Default LQR Control (RED)'
//  '<S153>' : 'GNC2026W/3 - Control/Default PD (ARM)'
//  '<S154>' : 'GNC2026W/3 - Control/Default PD Control (BLACK)'
//  '<S155>' : 'GNC2026W/3 - Control/Default PD Control (BLUE)'
//  '<S156>' : 'GNC2026W/3 - Control/Default PD Control (RED)'
//  '<S157>' : 'GNC2026W/3 - Control/Disable Control (ARM)'
//  '<S158>' : 'GNC2026W/3 - Control/Disable Thrusters (BLACK)'
//  '<S159>' : 'GNC2026W/3 - Control/Disable Thrusters (BLUE)'
//  '<S160>' : 'GNC2026W/3 - Control/Disable Thrusters (RED)'
//  '<S161>' : 'GNC2026W/3 - Control/Custom Control (RED)/MATLAB Function2'
//  '<S162>' : 'GNC2026W/3 - Control/Custom Control (RED)/MATLAB Function3'
//  '<S163>' : 'GNC2026W/3 - Control/Custom Control (RED)/Unwrap'
//  '<S164>' : 'GNC2026W/3 - Control/Custom Control (RED)/Unwrap1'
//  '<S165>' : 'GNC2026W/3 - Control/Custom Control (RED)/Unwrap/Unwrap'
//  '<S166>' : 'GNC2026W/3 - Control/Custom Control (RED)/Unwrap/Unwrap/MATLAB Function'
//  '<S167>' : 'GNC2026W/3 - Control/Custom Control (RED)/Unwrap1/MATLAB Function'
//  '<S168>' : 'GNC2026W/3 - Control/Default LQR Control (BLACK)/Calculate Error'
//  '<S169>' : 'GNC2026W/3 - Control/Default LQR Control (BLACK)/Discrete Derivative'
//  '<S170>' : 'GNC2026W/3 - Control/Default LQR Control (BLACK)/Discrete Derivative1'
//  '<S171>' : 'GNC2026W/3 - Control/Default LQR Control (BLACK)/Discrete Derivative2'
//  '<S172>' : 'GNC2026W/3 - Control/Default LQR Control (BLACK)/Calculate Error/MATLAB Function'
//  '<S173>' : 'GNC2026W/3 - Control/Default LQR Control (BLUE)/Calculate Error'
//  '<S174>' : 'GNC2026W/3 - Control/Default LQR Control (BLUE)/Discrete Derivative'
//  '<S175>' : 'GNC2026W/3 - Control/Default LQR Control (BLUE)/Discrete Derivative1'
//  '<S176>' : 'GNC2026W/3 - Control/Default LQR Control (BLUE)/Discrete Derivative2'
//  '<S177>' : 'GNC2026W/3 - Control/Default LQR Control (BLUE)/Calculate Error/MATLAB Function'
//  '<S178>' : 'GNC2026W/3 - Control/Default LQR Control (RED)/Calculate Error'
//  '<S179>' : 'GNC2026W/3 - Control/Default LQR Control (RED)/Discrete Derivative'
//  '<S180>' : 'GNC2026W/3 - Control/Default LQR Control (RED)/Discrete Derivative1'
//  '<S181>' : 'GNC2026W/3 - Control/Default LQR Control (RED)/Discrete Derivative2'
//  '<S182>' : 'GNC2026W/3 - Control/Default LQR Control (RED)/Calculate Error/MATLAB Function'
//  '<S183>' : 'GNC2026W/3 - Control/Default PD (ARM)/Passthrough for Experiment'
//  '<S184>' : 'GNC2026W/3 - Control/Default PD (ARM)/Simulated Position Controller'
//  '<S185>' : 'GNC2026W/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Elbow)'
//  '<S186>' : 'GNC2026W/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Shoulder)'
//  '<S187>' : 'GNC2026W/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Wrist)'
//  '<S188>' : 'GNC2026W/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Elbow)/Discrete Derivative1'
//  '<S189>' : 'GNC2026W/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Shoulder)/Discrete Derivative1'
//  '<S190>' : 'GNC2026W/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Wrist)/Discrete Derivative1'
//  '<S191>' : 'GNC2026W/3 - Control/Default PD Control (BLACK)/Calculate Error'
//  '<S192>' : 'GNC2026W/3 - Control/Default PD Control (BLACK)/Discrete Derivative'
//  '<S193>' : 'GNC2026W/3 - Control/Default PD Control (BLACK)/Discrete Derivative1'
//  '<S194>' : 'GNC2026W/3 - Control/Default PD Control (BLACK)/Discrete Derivative2'
//  '<S195>' : 'GNC2026W/3 - Control/Default PD Control (BLACK)/Calculate Error/MATLAB Function'
//  '<S196>' : 'GNC2026W/3 - Control/Default PD Control (BLUE)/Calculate Error'
//  '<S197>' : 'GNC2026W/3 - Control/Default PD Control (BLUE)/Discrete Derivative'
//  '<S198>' : 'GNC2026W/3 - Control/Default PD Control (BLUE)/Discrete Derivative1'
//  '<S199>' : 'GNC2026W/3 - Control/Default PD Control (BLUE)/Discrete Derivative2'
//  '<S200>' : 'GNC2026W/3 - Control/Default PD Control (BLUE)/Calculate Error/MATLAB Function'
//  '<S201>' : 'GNC2026W/3 - Control/Default PD Control (RED)/Calculate Error'
//  '<S202>' : 'GNC2026W/3 - Control/Default PD Control (RED)/Discrete Derivative'
//  '<S203>' : 'GNC2026W/3 - Control/Default PD Control (RED)/Discrete Derivative1'
//  '<S204>' : 'GNC2026W/3 - Control/Default PD Control (RED)/Discrete Derivative2'
//  '<S205>' : 'GNC2026W/3 - Control/Default PD Control (RED)/Calculate Error/MATLAB Function'
//  '<S206>' : 'GNC2026W/Check  Connection/Change BLACK Behavior'
//  '<S207>' : 'GNC2026W/Check  Connection/Change BLUE Behavior'
//  '<S208>' : 'GNC2026W/Check  Connection/Change RED Behavior'
//  '<S209>' : 'GNC2026W/Data Logger Subsystem/Data Logger'
//  '<S210>' : 'GNC2026W/Data Logger Subsystem/Separation'
//  '<S211>' : 'GNC2026W/Data Logger Subsystem/Data Logger/MATLAB Function'
//  '<S212>' : 'GNC2026W/Data Logger Subsystem/Separation/MATLAB Function'
//  '<S213>' : 'GNC2026W/Debugger/Change BLACK Behavior'
//  '<S214>' : 'GNC2026W/Debugger/Change BLUE Behavior'
//  '<S215>' : 'GNC2026W/Debugger/Change RED Behavior'
//  '<S216>' : 'GNC2026W/Float Code/Enable Pucks'
//  '<S217>' : 'GNC2026W/Manipulator Encoder Data/Change ARM Behavior'
//  '<S218>' : 'GNC2026W/Navigation Filter/If Action Subsystem'
//  '<S219>' : 'GNC2026W/Navigation Filter/If Action Subsystem/EKF'
//  '<S220>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF'
//  '<S221>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF'
//  '<S222>' : 'GNC2026W/Navigation Filter/If Action Subsystem/EKF/Camera to Inertial Frame'
//  '<S223>' : 'GNC2026W/Navigation Filter/If Action Subsystem/EKF/EKF'
//  '<S224>' : 'GNC2026W/Navigation Filter/If Action Subsystem/EKF/Unwrap'
//  '<S225>' : 'GNC2026W/Navigation Filter/If Action Subsystem/EKF/Unwrap/Unwrap'
//  '<S226>' : 'GNC2026W/Navigation Filter/If Action Subsystem/EKF/Unwrap/Unwrap/MATLAB Function'
//  '<S227>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/Camera to Inertial Frame'
//  '<S228>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/MEKF'
//  '<S229>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/Unwrap'
//  '<S230>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/VIS Measured States'
//  '<S231>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/Unwrap/Unwrap'
//  '<S232>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/Unwrap/Unwrap/MATLAB Function'
//  '<S233>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/VIS Measured States/Artificial VIS States'
//  '<S234>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/VIS Measured States/Experimental VIS States'
//  '<S235>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/VIS Measured States/Experimental VIS States/If Action Subsystem'
//  '<S236>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/VIS Measured States/Experimental VIS States/If Action Subsystem1'
//  '<S237>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/Unscented Kalman Filter'
//  '<S238>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/Unwrap'
//  '<S239>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/VIS Measured States'
//  '<S240>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/Unwrap/Unwrap'
//  '<S241>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/Unwrap/Unwrap/MATLAB Function'
//  '<S242>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/VIS Measured States/Artificial VIS States'
//  '<S243>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/VIS Measured States/Experimental VIS States'
//  '<S244>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/VIS Measured States/Experimental VIS States/If Action Subsystem'
//  '<S245>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/VIS Measured States/Experimental VIS States/If Action Subsystem1'
//  '<S246>' : 'GNC2026W/PhaseSpace Camera Code/Initialize Universal Time (Simulation)'
//  '<S247>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States'
//  '<S248>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data'
//  '<S249>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data'
//  '<S250>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data'
//  '<S251>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data'
//  '<S252>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)'
//  '<S253>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Enabled Subsystem2'
//  '<S254>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/MATLAB Function'
//  '<S255>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/MATLAB Function1'
//  '<S256>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time'
//  '<S257>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time/Change BLACK Behavior'
//  '<S258>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time/Change BLUE Behavior'
//  '<S259>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time/Change RED Behavior'
//  '<S260>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Calculate True  Time Step'
//  '<S261>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)'
//  '<S262>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem1'
//  '<S263>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem2'
//  '<S264>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Wrap'
//  '<S265>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Calculate True  Time Step/Enabled Subsystem3'
//  '<S266>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Calculate True  Time Step/MATLAB Function'
//  '<S267>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Artificial isValid Flag'
//  '<S268>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/BLK CoM to LAR'
//  '<S269>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/CV Noise'
//  '<S270>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Inertial to Camera Frame (HARDWARE)'
//  '<S271>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/MATLAB Function'
//  '<S272>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Sample and Hold'
//  '<S273>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Unwrap'
//  '<S274>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Artificial isValid Flag/MATLAB Function1'
//  '<S275>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Unwrap/Unwrap'
//  '<S276>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Unwrap/Unwrap/MATLAB Function'
//  '<S277>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem1/Enabled Subsystem'
//  '<S278>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem1/Enabled Subsystem/MATLAB Function'
//  '<S279>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem2/Enabled Subsystem'
//  '<S280>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem2/Enabled Subsystem/MATLAB Function'
//  '<S281>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Calculate True  Time Step'
//  '<S282>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem1'
//  '<S283>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem2'
//  '<S284>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Wrap'
//  '<S285>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Calculate True  Time Step/Enabled Subsystem3'
//  '<S286>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Calculate True  Time Step/MATLAB Function'
//  '<S287>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem1/Enabled Subsystem'
//  '<S288>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem1/Enabled Subsystem/MATLAB Function'
//  '<S289>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem2/Enabled Subsystem'
//  '<S290>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem2/Enabled Subsystem/MATLAB Function'
//  '<S291>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Calculate True  Time Step'
//  '<S292>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem1'
//  '<S293>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem2'
//  '<S294>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Wrap'
//  '<S295>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Calculate True  Time Step/Enabled Subsystem3'
//  '<S296>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Calculate True  Time Step/MATLAB Function'
//  '<S297>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem1/Enabled Subsystem'
//  '<S298>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem1/Enabled Subsystem/MATLAB Function'
//  '<S299>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem2/Enabled Subsystem'
//  '<S300>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem2/Enabled Subsystem/MATLAB Function'
//  '<S301>' : 'GNC2026W/Platform  Identification/Subsystem'
//  '<S302>' : 'GNC2026W/Receive CV Data/CV UDP'
//  '<S303>' : 'GNC2026W/Receive CV Data/CV UDP/Reading isValid'
//  '<S304>' : 'GNC2026W/Recieve ROB  Data/ROB UDP'
//  '<S305>' : 'GNC2026W/Recieve ROB  Data/Simulated Flag'
//  '<S306>' : 'GNC2026W/Robotic  Arm Code/Change ARM Behavior'
//  '<S307>' : 'GNC2026W/Send Data  to Orin/Subsystem'
//  '<S308>' : 'GNC2026W/Send Data  to ROB/SEND ROB UDP'
//  '<S309>' : 'GNC2026W/Send Data  to ROB/SEND ROB UDP/MATLAB Function'
//  '<S310>' : 'GNC2026W/Send Data  to ROB/SEND ROB UDP/MATLAB Function2'
//  '<S311>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior'
//  '<S312>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior'
//  '<S313>' : 'GNC2026W/Thruster Control Code/Change RED Behavior'
//  '<S314>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle'
//  '<S315>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Rotate Forces to Body'
//  '<S316>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Duty Cycle @ PWM'
//  '<S317>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Generate Initial Guess'
//  '<S318>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/MATLAB Function1'
//  '<S319>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/MATLAB Function5'
//  '<S320>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Rotate Forces to Inertial'
//  '<S321>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem'
//  '<S322>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem1'
//  '<S323>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Generate Initial Guess/MATLAB Function'
//  '<S324>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Rotate Forces to Inertial/Create Rotation Matrix'
//  '<S325>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Rotate Forces to Body/Create Rotation Matrix'
//  '<S326>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle'
//  '<S327>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Rotate Forces to Body'
//  '<S328>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Duty Cycle @ PWM'
//  '<S329>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Generate Initial Guess'
//  '<S330>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/MATLAB Function1'
//  '<S331>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/MATLAB Function5'
//  '<S332>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Rotate Forces to Inertial'
//  '<S333>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem'
//  '<S334>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem1'
//  '<S335>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Generate Initial Guess/MATLAB Function'
//  '<S336>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Rotate Forces to Inertial/Create Rotation Matrix'
//  '<S337>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Rotate Forces to Body/Create Rotation Matrix'
//  '<S338>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle'
//  '<S339>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Rotate Forces to Body'
//  '<S340>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Duty Cycle @ PWM'
//  '<S341>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Generate Initial Guess'
//  '<S342>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/MATLAB Function5'
//  '<S343>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/MATLAB Function8'
//  '<S344>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Rotate Forces to Inertial'
//  '<S345>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem'
//  '<S346>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem1'
//  '<S347>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Generate Initial Guess/MATLAB Function'
//  '<S348>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Rotate Forces to Inertial/Create Rotation Matrix'
//  '<S349>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Rotate Forces to Body/Create Rotation Matrix'
//  '<S350>' : 'GNC2026W/Time Sync./Change BLACK Behavior'
//  '<S351>' : 'GNC2026W/Time Sync./Change BLUE Behavior'
//  '<S352>' : 'GNC2026W/Time Sync./Change RED Behavior'
