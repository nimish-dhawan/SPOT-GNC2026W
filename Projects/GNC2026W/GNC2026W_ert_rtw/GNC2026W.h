...
// Block states (default storage) for system '<S242>/Change BLACK Behavior'
struct DW_ChangeBLACKBehavior_GNC2_l_T {
  real_T UDPSendGUI_NetworkLib[137];   // '<S243>/UDP Send (GUI)'
};

// Block signals for system '<S248>/Enabled Subsystem'
struct B_EnabledSubsystem_GNC2026W_T {
  real_T Delay[3];                     // '<S260>/Delay'
  real_T ema[3];                       // '<S260>/MATLAB Function'
};

// Block states (default storage) for system '<S248>/Enabled Subsystem'
struct DW_EnabledSubsystem_GNC2026W_T {
  real_T Delay_DSTATE[3];              // '<S260>/Delay'
  boolean_T EnabledSubsystem_MODE;     // '<S248>/Enabled Subsystem'
};

// Block signals for system '<S249>/Enabled Subsystem'
struct B_EnabledSubsystem_GNC2026W_h_T {
  real_T Delay[3];                     // '<S262>/Delay'
  real_T ema[3];                       // '<S262>/MATLAB Function'
};

// Block states (default storage) for system '<S249>/Enabled Subsystem'
struct DW_EnabledSubsystem_GNC2026_c_T {
  real_T Delay_DSTATE[3];              // '<S262>/Delay'
  boolean_T EnabledSubsystem_MODE;     // '<S249>/Enabled Subsystem'
};
...
struct B_GNC2026W_T {
  ...
  real_T ReceivePhaseSpaceData_o1[19]; // '<S234>/Receive PhaseSpace Data'
  real_T ConvertBLAXfrommmtom;        // '<S235>/Convert BLAX from [mm] to [m]'
  real_T ConvertBLUXfrommmtom;        // '<S236>/Convert BLUX from [mm] to [m]'
  real_T ConvertREDXfrommmtom;        // '<S237>/Convert REDX from [mm] to [m]'
  real_T UDPReceiveREDClock_o1;        // '<S238>/UDP Receive (RED Clock)'
  real_T UDPReceiveBLACKClock_o1;      // '<S238>/UDP Receive (BLACK Clock)'
  real_T UDPReceiveBLUEClock_o1;       // '<S238>/UDP Receive (BLUE Clock)'
  real_T dy[3];                        // '<S282>/MATLAB Function'
  real_T dy_h[3];                      // '<S280>/MATLAB Function'
  real_T y2y1;                         // '<S278>/y2-y1'
  real_T dy_c[3];                      // '<S272>/MATLAB Function'
  real_T dy_d[3];                      // '<S270>/MATLAB Function'
  real_T y2y1_o;                       // '<S268>/y2-y1'
  real_T dy_p[3];                      // '<S262>/MATLAB Function'
  real_T dy_g[3];                      // '<S260>/MATLAB Function'
  real_T y;                            // '<S258>/MATLAB Function'
  real_T u_next;                       // '<S258>/MATLAB Function'
  real_T y2y1_ob;                      // '<S251>/y2-y1'
  real_T In1_g20;                      // '<S239>/In1'
  real_T Merge_k[6];                   // '<S213>/Merge'
  real32_T UDPReceive_o1[4];           // '<S286>/UDP Receive'
  real32_T UDPReceive_o1_a[4];         // '<S285>/UDP Receive'
  ...
  B_EnabledSubsystem_GNC2026W_h_T EnabledSubsystem_l1;// '<S276>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_T EnabledSubsystem_k;// '<S275>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_h_T EnabledSubsystem_d;// '<S266>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_T EnabledSubsystem_l;// '<S265>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_h_T EnabledSubsystem_g;// '<S249>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_T EnabledSubsystem;// '<S248>/Enabled Subsystem'
};
...
struct DW_GNC2026W_T {
  ...
  IdentifyPlatform_GNC2026W_T obj_dk;  // '<S284>/WhoAmI'
  ...
  real_T Delay2_DSTATE;                // '<S246>/Delay2'
  real_T Delay1_DSTATE;                // '<S246>/Delay1'
  real_T Delay1_DSTATE_g[3];           // '<S249>/Delay1'
  real_T Delay1_DSTATE_b[3];           // '<S248>/Delay1'
  real_T Delay_DSTATE_h;               // '<S258>/Delay'
  real_T Delay1_DSTATE_f;              // '<S258>/Delay1'
  real_T Delay2_DSTATE_l;              // '<S264>/Delay2'
  real_T Delay1_DSTATE_l;              // '<S264>/Delay1'
  real_T Delay1_DSTATE_m[3];           // '<S266>/Delay1'
  real_T Delay1_DSTATE_lv[3];          // '<S265>/Delay1'
  real_T Delay2_DSTATE_l0;             // '<S274>/Delay2'
  real_T Delay1_DSTATE_ld;             // '<S274>/Delay1'
  real_T Delay1_DSTATE_c[3];           // '<S276>/Delay1'
  real_T Delay1_DSTATE_cq[3];          // '<S275>/Delay1'
  ...
  real_T Delay_DSTATE_b;               // '<S230>/Delay'
  real_T Delay1_DSTATE_a;              // '<S230>/Delay1'
  ...
  real_T UDPReceive_NetworkLib[137];   // '<S286>/UDP Receive'
  real_T UDPReceive_NetworkLib_i[137]; // '<S285>/UDP Receive'
  real_T ReceivePhaseSpaceData_NetworkLi[137];// '<S234>/Receive PhaseSpace Data' 
  real_T UDPReceiveREDClock_NetworkLib[137];// '<S238>/UDP Receive (RED Clock)'
  real_T UDPReceiveBLACKClock_NetworkLib[137];// '<S238>/UDP Receive (BLACK Clock)' 
  real_T UDPReceiveBLUEClock_NetworkLib[137];// '<S238>/UDP Receive (BLUE Clock)' 
  real_T k;                            // '<S247>/Sample and Hold'
  real_T y_hold[3];                    // '<S247>/Sample and Hold'
  real_T x[6];                         // '<S214>/EKF'
  ...
  real_T x_o[3];                       // '<S144>/MATLAB Function2'
  real_T P_l[9];                       // '<S144>/MATLAB Function2'
  ...
  uint32_T method;                     // '<S247>/CV Noise'
  uint32_T state;                      // '<S247>/CV Noise'
  uint32_T state_g[2];                 // '<S247>/CV Noise'
  uint32_T state_j[625];               // '<S247>/CV Noise'
  ...
  // '<S242>/This IF block determines whether or not to run the BLACK sim//exp'
  int8_T ThisIFblockdetermineswhether_cs;
  // '<S242>/This IF block determines whether or not to run the BLUE sim//exp'
  int8_T ThisIFblockdetermineswhethero_d;
  // '<S242>/This IF block determines whether or not to run the RED sim//exp '
  boolean_T k_not_empty;               // '<S247>/Sample and Hold'
  ...
  DW_EnabledSubsystem_GNC2026_c_T EnabledSubsystem_l1;// '<S276>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026W_T EnabledSubsystem_k;// '<S275>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026_c_T EnabledSubsystem_d;// '<S266>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026W_T EnabledSubsystem_l;// '<S265>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026_c_T EnabledSubsystem_g;// '<S249>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026W_T EnabledSubsystem;// '<S248>/Enabled Subsystem'
  DW_ChangeBLACKBehavior_GNC2_l_T ChangeREDBehavior_d;// '<S242>/Change RED Behavior' 
  DW_ChangeBLACKBehavior_GNC2_l_T ChangeBLUEBehavior_f;// '<S242>/Change BLUE Behavior' 
  DW_ChangeBLACKBehavior_GNC2_l_T ChangeBLACKBehavior_e;// '<S242>/Change BLACK Behavior' 
...
// Parameters for system: '<S242>/Change BLACK Behavior'
...
// Parameters for system: '<S248>/Enabled Subsystem'
...
// Parameters for system: '<S249>/Enabled Subsystem'
...
struct P_GNC2026W_T_ {
  ...
  P_EnabledSubsystem_GNC2026W_c_T EnabledSubsystem_l1;// '<S276>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_T EnabledSubsystem_k;// '<S275>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_c_T EnabledSubsystem_d;// '<S266>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_T EnabledSubsystem_l;// '<S265>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_c_T EnabledSubsystem_g;// '<S249>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_T EnabledSubsystem;// '<S248>/Enabled Subsystem'
  P_ChangeBLACKBehavior_GNC20_p_T ChangeREDBehavior_d;// '<S242>/Change RED Behavior' 
  P_ChangeBLACKBehavior_GNC20_p_T ChangeBLUEBehavior_f;// '<S242>/Change BLUE Behavior' 
  P_ChangeBLACKBehavior_GNC20_p_T ChangeBLACKBehavior_e;// '<S242>/Change BLACK Behavior' 
...
//  Block '<S216>/Scope3' : Unused code path elimination
//  Block '<S247>/Scope1' : Unused code path elimination
//  Block '<S247>/Scope2' : Unused code path elimination
//  Block '<S247>/Scope3' : Unused code path elimination
...
//  Block '<S234>/Reshape' : Reshape block reduction
...
//  '<S227>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/Camera to Inertial Frame'
//  '<S228>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/Unscented Kalman Filter'
//  '<S229>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/Unwrap'
//  '<S230>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/Unwrap/Unwrap'
//  '<S231>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/Unwrap/Unwrap/MATLAB Function'
//  '<S232>' : 'GNC2026W/PhaseSpace Camera Code/Initialize Universal Time (Simulation)'
//  '<S233>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States'
//  '<S234>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data'
//  '<S235>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data'
//  '<S236>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data'
//  '<S237>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data'
//  '<S238>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)'
//  '<S239>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Enabled Subsystem2'
//  '<S240>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/MATLAB Function'
//  '<S241>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/MATLAB Function1'
//  '<S242>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time'
//  '<S243>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time/Change BLACK Behavior'
//  '<S244>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time/Change BLUE Behavior'
//  '<S245>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time/Change RED Behavior'
//  '<S246>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Calculate True  Time Step'
//  '<S247>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)'
//  '<S248>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem1'
//  '<S249>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem2'
//  '<S250>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Wrap'
//  '<S251>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Calculate True  Time Step/Enabled Subsystem3'
//  '<S252>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Calculate True  Time Step/MATLAB Function'
//  '<S253>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/BLK CoM to LAR'
//  '<S254>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/CV Noise'
//  '<S255>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Inertial to Camera Frame (HARDWARE)'
//  '<S256>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Sample and Hold'
//  '<S257>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Unwrap'
//  '<S258>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Unwrap/Unwrap'
//  '<S259>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Unwrap/Unwrap/MATLAB Function'
//  '<S260>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem1/Enabled Subsystem'
//  '<S261>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem1/Enabled Subsystem/MATLAB Function'
//  '<S262>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem2/Enabled Subsystem'
//  '<S263>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem2/Enabled Subsystem/MATLAB Function'
//  '<S264>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Calculate True  Time Step'
//  '<S265>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem1'
//  '<S266>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem2'
//  '<S267>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Wrap'
//  '<S268>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Calculate True  Time Step/Enabled Subsystem3'
//  '<S269>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Calculate True  Time Step/MATLAB Function'
//  '<S270>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem1/Enabled Subsystem'
//  '<S271>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem1/Enabled Subsystem/MATLAB Function'
//  '<S272>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem2/Enabled Subsystem'
//  '<S273>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem2/Enabled Subsystem/MATLAB Function'
//  '<S274>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Calculate True  Time Step'
//  '<S275>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem1'
//  '<S276>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem2'
//  '<S277>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Wrap'
//  '<S278>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Calculate True  Time Step/Enabled Subsystem3'
//  '<S279>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Calculate True  Time Step/MATLAB Function'
//  '<S280>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem1/Enabled Subsystem'
//  '<S281>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem1/Enabled Subsystem/MATLAB Function'
//  '<S282>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem2/Enabled Subsystem'
//  '<S283>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem2/Enabled Subsystem/MATLAB Function'
//  '<S284>' : 'GNC2026W/Platform  Identification/Subsystem'
//  '<S285>' : 'GNC2026W/Receive CV Data/CV UDP'
//  '<S286>' : 'GNC2026W/Receive Data from Orin/Subsystem'
//  '<S287>' : 'GNC2026W/Robotic  Arm Code/Change ARM Behavior'
//  '<S288>' : 'GNC2026W/Send Data  to Orin/Subsystem'
