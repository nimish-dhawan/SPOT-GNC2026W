...
struct DW_ChangeBLACKBehavior_GNC202_T {
  real_T UDPSend_NetworkLib[137];      // '<S214>/UDP Send'
};

// Block states (default storage) for system '<S236>/Change BLACK Behavior'
struct DW_ChangeBLACKBehavior_GNC2_l_T {
  real_T UDPSendGUI_NetworkLib[137];   // '<S237>/UDP Send (GUI)'
};

// Block signals for system '<S242>/Enabled Subsystem'
struct B_EnabledSubsystem_GNC2026W_T {
  real_T Delay[3];                     // '<S254>/Delay'
  real_T ema[3];                       // '<S254>/MATLAB Function'
};

// Block states (default storage) for system '<S242>/Enabled Subsystem'
struct DW_EnabledSubsystem_GNC2026W_T {
  real_T Delay_DSTATE[3];              // '<S254>/Delay'
  boolean_T EnabledSubsystem_MODE;     // '<S242>/Enabled Subsystem'
};
...
// Block signals for system '<S289>/Pseudoinverse1'
struct B_Pseudoinverse1_GNC2026W_T {
  real_T Pseudoinverse1[24];           // '<S289>/Pseudoinverse1'
};

// Block states (default storage) for system '<S289>/Pseudoinverse1'
struct DW_Pseudoinverse1_GNC2026W_T {
  dsp_simulink_Pseudoinverse_GN_T obj; // '<S289>/Pseudoinverse1'
  boolean_T objisempty;                // '<S289>/Pseudoinverse1'
};

// Block signals for system '<S17>/Change BLACK Behavior'
struct B_ChangeBLACKBehavior_GNC20_m_T {
  real_T Clock1;                       // '<S322>/Clock1'
};

// Block states (default storage) for system '<S17>/Change BLACK Behavior'
struct DW_ChangeBLACKBehavior_GNC2_g_T {
  real_T UDPSendClock_NetworkLib[137]; // '<S322>/UDP Send (Clock)'
};
...
struct B_GNC2026W_T {
  ...
  real_T duty_cycles[8];               // '<S310>/MATLAB Function5'
  real_T ThrustPer_Final[8];           // '<S318>/ThrustPer_Final'
  real_T In1;                          // '<S317>/In1'
  real_T duty_cycles_j[8];             // '<S298>/MATLAB Function5'
  real_T ThrustPer_Final_h[8];         // '<S306>/ThrustPer_Final'
  real_T In1_g;                        // '<S305>/In1'
  real_T duty_cycles_m[8];             // '<S286>/MATLAB Function5'
  real_T ThrustPer_Final_h5[8];        // '<S294>/ThrustPer_Final'
  real_T In1_g2;                       // '<S293>/In1'
  real_T TmpSignalConversionAtUDPSendI_o[28];
  real_T ReceivePhaseSpaceData_o1[19]; // '<S228>/Receive PhaseSpace Data'
  real_T ConvertBLAXfrommmtom;        // '<S229>/Convert BLAX from [mm] to [m]'
  real_T ConvertBLUXfrommmtom;        // '<S230>/Convert BLUX from [mm] to [m]'
  real_T ConvertREDXfrommmtom;        // '<S231>/Convert REDX from [mm] to [m]'
  real_T UDPReceiveREDClock_o1;        // '<S232>/UDP Receive (RED Clock)'
  real_T UDPReceiveBLACKClock_o1;      // '<S232>/UDP Receive (BLACK Clock)'
  real_T UDPReceiveBLUEClock_o1;       // '<S232>/UDP Receive (BLUE Clock)'
  real_T dy[3];                        // '<S276>/MATLAB Function'
  real_T dy_h[3];                      // '<S274>/MATLAB Function'
  real_T y2y1;                         // '<S272>/y2-y1'
  real_T dy_c[3];                      // '<S266>/MATLAB Function'
  real_T dy_d[3];                      // '<S264>/MATLAB Function'
  real_T y2y1_o;                       // '<S262>/y2-y1'
  real_T dy_p[3];                      // '<S256>/MATLAB Function'
  real_T dy_g[3];                      // '<S254>/MATLAB Function'
  real_T y;                            // '<S252>/MATLAB Function'
  real_T u_next;                       // '<S252>/MATLAB Function'
  real_T y2y1_ob;                      // '<S245>/y2-y1'
  real_T In1_g20;                      // '<S233>/In1'
  real_T Merge_k[6];                   // '<S129>/Merge'
  real32_T UDPReceive_o1[4];           // '<S280>/UDP Receive'
  real32_T UDPReceive_o1_a[4];         // '<S279>/UDP Receive'
  uint8_T StringtoASCII[31];           // '<S223>/String to ASCII'
  uint8_T StringtoASCII2[31];          // '<S222>/String to ASCII2'
  uint8_T StringtoASCII1[31];          // '<S221>/String to ASCII1'
  ...
  B_Pseudoinverse1_GNC2026W_T Pseudoinverse1_pn;// '<S289>/Pseudoinverse1'
  B_Pseudoinverse1_GNC2026W_T Pseudoinverse1_p;// '<S289>/Pseudoinverse1'
  B_Pseudoinverse1_GNC2026W_T Pseudoinverse1;// '<S289>/Pseudoinverse1'
  B_EnabledSubsystem_GNC2026W_h_T EnabledSubsystem_l1;// '<S270>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_T EnabledSubsystem_k;// '<S269>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_h_T EnabledSubsystem_d;// '<S260>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_T EnabledSubsystem_l;// '<S259>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_h_T EnabledSubsystem_g;// '<S243>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_T EnabledSubsystem;// '<S242>/Enabled Subsystem'
};

// Block states (default storage) for system '<Root>'
struct DW_GNC2026W_T {
  Dynamixel_Controller_GNC2026W_T obj;
  // '<S281>/Control Dynamixel Actuators in  either Position, Current, or Speed  Control Modes' 
  GPIO_Write_GNC2026W_T obj_l;         // '<S224>/GPIO Write1'
  ReadArm_Position_Rates_GNC202_T obj_d;
                     // '<S225>/Read Joint Positions using  Dynamixel Encoders'
  IdentifyPlatform_GNC2026W_T obj_dk;  // '<S278>/WhoAmI'
  CustomDataLogger_GNC2026W_T obj_f;   // '<S217>/MATLAB System'
  real_T Delay_DSTATE;                 // '<S312>/Delay'
  real_T Delay_DSTATE_k;               // '<S300>/Delay'
  real_T Delay_DSTATE_kz;              // '<S288>/Delay'
  real_T Delay2_DSTATE;                // '<S240>/Delay2'
  real_T Delay1_DSTATE;                // '<S240>/Delay1'
  real_T Delay1_DSTATE_g[3];           // '<S243>/Delay1'
  real_T Delay1_DSTATE_b[3];           // '<S242>/Delay1'
  real_T Delay_DSTATE_h;               // '<S252>/Delay'
  real_T Delay1_DSTATE_f;              // '<S252>/Delay1'
  real_T Delay2_DSTATE_l;              // '<S258>/Delay2'
  real_T Delay1_DSTATE_l;              // '<S258>/Delay1'
  real_T Delay1_DSTATE_m[3];           // '<S260>/Delay1'
  real_T Delay1_DSTATE_lv[3];          // '<S259>/Delay1'
  real_T Delay2_DSTATE_l0;             // '<S268>/Delay2'
  real_T Delay1_DSTATE_ld;             // '<S268>/Delay1'
  real_T Delay1_DSTATE_c[3];           // '<S270>/Delay1'
  real_T Delay1_DSTATE_cq[3];          // '<S269>/Delay1'
  real_T Delay_DSTATE_o;               // '<S225>/Delay'
  real_T Delay1_DSTATE_cg;             // '<S225>/Delay1'
  real_T Delay2_DSTATE_h;              // '<S225>/Delay2'
  real_T UD_DSTATE;                    // '<S196>/UD'
  real_T UD_DSTATE_e;                  // '<S197>/UD'
  real_T UD_DSTATE_a;                  // '<S198>/UD'
  real_T UD_DSTATE_l;                  // '<S182>/UD'
  real_T UD_DSTATE_k;                  // '<S183>/UD'
  real_T UD_DSTATE_h;                  // '<S184>/UD'
  real_T UD_DSTATE_o;                  // '<S205>/UD'
  real_T UD_DSTATE_n;                  // '<S206>/UD'
  real_T UD_DSTATE_hu;                 // '<S207>/UD'
  real_T UD_DSTATE_j;                  // '<S177>/UD'
  real_T UD_DSTATE_c;                  // '<S178>/UD'
  real_T UD_DSTATE_d;                  // '<S179>/UD'
  real_T UD_DSTATE_eh;                 // '<S200>/UD'
  real_T UD_DSTATE_hv;                 // '<S201>/UD'
  real_T UD_DSTATE_kv;                 // '<S202>/UD'
  real_T Delay_DSTATE_l;               // '<S174>/Delay'
  real_T Delay1_DSTATE_ba;             // '<S174>/Delay1'
  real_T UD_DSTATE_aq;                 // '<S187>/UD'
  real_T UD_DSTATE_p;                  // '<S188>/UD'
  real_T UD_DSTATE_pr;                 // '<S189>/UD'
  real_T UD_DSTATE_eg;                 // '<S210>/UD'
  real_T UD_DSTATE_cd;                 // '<S211>/UD'
  real_T UD_DSTATE_hd;                 // '<S212>/UD'
  real_T Delay_DSTATE_h0;              // '<S152>/Delay'
  real_T Delay1_DSTATE_lo;             // '<S152>/Delay1'
  real_T Delay_DSTATE_ol;              // '<S150>/Delay'
  real_T Delay1_DSTATE_e;              // '<S150>/Delay1'
  real_T Delay_DSTATE_c;               // '<S138>/Delay'
  real_T Delay1_DSTATE_g0;             // '<S138>/Delay1'
  real_T Delay_DSTATE_j;               // '<S143>/Delay'
  real_T Delay1_DSTATE_d;              // '<S143>/Delay1'
  real_T Delay_DSTATE_b;               // '<S148>/Delay'
  real_T Delay1_DSTATE_a;              // '<S148>/Delay1'
  real_T UnitDelay1_DSTATE[6];         // '<S134>/Unit Delay1'
  real_T UnitDelay2_DSTATE[36];        // '<S134>/Unit Delay2'
  creal_T q;                           // '<S133>/MEKF'
  ...
  real_T UDPSend_NetworkLib_m[137];    // '<S282>/UDP Send'
  real_T UDPReceive_NetworkLib[137];   // '<S280>/UDP Receive'
  real_T UDPReceive_NetworkLib_i[137]; // '<S279>/UDP Receive'
  real_T ReceivePhaseSpaceData_NetworkLi[137];// '<S228>/Receive PhaseSpace Data' 
  real_T UDPReceiveREDClock_NetworkLib[137];// '<S232>/UDP Receive (RED Clock)'
  real_T UDPReceiveBLACKClock_NetworkLib[137];// '<S232>/UDP Receive (BLACK Clock)' 
  real_T UDPReceiveBLUEClock_NetworkLib[137];// '<S232>/UDP Receive (BLUE Clock)' 
  real_T k;                            // '<S241>/Sample and Hold'
  real_T y_hold[3];                    // '<S241>/Sample and Hold'
  real_T UDPSend3_NetworkLib[137];     // '<S223>/UDP Send3'
  real_T UDPSend2_NetworkLib[137];     // '<S222>/UDP Send2'
  real_T UDPSend1_NetworkLib[137];     // '<S221>/UDP Send1'
  real_T x[6];                         // '<S132>/EKF'
  real_T P[36];                        // '<S132>/EKF'
  real_T theta;                        // '<S132>/EKF'
  real_T theta_prev;                   // '<S132>/EKF'
  real_T x_m[5];                       // '<S133>/MEKF'
  real_T P_h[36];                      // '<S133>/MEKF'
  real_T theta_prev_a;                 // '<S133>/MEKF'
  real_T theta_cont;                   // '<S133>/MEKF'
  real_T k_h;                          // '<S134>/Unscented Kalman Filter'
  ...
  uint32_T method;                     // '<S241>/CV Noise'
  uint32_T state;                      // '<S241>/CV Noise'
  uint32_T state_g[2];                 // '<S241>/CV Noise'
  uint32_T state_j[625];               // '<S241>/CV Noise'
  ...
  // '<S236>/This IF block determines whether or not to run the BLACK sim//exp'
  int8_T ThisIFblockdetermineswhether_cs;
  // '<S236>/This IF block determines whether or not to run the BLUE sim//exp'
  int8_T ThisIFblockdetermineswhethero_d;
  // '<S236>/This IF block determines whether or not to run the RED sim//exp '
  boolean_T k_not_empty;               // '<S241>/Sample and Hold'
  boolean_T initial_theta;             // '<S132>/EKF'
  ...
  DW_Pseudoinverse1_GNC2026W_T Pseudoinverse1_pn;// '<S289>/Pseudoinverse1'
  DW_Pseudoinverse1_GNC2026W_T Pseudoinverse1_p;// '<S289>/Pseudoinverse1'
  DW_Pseudoinverse1_GNC2026W_T Pseudoinverse1;// '<S289>/Pseudoinverse1'
  DW_EnabledSubsystem_GNC2026_c_T EnabledSubsystem_l1;// '<S270>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026W_T EnabledSubsystem_k;// '<S269>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026_c_T EnabledSubsystem_d;// '<S260>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026W_T EnabledSubsystem_l;// '<S259>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026_c_T EnabledSubsystem_g;// '<S243>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026W_T EnabledSubsystem;// '<S242>/Enabled Subsystem'
  DW_ChangeBLACKBehavior_GNC2_l_T ChangeREDBehavior_d;// '<S236>/Change RED Behavior' 
  DW_ChangeBLACKBehavior_GNC2_l_T ChangeBLUEBehavior_f;// '<S236>/Change BLUE Behavior' 
  DW_ChangeBLACKBehavior_GNC2_l_T ChangeBLACKBehavior_e;// '<S236>/Change BLACK Behavior' 
...
struct P_ChangeBLACKBehavior_GNC20_b_T_ {
  int32_T UDPSendClock_Port;           // Computed Parameter: UDPSendClock_Port
                                          //  Referenced by: '<S322>/UDP Send (Clock)'
...
struct P_GNC2026W_T_ {
  ...
  real_T ControlDynamixelActuatorsineith;// Expression: 400
                                            //  Referenced by: '<S281>/Control Dynamixel Actuators in  either Position, Current, or Speed  Control Modes'
  ...
  P_EnabledSubsystem_GNC2026W_c_T EnabledSubsystem_l1;// '<S270>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_T EnabledSubsystem_k;// '<S269>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_c_T EnabledSubsystem_d;// '<S260>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_T EnabledSubsystem_l;// '<S259>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_c_T EnabledSubsystem_g;// '<S243>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_T EnabledSubsystem;// '<S242>/Enabled Subsystem'
  P_ChangeBLACKBehavior_GNC20_p_T ChangeREDBehavior_d;// '<S236>/Change RED Behavior' 
  P_ChangeBLACKBehavior_GNC20_p_T ChangeBLUEBehavior_f;// '<S236>/Change BLUE Behavior' 
  P_ChangeBLACKBehavior_GNC20_p_T ChangeBLACKBehavior_e;// '<S236>/Change BLACK Behavior' 
...
//  Block '<S132>/Scope' : Unused code path elimination
//  Block '<S134>/Scope' : Unused code path elimination
//  Block '<S134>/Scope2' : Unused code path elimination
//  Block '<S119>/Scope1' : Unused code path elimination
//  Block '<S119>/Scope2' : Unused code path elimination
//  Block '<S119>/Scope3' : Unused code path elimination
//  Block '<S119>/Scope4' : Unused code path elimination
...
//  Block '<S241>/Scope1' : Unused code path elimination
//  Block '<S241>/Scope2' : Unused code path elimination
//  Block '<S241>/Scope3' : Unused code path elimination
//  Block '<S279>/Scope' : Unused code path elimination
//  Block '<S221>/Data Type Conversion1' : Eliminate redundant data type conversion
...
//  '<S73>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Joint Angles RED'
//  '<S74>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK'
//  '<S75>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLUE'
//  '<S76>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED'
//  '<S77>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK/BLACK_Rz Desired'
//  '<S78>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK/Subsystem'
//  '<S79>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK/Wrap'
//  '<S80>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK/BLACK_Rz Desired/Subsystem'
//  '<S81>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK/Subsystem/Subsystem'
//  '<S82>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK/Subsystem/Subsystem1'
//  '<S83>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLUE/Calculate Circular Tracking'
//  '<S84>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLUE/Calculate Time since Phase #3 Start'
//  '<S85>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLUE/Wrap'
//  '<S86>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLUE/Calculate Time since Phase #3 Start/Subsystem'
//  '<S87>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED/Calculate Circular Tracking'
//  '<S88>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED/Calculate Time since Phase #3 Start'
//  '<S89>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED/Stand-off Distance'
//  '<S90>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED/Wrap'
//  '<S91>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED/Calculate Time since Phase #3 Start/Subsystem'
//  '<S92>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Joint Angles RED'
//  '<S93>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLACK'
//  '<S94>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLUE'
//  '<S95>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED'
//  '<S96>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLACK/BLACK_Rz Desired'
//  '<S97>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLACK/Wrap'
//  '<S98>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLACK/BLACK_Rz Desired/Subsystem'
//  '<S99>'  : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLUE/Calculate Circular Tracking'
//  '<S100>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLUE/Calculate Time since Phase #3 Start'
//  '<S101>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLUE/Wrap'
//  '<S102>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLUE/Calculate Time since Phase #3 Start/Subsystem'
//  '<S103>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED/Calculate Circular Tracking'
//  '<S104>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED/Calculate Time since Phase #3 Start'
//  '<S105>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED/Stand-off Distance'
//  '<S106>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED/Wrap'
//  '<S107>' : 'GNC2026W/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED/Calculate Time since Phase #3 Start/Subsystem'
//  '<S108>' : 'GNC2026W/1 - Experiment Logic/Phase #4: Return Home/Desired Joint Angles RED'
//  '<S109>' : 'GNC2026W/1 - Experiment Logic/Phase #4: Return Home/Desired Position BLACK'
//  '<S110>' : 'GNC2026W/1 - Experiment Logic/Phase #4: Return Home/Desired Position BLUE'
//  '<S111>' : 'GNC2026W/1 - Experiment Logic/Phase #4: Return Home/Desired Position RED'
//  '<S112>' : 'GNC2026W/1 - Experiment Logic/Phase #5: Hold Home/Desired Joint Angles RED'
//  '<S113>' : 'GNC2026W/1 - Experiment Logic/Phase #5: Hold Home/Desired Position BLACK'
//  '<S114>' : 'GNC2026W/1 - Experiment Logic/Phase #5: Hold Home/Desired Position BLUE'
//  '<S115>' : 'GNC2026W/1 - Experiment Logic/Phase #5: Hold Home/Desired Position RED'
//  '<S116>' : 'GNC2026W/2 - Guidance/Custom PPL (ARM)'
//  '<S117>' : 'GNC2026W/2 - Guidance/Custom PPL (BLACK)'
//  '<S118>' : 'GNC2026W/2 - Guidance/Custom PPL (BLUE)'
//  '<S119>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)'
//  '<S120>' : 'GNC2026W/2 - Guidance/Disable PPL (ARM)'
//  '<S121>' : 'GNC2026W/2 - Guidance/Disable PPL (BLACK)'
//  '<S122>' : 'GNC2026W/2 - Guidance/Disable PPL (BLUE)'
//  '<S123>' : 'GNC2026W/2 - Guidance/Disable PPL (RED)'
//  '<S124>' : 'GNC2026W/2 - Guidance/Custom PPL (ARM)/Desired Position'
//  '<S125>' : 'GNC2026W/2 - Guidance/Custom PPL (BLACK)/Desired Position'
//  '<S126>' : 'GNC2026W/2 - Guidance/Custom PPL (BLUE)/Desired Position'
//  '<S127>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/End Effector Desired'
...
//  '<S131>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Unwrap1'
//  '<S132>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/EKF'
//  '<S133>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/MEKF'
//  '<S134>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/UKF'
//  '<S135>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/EKF/Camera to Inertial Frame'
//  '<S136>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/EKF/EKF'
//  '<S137>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/EKF/Unwrap'
//  '<S138>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/EKF/Unwrap/Unwrap'
//  '<S139>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/EKF/Unwrap/Unwrap/MATLAB Function'
//  '<S140>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/MEKF/Camera to Inertial Frame'
//  '<S141>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/MEKF/MEKF'
//  '<S142>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/MEKF/Unwrap'
//  '<S143>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/MEKF/Unwrap/Unwrap'
//  '<S144>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/MEKF/Unwrap/Unwrap/MATLAB Function'
//  '<S145>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/UKF/Camera to Inertial Frame'
//  '<S146>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/UKF/Unscented Kalman Filter'
//  '<S147>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/UKF/Unwrap'
//  '<S148>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/UKF/Unwrap/Unwrap'
//  '<S149>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Navigation Filter/UKF/Unwrap/Unwrap/MATLAB Function'
//  '<S150>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Unwrap/Unwrap'
//  '<S151>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Unwrap/Unwrap/MATLAB Function'
//  '<S152>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Unwrap1/Unwrap'
//  '<S153>' : 'GNC2026W/2 - Guidance/Custom PPL (RED)/Unwrap1/Unwrap/MATLAB Function'
//  '<S154>' : 'GNC2026W/2 - Guidance/Disable PPL (ARM)/Desired Position'
//  '<S155>' : 'GNC2026W/2 - Guidance/Disable PPL (BLACK)/Desired Position'
//  '<S156>' : 'GNC2026W/2 - Guidance/Disable PPL (BLUE)/Desired Position'
//  '<S157>' : 'GNC2026W/2 - Guidance/Disable PPL (RED)/Desired Position'
//  '<S158>' : 'GNC2026W/3 - Control/Custom Control (ARM)'
//  '<S159>' : 'GNC2026W/3 - Control/Custom Control (RED)'
//  '<S160>' : 'GNC2026W/3 - Control/Default LQR Control (BLACK)'
//  '<S161>' : 'GNC2026W/3 - Control/Default LQR Control (BLUE)'
//  '<S162>' : 'GNC2026W/3 - Control/Default LQR Control (RED)'
//  '<S163>' : 'GNC2026W/3 - Control/Default PD (ARM)'
//  '<S164>' : 'GNC2026W/3 - Control/Default PD Control (BLACK)'
//  '<S165>' : 'GNC2026W/3 - Control/Default PD Control (BLUE)'
//  '<S166>' : 'GNC2026W/3 - Control/Default PD Control (RED)'
//  '<S167>' : 'GNC2026W/3 - Control/Disable Control (ARM)'
//  '<S168>' : 'GNC2026W/3 - Control/Disable Thrusters (BLACK)'
//  '<S169>' : 'GNC2026W/3 - Control/Disable Thrusters (BLUE)'
//  '<S170>' : 'GNC2026W/3 - Control/Disable Thrusters (RED)'
//  '<S171>' : 'GNC2026W/3 - Control/Custom Control (RED)/MATLAB Function2'
//  '<S172>' : 'GNC2026W/3 - Control/Custom Control (RED)/MATLAB Function3'
//  '<S173>' : 'GNC2026W/3 - Control/Custom Control (RED)/Unwrap'
//  '<S174>' : 'GNC2026W/3 - Control/Custom Control (RED)/Unwrap/Unwrap'
//  '<S175>' : 'GNC2026W/3 - Control/Custom Control (RED)/Unwrap/Unwrap/MATLAB Function'
//  '<S176>' : 'GNC2026W/3 - Control/Default LQR Control (BLACK)/Calculate Error'
//  '<S177>' : 'GNC2026W/3 - Control/Default LQR Control (BLACK)/Discrete Derivative'
//  '<S178>' : 'GNC2026W/3 - Control/Default LQR Control (BLACK)/Discrete Derivative1'
//  '<S179>' : 'GNC2026W/3 - Control/Default LQR Control (BLACK)/Discrete Derivative2'
//  '<S180>' : 'GNC2026W/3 - Control/Default LQR Control (BLACK)/Calculate Error/MATLAB Function'
//  '<S181>' : 'GNC2026W/3 - Control/Default LQR Control (BLUE)/Calculate Error'
//  '<S182>' : 'GNC2026W/3 - Control/Default LQR Control (BLUE)/Discrete Derivative'
//  '<S183>' : 'GNC2026W/3 - Control/Default LQR Control (BLUE)/Discrete Derivative1'
//  '<S184>' : 'GNC2026W/3 - Control/Default LQR Control (BLUE)/Discrete Derivative2'
//  '<S185>' : 'GNC2026W/3 - Control/Default LQR Control (BLUE)/Calculate Error/MATLAB Function'
//  '<S186>' : 'GNC2026W/3 - Control/Default LQR Control (RED)/Calculate Error'
//  '<S187>' : 'GNC2026W/3 - Control/Default LQR Control (RED)/Discrete Derivative'
//  '<S188>' : 'GNC2026W/3 - Control/Default LQR Control (RED)/Discrete Derivative1'
//  '<S189>' : 'GNC2026W/3 - Control/Default LQR Control (RED)/Discrete Derivative2'
//  '<S190>' : 'GNC2026W/3 - Control/Default LQR Control (RED)/Calculate Error/MATLAB Function'
//  '<S191>' : 'GNC2026W/3 - Control/Default PD (ARM)/Passthrough for Experiment'
//  '<S192>' : 'GNC2026W/3 - Control/Default PD (ARM)/Simulated Position Controller'
//  '<S193>' : 'GNC2026W/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Elbow)'
//  '<S194>' : 'GNC2026W/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Shoulder)'
//  '<S195>' : 'GNC2026W/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Wrist)'
//  '<S196>' : 'GNC2026W/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Elbow)/Discrete Derivative1'
//  '<S197>' : 'GNC2026W/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Shoulder)/Discrete Derivative1'
//  '<S198>' : 'GNC2026W/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Wrist)/Discrete Derivative1'
//  '<S199>' : 'GNC2026W/3 - Control/Default PD Control (BLACK)/Calculate Error'
//  '<S200>' : 'GNC2026W/3 - Control/Default PD Control (BLACK)/Discrete Derivative'
//  '<S201>' : 'GNC2026W/3 - Control/Default PD Control (BLACK)/Discrete Derivative1'
//  '<S202>' : 'GNC2026W/3 - Control/Default PD Control (BLACK)/Discrete Derivative2'
//  '<S203>' : 'GNC2026W/3 - Control/Default PD Control (BLACK)/Calculate Error/MATLAB Function'
//  '<S204>' : 'GNC2026W/3 - Control/Default PD Control (BLUE)/Calculate Error'
//  '<S205>' : 'GNC2026W/3 - Control/Default PD Control (BLUE)/Discrete Derivative'
//  '<S206>' : 'GNC2026W/3 - Control/Default PD Control (BLUE)/Discrete Derivative1'
//  '<S207>' : 'GNC2026W/3 - Control/Default PD Control (BLUE)/Discrete Derivative2'
//  '<S208>' : 'GNC2026W/3 - Control/Default PD Control (BLUE)/Calculate Error/MATLAB Function'
//  '<S209>' : 'GNC2026W/3 - Control/Default PD Control (RED)/Calculate Error'
//  '<S210>' : 'GNC2026W/3 - Control/Default PD Control (RED)/Discrete Derivative'
//  '<S211>' : 'GNC2026W/3 - Control/Default PD Control (RED)/Discrete Derivative1'
//  '<S212>' : 'GNC2026W/3 - Control/Default PD Control (RED)/Discrete Derivative2'
//  '<S213>' : 'GNC2026W/3 - Control/Default PD Control (RED)/Calculate Error/MATLAB Function'
//  '<S214>' : 'GNC2026W/Check  Connection/Change BLACK Behavior'
//  '<S215>' : 'GNC2026W/Check  Connection/Change BLUE Behavior'
//  '<S216>' : 'GNC2026W/Check  Connection/Change RED Behavior'
//  '<S217>' : 'GNC2026W/Data Logger Subsystem/Data Logger'
//  '<S218>' : 'GNC2026W/Data Logger Subsystem/Separation'
//  '<S219>' : 'GNC2026W/Data Logger Subsystem/Data Logger/MATLAB Function'
//  '<S220>' : 'GNC2026W/Data Logger Subsystem/Separation/MATLAB Function'
//  '<S221>' : 'GNC2026W/Debugger/Change BLACK Behavior'
//  '<S222>' : 'GNC2026W/Debugger/Change BLUE Behavior'
//  '<S223>' : 'GNC2026W/Debugger/Change RED Behavior'
//  '<S224>' : 'GNC2026W/Float Code/Enable Pucks'
//  '<S225>' : 'GNC2026W/Manipulator Encoder Data/Change ARM Behavior'
//  '<S226>' : 'GNC2026W/PhaseSpace Camera Code/Initialize Universal Time (Simulation)'
//  '<S227>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States'
//  '<S228>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data'
//  '<S229>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data'
//  '<S230>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data'
//  '<S231>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data'
//  '<S232>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)'
//  '<S233>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Enabled Subsystem2'
//  '<S234>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/MATLAB Function'
//  '<S235>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/MATLAB Function1'
//  '<S236>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time'
//  '<S237>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time/Change BLACK Behavior'
//  '<S238>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time/Change BLUE Behavior'
//  '<S239>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time/Change RED Behavior'
//  '<S240>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Calculate True  Time Step'
//  '<S241>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)'
//  '<S242>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem1'
//  '<S243>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem2'
//  '<S244>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Wrap'
//  '<S245>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Calculate True  Time Step/Enabled Subsystem3'
//  '<S246>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Calculate True  Time Step/MATLAB Function'
//  '<S247>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/BLK CoM to LAR'
//  '<S248>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/CV Noise'
//  '<S249>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Inertial to Camera Frame (HARDWARE)'
//  '<S250>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Sample and Hold'
//  '<S251>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Unwrap'
//  '<S252>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Unwrap/Unwrap'
//  '<S253>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Unwrap/Unwrap/MATLAB Function'
//  '<S254>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem1/Enabled Subsystem'
//  '<S255>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem1/Enabled Subsystem/MATLAB Function'
//  '<S256>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem2/Enabled Subsystem'
//  '<S257>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem2/Enabled Subsystem/MATLAB Function'
//  '<S258>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Calculate True  Time Step'
//  '<S259>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem1'
//  '<S260>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem2'
//  '<S261>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Wrap'
//  '<S262>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Calculate True  Time Step/Enabled Subsystem3'
//  '<S263>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Calculate True  Time Step/MATLAB Function'
//  '<S264>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem1/Enabled Subsystem'
//  '<S265>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem1/Enabled Subsystem/MATLAB Function'
//  '<S266>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem2/Enabled Subsystem'
//  '<S267>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem2/Enabled Subsystem/MATLAB Function'
//  '<S268>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Calculate True  Time Step'
//  '<S269>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem1'
//  '<S270>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem2'
//  '<S271>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Wrap'
//  '<S272>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Calculate True  Time Step/Enabled Subsystem3'
//  '<S273>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Calculate True  Time Step/MATLAB Function'
//  '<S274>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem1/Enabled Subsystem'
//  '<S275>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem1/Enabled Subsystem/MATLAB Function'
//  '<S276>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem2/Enabled Subsystem'
//  '<S277>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem2/Enabled Subsystem/MATLAB Function'
//  '<S278>' : 'GNC2026W/Platform  Identification/Subsystem'
//  '<S279>' : 'GNC2026W/Receive CV Data/CV UDP'
//  '<S280>' : 'GNC2026W/Receive Data from Orin/Subsystem'
//  '<S281>' : 'GNC2026W/Robotic  Arm Code/Change ARM Behavior'
//  '<S282>' : 'GNC2026W/Send Data  to Orin/Subsystem'
//  '<S283>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior'
//  '<S284>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior'
//  '<S285>' : 'GNC2026W/Thruster Control Code/Change RED Behavior'
//  '<S286>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle'
//  '<S287>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Rotate Forces to Body'
//  '<S288>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Duty Cycle @ PWM'
//  '<S289>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Generate Initial Guess'
//  '<S290>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/MATLAB Function1'
//  '<S291>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/MATLAB Function5'
//  '<S292>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Rotate Forces to Inertial'
//  '<S293>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem'
//  '<S294>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem1'
//  '<S295>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Generate Initial Guess/MATLAB Function'
//  '<S296>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Rotate Forces to Inertial/Create Rotation Matrix'
//  '<S297>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Rotate Forces to Body/Create Rotation Matrix'
//  '<S298>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle'
//  '<S299>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Rotate Forces to Body'
//  '<S300>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Duty Cycle @ PWM'
//  '<S301>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Generate Initial Guess'
//  '<S302>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/MATLAB Function1'
//  '<S303>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/MATLAB Function5'
//  '<S304>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Rotate Forces to Inertial'
//  '<S305>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem'
//  '<S306>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem1'
//  '<S307>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Generate Initial Guess/MATLAB Function'
//  '<S308>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Rotate Forces to Inertial/Create Rotation Matrix'
//  '<S309>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Rotate Forces to Body/Create Rotation Matrix'
//  '<S310>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle'
//  '<S311>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Rotate Forces to Body'
//  '<S312>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Duty Cycle @ PWM'
//  '<S313>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Generate Initial Guess'
//  '<S314>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/MATLAB Function5'
//  '<S315>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/MATLAB Function8'
//  '<S316>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Rotate Forces to Inertial'
//  '<S317>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem'
//  '<S318>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem1'
//  '<S319>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Generate Initial Guess/MATLAB Function'
//  '<S320>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Rotate Forces to Inertial/Create Rotation Matrix'
//  '<S321>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Rotate Forces to Body/Create Rotation Matrix'
//  '<S322>' : 'GNC2026W/Time Sync./Change BLACK Behavior'
//  '<S323>' : 'GNC2026W/Time Sync./Change BLUE Behavior'
//  '<S324>' : 'GNC2026W/Time Sync./Change RED Behavior'
