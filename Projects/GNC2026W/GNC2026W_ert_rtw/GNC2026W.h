...
// Block states (default storage) for system '<S264>/Change BLACK Behavior'
struct DW_ChangeBLACKBehavior_GNC2_l_T {
  real_T UDPSendGUI_NetworkLib[137];   // '<S265>/UDP Send (GUI)'
};

// Block signals for system '<S270>/Enabled Subsystem'
struct B_EnabledSubsystem_GNC2026W_T {
  real_T Delay[3];                     // '<S285>/Delay'
  real_T ema[3];                       // '<S285>/MATLAB Function'
};

// Block states (default storage) for system '<S270>/Enabled Subsystem'
struct DW_EnabledSubsystem_GNC2026W_T {
  real_T Delay_DSTATE[3];              // '<S285>/Delay'
  boolean_T EnabledSubsystem_MODE;     // '<S270>/Enabled Subsystem'
};
...
// Block states (default storage) for system '<S317>/MATLAB Function'
struct DW_MATLABFunction_GNC2026W_l_T {
  real_T set;                          // '<S317>/MATLAB Function'
};

// Block signals for system '<S327>/Pseudoinverse1'
struct B_Pseudoinverse1_GNC2026W_T {
  real_T Pseudoinverse1[24];           // '<S327>/Pseudoinverse1'
};

// Block states (default storage) for system '<S327>/Pseudoinverse1'
struct DW_Pseudoinverse1_GNC2026W_T {
  dsp_simulink_Pseudoinverse_GN_T obj; // '<S327>/Pseudoinverse1'
  boolean_T objisempty;                // '<S327>/Pseudoinverse1'
};

// Block signals for system '<S19>/Change BLACK Behavior'
struct B_ChangeBLACKBehavior_GNC20_m_T {
  real_T Clock1;                       // '<S360>/Clock1'
};

// Block states (default storage) for system '<S19>/Change BLACK Behavior'
struct DW_ChangeBLACKBehavior_GNC2_g_T {
  real_T UDPSendClock_NetworkLib[137]; // '<S360>/UDP Send (Clock)'
};
...
struct B_GNC2026W_T {
  ...
  real_T duty_cycles[8];               // '<S348>/MATLAB Function5'
  real_T ThrustPer_Final[8];           // '<S356>/ThrustPer_Final'
  real_T In1;                          // '<S355>/In1'
  real_T duty_cycles_j[8];             // '<S336>/MATLAB Function5'
  real_T ThrustPer_Final_h[8];         // '<S344>/ThrustPer_Final'
  real_T In1_g;                        // '<S343>/In1'
  real_T duty_cycles_m[8];             // '<S324>/MATLAB Function5'
  real_T ThrustPer_Final_h5[8];        // '<S332>/ThrustPer_Final'
  real_T In1_g2;                       // '<S331>/In1'
  real_T TmpSignalConversionAtUDPSendI_o[2];
  real_T TmpSignalConversionAtUDPSend_og[28];
  real_T ReceivePhaseSpaceData_o1[19]; // '<S256>/Receive PhaseSpace Data'
  real_T ConvertBLAXfrommmtom;        // '<S257>/Convert BLAX from [mm] to [m]'
  real_T ConvertBLUXfrommmtom;        // '<S258>/Convert BLUX from [mm] to [m]'
  real_T ConvertREDXfrommmtom;        // '<S259>/Convert REDX from [mm] to [m]'
  real_T UDPReceiveREDClock_o1;        // '<S260>/UDP Receive (RED Clock)'
  real_T UDPReceiveBLACKClock_o1;      // '<S260>/UDP Receive (BLACK Clock)'
  real_T UDPReceiveBLUEClock_o1;       // '<S260>/UDP Receive (BLUE Clock)'
  real_T dy[3];                        // '<S307>/MATLAB Function'
  real_T dy_h[3];                      // '<S305>/MATLAB Function'
  real_T y2y1;                         // '<S303>/y2-y1'
  real_T dy_c[3];                      // '<S297>/MATLAB Function'
  real_T dy_d[3];                      // '<S295>/MATLAB Function'
  real_T y2y1_o;                       // '<S293>/y2-y1'
  real_T dy_p[3];                      // '<S287>/MATLAB Function'
  real_T dy_g[3];                      // '<S285>/MATLAB Function'
  real_T y;                            // '<S283>/MATLAB Function'
  real_T u_next;                       // '<S283>/MATLAB Function'
  real_T y2y1_ob;                      // '<S273>/y2-y1'
  real_T In1_g20;                      // '<S261>/In1'
  real_T Merge_k[6];                   // '<S226>/Merge'
  real_T Merge_d[3];                   // '<S238>/Merge'
  real_T Merge_b[3];                   // '<S247>/Merge'
  real_T In1_g20a[3];                  // '<S154>/In1'
  real_T Merge_h[3];                   // '<S56>/Merge'
  real32_T UDPReceive_o1[5];           // '<S312>/UDP Receive'
  real32_T UDPReceive_o1_a[4];         // '<S310>/UDP Receive'
  ...
  B_Pseudoinverse1_GNC2026W_T Pseudoinverse1_pn;// '<S327>/Pseudoinverse1'
  B_Pseudoinverse1_GNC2026W_T Pseudoinverse1_p;// '<S327>/Pseudoinverse1'
  B_Pseudoinverse1_GNC2026W_T Pseudoinverse1;// '<S327>/Pseudoinverse1'
  B_EnabledSubsystem_GNC2026W_h_T EnabledSubsystem_l1;// '<S301>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_T EnabledSubsystem_k;// '<S300>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_h_T EnabledSubsystem_d;// '<S291>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_T EnabledSubsystem_l;// '<S290>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_h_T EnabledSubsystem_g;// '<S271>/Enabled Subsystem' 
  B_EnabledSubsystem_GNC2026W_T EnabledSubsystem_i;// '<S270>/Enabled Subsystem' 
};

// Block states (default storage) for system '<Root>'
struct DW_GNC2026W_T {
  Dynamixel_Controller_GNC2026W_T obj;
  // '<S314>/Control Dynamixel Actuators in  either Position, Current, or Speed  Control Modes' 
  ...
  IdentifyPlatform_GNC2026W_T obj_dk;  // '<S309>/WhoAmI'
  CustomDataLogger_GNC2026W_T obj_f;   // '<S217>/MATLAB System'
  real_T Delay_DSTATE;                 // '<S350>/Delay'
  real_T Delay_DSTATE_k;               // '<S338>/Delay'
  real_T Delay_DSTATE_kz;              // '<S326>/Delay'
  real_T Delay2_DSTATE;                // '<S268>/Delay2'
  real_T Delay1_DSTATE;                // '<S268>/Delay1'
  real_T Delay1_DSTATE_g[3];           // '<S271>/Delay1'
  real_T Delay1_DSTATE_b[3];           // '<S270>/Delay1'
  real_T Delay_DSTATE_h;               // '<S283>/Delay'
  real_T Delay1_DSTATE_f;              // '<S283>/Delay1'
  real_T Delay2_DSTATE_l;              // '<S289>/Delay2'
  real_T Delay1_DSTATE_l;              // '<S289>/Delay1'
  real_T Delay1_DSTATE_m[3];           // '<S291>/Delay1'
  real_T Delay1_DSTATE_lv[3];          // '<S290>/Delay1'
  real_T Delay2_DSTATE_l0;             // '<S299>/Delay2'
  real_T Delay1_DSTATE_ld;             // '<S299>/Delay1'
  real_T Delay1_DSTATE_c[3];           // '<S301>/Delay1'
  real_T Delay1_DSTATE_cq[3];          // '<S300>/Delay1'
  real_T Delay_DSTATE_c;               // '<S233>/Delay'
  real_T Delay1_DSTATE_g0;             // '<S233>/Delay1'
  real_T Delay_DSTATE_j;               // '<S239>/Delay'
  real_T Delay1_DSTATE_d;              // '<S239>/Delay1'
  real_T Delay_DSTATE_b;               // '<S248>/Delay'
  real_T Delay1_DSTATE_a;              // '<S248>/Delay1'
  ...
  real_T UDPSend_NetworkLib_f[137];    // '<S317>/UDP Send'
  real_T UDPSend_NetworkLib_m[137];    // '<S315>/UDP Send'
  real_T UDPReceive_NetworkLib[137];   // '<S312>/UDP Receive'
  real_T UDPReceive_NetworkLib_i[137]; // '<S310>/UDP Receive'
  real_T ReceivePhaseSpaceData_NetworkLi[137];// '<S256>/Receive PhaseSpace Data' 
  real_T UDPReceiveREDClock_NetworkLib[137];// '<S260>/UDP Receive (RED Clock)'
  real_T UDPReceiveBLACKClock_NetworkLib[137];// '<S260>/UDP Receive (BLACK Clock)' 
  real_T UDPReceiveBLUEClock_NetworkLib[137];// '<S260>/UDP Receive (BLUE Clock)' 
  real_T k;                            // '<S269>/Sample and Hold'
  real_T y_hold[3];                    // '<S269>/Sample and Hold'
  real_T k_h;                          // '<S275>/MATLAB Function1'
  real_T x[6];                         // '<S227>/EKF'
  real_T P[36];                        // '<S227>/EKF'
  real_T theta;                        // '<S227>/EKF'
  real_T theta_prev;                   // '<S227>/EKF'
  real_T x_m[5];                       // '<S228>/MEKF'
  real_T P_h[36];                      // '<S228>/MEKF'
  real_T theta_prev_a;                 // '<S228>/MEKF'
  real_T theta_cont;                   // '<S228>/MEKF'
  real_T k_g;                          // '<S228>/MEKF'
  real_T converge;                     // '<S229>/Unscented Kalman Filter'
  real_T x_i[6];                       // '<S229>/Unscented Kalman Filter'
  real_T P_f[36];                      // '<S229>/Unscented Kalman Filter'
  real_T k_c;                          // '<S229>/Unscented Kalman Filter'
  ...
  uint32_T method;                     // '<S269>/CV Noise'
  uint32_T state;                      // '<S269>/CV Noise'
  uint32_T state_g[2];                 // '<S269>/CV Noise'
  uint32_T state_j[625];               // '<S269>/CV Noise'
  ...
  // '<S264>/This IF block determines whether or not to run the BLACK sim//exp'
  int8_T ThisIFblockdetermineswhether_cs;
  // '<S264>/This IF block determines whether or not to run the BLUE sim//exp'
  int8_T ThisIFblockdetermineswhethero_d;
  // '<S264>/This IF block determines whether or not to run the RED sim//exp '
  boolean_T k_not_empty;               // '<S269>/Sample and Hold'
  boolean_T initial_theta;             // '<S227>/EKF'
  ...
  DW_Pseudoinverse1_GNC2026W_T Pseudoinverse1_pn;// '<S327>/Pseudoinverse1'
  DW_Pseudoinverse1_GNC2026W_T Pseudoinverse1_p;// '<S327>/Pseudoinverse1'
  DW_Pseudoinverse1_GNC2026W_T Pseudoinverse1;// '<S327>/Pseudoinverse1'
  DW_MATLABFunction_GNC2026W_l_T sf_MATLABFunction_cy;// '<S316>/MATLAB Function' 
  DW_MATLABFunction_GNC2026W_l_T sf_MATLABFunction_ec;// '<S317>/MATLAB Function' 
  DW_EnabledSubsystem_GNC2026_c_T EnabledSubsystem_l1;// '<S301>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026W_T EnabledSubsystem_k;// '<S300>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026_c_T EnabledSubsystem_d;// '<S291>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026W_T EnabledSubsystem_l;// '<S290>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026_c_T EnabledSubsystem_g;// '<S271>/Enabled Subsystem' 
  DW_EnabledSubsystem_GNC2026W_T EnabledSubsystem_i;// '<S270>/Enabled Subsystem' 
  DW_ChangeBLACKBehavior_GNC2_l_T ChangeREDBehavior_d;// '<S264>/Change RED Behavior' 
  DW_ChangeBLACKBehavior_GNC2_l_T ChangeBLUEBehavior_f;// '<S264>/Change BLUE Behavior' 
  DW_ChangeBLACKBehavior_GNC2_l_T ChangeBLACKBehavior_e;// '<S264>/Change BLACK Behavior' 
...
struct P_GNC2026W_T_ {
  ...
  real_T CVrate;                       // Variable: CVrate
                                          ...
                                          //    '<S227>/EKF'
                                          //    '<S228>/MEKF'
                                          //    '<S229>/Unscented Kalman Filter'
                                          //    '<S269>/Sample and Hold'
  ...
  real_T F_thrusters_BLACK[8];         // Variable: F_thrusters_BLACK
                                          //  Referenced by: '<S327>/MATLAB Function'

  real_T F_thrusters_BLUE[8];          // Variable: F_thrusters_BLUE
                                          //  Referenced by: '<S339>/MATLAB Function'

  real_T F_thrusters_RED[8];           // Variable: F_thrusters_RED
                                          //  Referenced by: '<S351>/MATLAB Function'
  ...
  real_T R[9];                         // Variable: R
                                          //  Referenced by: '<S229>/Unscented Kalman Filter'
  ...
  real_T platformSelection;            // Variable: platformSelection
                                          //  Referenced by: '<S260>/MATLAB Function'
  ...
  real_T Separation_Value;             // Expression: 0.44
  ...
  real_T ConvertREDXfrommmtom_Gain;    // Expression: 1/1000
                                          //  Referenced by: '<S259>/Convert REDX from [mm] to [m]'

  real_T ConvertREDYfrommmtom_Gain;    // Expression: 1/1000
                                          //  Referenced by: '<S259>/Convert REDY from [mm] to [m]'

  real_T ConvertREDVXfrommmtom_Gain;   // Expression: 1/1000
                                          //  Referenced by: '<S259>/Convert REDVX from [mm] to [m]'

  real_T ConvertREDVYfrommmtom_Gain;   // Expression: 1/1000
                                          //  Referenced by: '<S259>/Convert REDVY from [mm] to [m]'
  ...
  real_T ControlDynamixelActuatorsineith;// Expression: 400
                                            //  Referenced by: '<S314>/Control Dynamixel Actuators in  either Position, Current, or Speed  Control Modes'
  ...
  uint8_T ManualSwitch_CurrentSetting;
                              // Computed Parameter: ManualSwitch_CurrentSetting
                                 //  Referenced by: '<S313>/Manual Switch'
  ...
  P_EnabledSubsystem_GNC2026W_c_T EnabledSubsystem_l1;// '<S301>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_T EnabledSubsystem_k;// '<S300>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_c_T EnabledSubsystem_d;// '<S291>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_T EnabledSubsystem_l;// '<S290>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_c_T EnabledSubsystem_g;// '<S271>/Enabled Subsystem' 
  P_EnabledSubsystem_GNC2026W_T EnabledSubsystem_i;// '<S270>/Enabled Subsystem' 
  P_ChangeBLACKBehavior_GNC20_p_T ChangeREDBehavior_d;// '<S264>/Change RED Behavior' 
  P_ChangeBLACKBehavior_GNC20_p_T ChangeBLUEBehavior_f;// '<S264>/Change BLUE Behavior' 
  P_ChangeBLACKBehavior_GNC20_p_T ChangeBLACKBehavior_e;// '<S264>/Change BLACK Behavior' 
...
//  Block '<S269>/Scope2' : Unused code path elimination
//  Block '<S269>/Scope3' : Unused code path elimination
//  Block '<S269>/Scope4' : Unused code path elimination
//  Block '<S312>/Cast To Double1' : Unused code path elimination
//  Block '<S312>/Display' : Unused code path elimination
//  Block '<S312>/Scope' : Unused code path elimination
//  Block '<S313>/Scope1' : Unused code path elimination
//  Block '<S317>/Scope1' : Unused code path elimination
//  Block '<S317>/Scope2' : Unused code path elimination
//  Block '<S317>/Scope4' : Unused code path elimination
//  Block '<S317>/Scope5' : Unused code path elimination
...
//  '<S174>' : 'GNC2026W/3 - Control/Custom Control (RED)/MATLAB Function2'
//  '<S175>' : 'GNC2026W/3 - Control/Custom Control (RED)/MATLAB Function3'
...
//  '<S226>' : 'GNC2026W/Navigation Filter/If Action Subsystem'
//  '<S227>' : 'GNC2026W/Navigation Filter/If Action Subsystem/EKF'
//  '<S228>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF'
//  '<S229>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF'
//  '<S230>' : 'GNC2026W/Navigation Filter/If Action Subsystem/EKF/Camera to Inertial Frame'
//  '<S231>' : 'GNC2026W/Navigation Filter/If Action Subsystem/EKF/EKF'
//  '<S232>' : 'GNC2026W/Navigation Filter/If Action Subsystem/EKF/Unwrap'
//  '<S233>' : 'GNC2026W/Navigation Filter/If Action Subsystem/EKF/Unwrap/Unwrap'
//  '<S234>' : 'GNC2026W/Navigation Filter/If Action Subsystem/EKF/Unwrap/Unwrap/MATLAB Function'
//  '<S235>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/Camera to Inertial Frame'
//  '<S236>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/MEKF'
//  '<S237>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/Unwrap'
//  '<S238>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/VIS Measured States'
//  '<S239>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/Unwrap/Unwrap'
//  '<S240>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/Unwrap/Unwrap/MATLAB Function'
//  '<S241>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/VIS Measured States/Artificial VIS States'
//  '<S242>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/VIS Measured States/Experimental VIS States'
//  '<S243>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/VIS Measured States/Experimental VIS States/If Action Subsystem'
//  '<S244>' : 'GNC2026W/Navigation Filter/If Action Subsystem/MEKF/VIS Measured States/Experimental VIS States/If Action Subsystem1'
//  '<S245>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/Unscented Kalman Filter'
//  '<S246>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/Unwrap'
//  '<S247>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/VIS Measured States'
//  '<S248>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/Unwrap/Unwrap'
//  '<S249>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/Unwrap/Unwrap/MATLAB Function'
//  '<S250>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/VIS Measured States/Artificial VIS States'
//  '<S251>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/VIS Measured States/Experimental VIS States'
//  '<S252>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/VIS Measured States/Experimental VIS States/If Action Subsystem'
//  '<S253>' : 'GNC2026W/Navigation Filter/If Action Subsystem/UKF/VIS Measured States/Experimental VIS States/If Action Subsystem1'
//  '<S254>' : 'GNC2026W/PhaseSpace Camera Code/Initialize Universal Time (Simulation)'
//  '<S255>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States'
//  '<S256>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data'
//  '<S257>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data'
//  '<S258>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data'
//  '<S259>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data'
//  '<S260>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)'
//  '<S261>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Enabled Subsystem2'
//  '<S262>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/MATLAB Function'
//  '<S263>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/MATLAB Function1'
//  '<S264>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time'
//  '<S265>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time/Change BLACK Behavior'
//  '<S266>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time/Change BLUE Behavior'
//  '<S267>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time/Change RED Behavior'
//  '<S268>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Calculate True  Time Step'
//  '<S269>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)'
//  '<S270>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem1'
//  '<S271>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem2'
//  '<S272>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Wrap'
//  '<S273>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Calculate True  Time Step/Enabled Subsystem3'
//  '<S274>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Calculate True  Time Step/MATLAB Function'
//  '<S275>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Artificial isValid Flag'
//  '<S276>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/BLK CoM to LAR'
//  '<S277>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/CV Noise'
//  '<S278>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Inertial to Camera Frame (HARDWARE)'
//  '<S279>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/MATLAB Function'
//  '<S280>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Sample and Hold'
//  '<S281>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Unwrap'
//  '<S282>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Artificial isValid Flag/MATLAB Function1'
//  '<S283>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Unwrap/Unwrap'
//  '<S284>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/Unwrap/Unwrap/MATLAB Function'
//  '<S285>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem1/Enabled Subsystem'
//  '<S286>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem1/Enabled Subsystem/MATLAB Function'
//  '<S287>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem2/Enabled Subsystem'
//  '<S288>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem2/Enabled Subsystem/MATLAB Function'
//  '<S289>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Calculate True  Time Step'
//  '<S290>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem1'
//  '<S291>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem2'
//  '<S292>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Wrap'
//  '<S293>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Calculate True  Time Step/Enabled Subsystem3'
//  '<S294>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Calculate True  Time Step/MATLAB Function'
//  '<S295>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem1/Enabled Subsystem'
//  '<S296>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem1/Enabled Subsystem/MATLAB Function'
//  '<S297>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem2/Enabled Subsystem'
//  '<S298>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem2/Enabled Subsystem/MATLAB Function'
//  '<S299>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Calculate True  Time Step'
//  '<S300>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem1'
//  '<S301>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem2'
//  '<S302>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Wrap'
//  '<S303>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Calculate True  Time Step/Enabled Subsystem3'
//  '<S304>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Calculate True  Time Step/MATLAB Function'
//  '<S305>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem1/Enabled Subsystem'
//  '<S306>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem1/Enabled Subsystem/MATLAB Function'
//  '<S307>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem2/Enabled Subsystem'
//  '<S308>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem2/Enabled Subsystem/MATLAB Function'
//  '<S309>' : 'GNC2026W/Platform  Identification/Subsystem'
//  '<S310>' : 'GNC2026W/Receive CV Data/CV UDP'
//  '<S311>' : 'GNC2026W/Receive CV Data/CV UDP/Reading isValid'
//  '<S312>' : 'GNC2026W/Recieve ROB  Data/ROB UDP'
//  '<S313>' : 'GNC2026W/Recieve ROB  Data/Simulated Flag'
//  '<S314>' : 'GNC2026W/Robotic  Arm Code/Change ARM Behavior'
//  '<S315>' : 'GNC2026W/Send Data  to Orin/Subsystem'
//  '<S316>' : 'GNC2026W/Send Data  to ROB/Extend Arm in SIM'
//  '<S317>' : 'GNC2026W/Send Data  to ROB/SEND ROB UDP'
//  '<S318>' : 'GNC2026W/Send Data  to ROB/Extend Arm in SIM/MATLAB Function'
//  '<S319>' : 'GNC2026W/Send Data  to ROB/SEND ROB UDP/MATLAB Function'
//  '<S320>' : 'GNC2026W/Send Data  to ROB/SEND ROB UDP/MATLAB Function2'
//  '<S321>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior'
//  '<S322>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior'
//  '<S323>' : 'GNC2026W/Thruster Control Code/Change RED Behavior'
//  '<S324>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle'
//  '<S325>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Rotate Forces to Body'
//  '<S326>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Duty Cycle @ PWM'
//  '<S327>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Generate Initial Guess'
//  '<S328>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/MATLAB Function1'
//  '<S329>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/MATLAB Function5'
//  '<S330>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Rotate Forces to Inertial'
//  '<S331>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem'
//  '<S332>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem1'
//  '<S333>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Generate Initial Guess/MATLAB Function'
//  '<S334>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Rotate Forces to Inertial/Create Rotation Matrix'
//  '<S335>' : 'GNC2026W/Thruster Control Code/Change BLACK Behavior/Rotate Forces to Body/Create Rotation Matrix'
//  '<S336>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle'
//  '<S337>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Rotate Forces to Body'
//  '<S338>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Duty Cycle @ PWM'
//  '<S339>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Generate Initial Guess'
//  '<S340>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/MATLAB Function1'
//  '<S341>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/MATLAB Function5'
//  '<S342>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Rotate Forces to Inertial'
//  '<S343>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem'
//  '<S344>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem1'
//  '<S345>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Generate Initial Guess/MATLAB Function'
//  '<S346>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Rotate Forces to Inertial/Create Rotation Matrix'
//  '<S347>' : 'GNC2026W/Thruster Control Code/Change BLUE Behavior/Rotate Forces to Body/Create Rotation Matrix'
//  '<S348>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle'
//  '<S349>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Rotate Forces to Body'
//  '<S350>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Duty Cycle @ PWM'
//  '<S351>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Generate Initial Guess'
//  '<S352>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/MATLAB Function5'
//  '<S353>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/MATLAB Function8'
//  '<S354>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Rotate Forces to Inertial'
//  '<S355>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem'
//  '<S356>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem1'
//  '<S357>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Generate Initial Guess/MATLAB Function'
//  '<S358>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Rotate Forces to Inertial/Create Rotation Matrix'
//  '<S359>' : 'GNC2026W/Thruster Control Code/Change RED Behavior/Rotate Forces to Body/Create Rotation Matrix'
//  '<S360>' : 'GNC2026W/Time Sync./Change BLACK Behavior'
//  '<S361>' : 'GNC2026W/Time Sync./Change BLUE Behavior'
//  '<S362>' : 'GNC2026W/Time Sync./Change RED Behavior'
