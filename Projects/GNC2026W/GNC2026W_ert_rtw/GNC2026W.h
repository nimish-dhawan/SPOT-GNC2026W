...
struct DW_GNC2026W_T {
  ...
  real_T k_h;                          // '<S241>/MATLAB Function1'
  ...
  real_T k_hq;                         // '<S134>/Unscented Kalman Filter'
...
//  Block '<S280>/Cast To Double3' : Unused code path elimination
...
//  '<S250>' : 'GNC2026W/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Simulated Noise  (HARDWARE)/MATLAB Function1'
