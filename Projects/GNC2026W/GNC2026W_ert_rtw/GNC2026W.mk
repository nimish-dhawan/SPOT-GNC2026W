...
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/srlre/OneDrive/Documents/GitHub/SPOT-GNC2026W/Projects/GNC2026W
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
custom_data_logger.cpp.o : $(MATLAB_WORKSPACE)/C/Users/srlre/OneDrive/Documents/GitHub/SPOT-GNC2026W/Custom_Library/Resources/CustomDataLogger/src/custom_data_logger.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
protocol1_packet_handler.cpp.o : $(MATLAB_WORKSPACE)/C/Users/srlre/OneDrive/Documents/GitHub/SPOT-GNC2026W/Custom_Library/Dynamixel_Actuators/src/protocol1_packet_handler.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


port_handler_windows.cpp.o : $(MATLAB_WORKSPACE)/C/Users/srlre/OneDrive/Documents/GitHub/SPOT-GNC2026W/Custom_Library/Dynamixel_Actuators/src/port_handler_windows.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


port_handler_mac.cpp.o : $(MATLAB_WORKSPACE)/C/Users/srlre/OneDrive/Documents/GitHub/SPOT-GNC2026W/Custom_Library/Dynamixel_Actuators/src/port_handler_mac.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


port_handler_linux.cpp.o : $(MATLAB_WORKSPACE)/C/Users/srlre/OneDrive/Documents/GitHub/SPOT-GNC2026W/Custom_Library/Dynamixel_Actuators/src/port_handler_linux.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


port_handler_arduino.cpp.o : $(MATLAB_WORKSPACE)/C/Users/srlre/OneDrive/Documents/GitHub/SPOT-GNC2026W/Custom_Library/Dynamixel_Actuators/src/port_handler_arduino.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


port_handler.cpp.o : $(MATLAB_WORKSPACE)/C/Users/srlre/OneDrive/Documents/GitHub/SPOT-GNC2026W/Custom_Library/Dynamixel_Actuators/src/port_handler.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


packet_handler.cpp.o : $(MATLAB_WORKSPACE)/C/Users/srlre/OneDrive/Documents/GitHub/SPOT-GNC2026W/Custom_Library/Dynamixel_Actuators/src/packet_handler.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


group_sync_write.cpp.o : $(MATLAB_WORKSPACE)/C/Users/srlre/OneDrive/Documents/GitHub/SPOT-GNC2026W/Custom_Library/Dynamixel_Actuators/src/group_sync_write.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


group_sync_read.cpp.o : $(MATLAB_WORKSPACE)/C/Users/srlre/OneDrive/Documents/GitHub/SPOT-GNC2026W/Custom_Library/Dynamixel_Actuators/src/group_sync_read.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


group_bulk_write.cpp.o : $(MATLAB_WORKSPACE)/C/Users/srlre/OneDrive/Documents/GitHub/SPOT-GNC2026W/Custom_Library/Dynamixel_Actuators/src/group_bulk_write.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


group_bulk_read.cpp.o : $(MATLAB_WORKSPACE)/C/Users/srlre/OneDrive/Documents/GitHub/SPOT-GNC2026W/Custom_Library/Dynamixel_Actuators/src/group_bulk_read.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


dynamixel_functions.cpp.o : $(MATLAB_WORKSPACE)/C/Users/srlre/OneDrive/Documents/GitHub/SPOT-GNC2026W/Custom_Library/Dynamixel_Actuators/src/dynamixel_functions.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
