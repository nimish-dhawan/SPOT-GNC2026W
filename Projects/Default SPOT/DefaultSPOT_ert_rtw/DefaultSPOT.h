...
//
#ifndef DefaultSPOT_h_
#define DefaultSPOT_h_
#include "rtwtypes.h"
...
struct B_EnabledSubsystem_DefaultS_h_T {
...
struct B_DefaultSPOT_T {
  ...
  B_Pseudoinverse1_DefaultSPOT_T Pseudoinverse1_pn;// '<S234>/Pseudoinverse1'
  B_Pseudoinverse1_DefaultSPOT_T Pseudoinverse1_p;// '<S234>/Pseudoinverse1'
  B_Pseudoinverse1_DefaultSPOT_T Pseudoinverse1;// '<S234>/Pseudoinverse1'
  B_EnabledSubsystem_DefaultS_h_T EnabledSubsystem_l1;// '<S216>/Enabled Subsystem' 
  B_EnabledSubsystem_DefaultSPO_T EnabledSubsystem_k;// '<S215>/Enabled Subsystem' 
  B_EnabledSubsystem_DefaultS_h_T EnabledSubsystem_d;// '<S206>/Enabled Subsystem' 
  B_EnabledSubsystem_DefaultSPO_T EnabledSubsystem_l;// '<S205>/Enabled Subsystem' 
  B_EnabledSubsystem_DefaultS_h_T EnabledSubsystem_g;// '<S196>/Enabled Subsystem' 
  B_EnabledSubsystem_DefaultSPO_T EnabledSubsystem;// '<S195>/Enabled Subsystem' 
};

// Block states (default storage) for system '<Root>'
struct DW_DefaultSPOT_T {
  nvidiacoder_sensors_BMI160Blo_T obj; // '<S177>/Gyroscope//Accelerometer'
  Dynamixel_Controller_DefaultS_T obj_n;
  // '<S226>/Control Dynamixel Actuators in  either Position, Current, or Speed  Control Modes' 
  GPIO_Write_DefaultSPOT_T obj_l;      // '<S176>/GPIO Write1'
  ReadArm_Position_Rates_Defaul_T obj_d;
                     // '<S179>/Read Joint Positions using  Dynamixel Encoders'
  IdentifyPlatform_DefaultSPOT_T obj_dk;// '<S224>/WhoAmI'
  CustomDataLogger_DefaultSPOT_T obj_f;// '<S171>/MATLAB System'
  ...
  DW_Pseudoinverse1_DefaultSPOT_T Pseudoinverse1_pn;// '<S234>/Pseudoinverse1'
  DW_Pseudoinverse1_DefaultSPOT_T Pseudoinverse1_p;// '<S234>/Pseudoinverse1'
  DW_Pseudoinverse1_DefaultSPOT_T Pseudoinverse1;// '<S234>/Pseudoinverse1'
  DW_EnabledSubsystem_Default_c_T EnabledSubsystem_l1;// '<S216>/Enabled Subsystem' 
  DW_EnabledSubsystem_DefaultSP_T EnabledSubsystem_k;// '<S215>/Enabled Subsystem' 
  DW_EnabledSubsystem_Default_c_T EnabledSubsystem_d;// '<S206>/Enabled Subsystem' 
  DW_EnabledSubsystem_DefaultSP_T EnabledSubsystem_l;// '<S205>/Enabled Subsystem' 
  DW_EnabledSubsystem_Default_c_T EnabledSubsystem_g;// '<S196>/Enabled Subsystem' 
  DW_EnabledSubsystem_DefaultSP_T EnabledSubsystem;// '<S195>/Enabled Subsystem' 
...
struct P_SubPhase1_DefaultSPOT_T_ {
...
struct P_Phase4ReturnHome_DefaultSPO_T_ {
  real_T Constant11_Value;             // Expression: 0
...
struct P_CustomControlRED_DefaultSPO_T_ {
...
struct P_EnabledSubsystem_DefaultSPO_T_ {
...
struct P_EnabledSubsystem_DefaultS_c_T_ {
  real_T dydt_Y0;                      // Computed Parameter: dydt_Y0
...
struct P_DefaultSPOT_T_ {
  ...
  P_EnabledSubsystem_DefaultS_c_T EnabledSubsystem_l1;// '<S216>/Enabled Subsystem' 
  P_EnabledSubsystem_DefaultSPO_T EnabledSubsystem_k;// '<S215>/Enabled Subsystem' 
  P_EnabledSubsystem_DefaultS_c_T EnabledSubsystem_d;// '<S206>/Enabled Subsystem' 
  P_EnabledSubsystem_DefaultSPO_T EnabledSubsystem_l;// '<S205>/Enabled Subsystem' 
  P_EnabledSubsystem_DefaultS_c_T EnabledSubsystem_g;// '<S196>/Enabled Subsystem' 
  P_EnabledSubsystem_DefaultSPO_T EnabledSubsystem;// '<S195>/Enabled Subsystem' 
  ...
  P_CustomControlRED_DefaultSPO_T CustomControlARM;// '<S3>/Custom Control (ARM)' 
  ...
  P_CustomControlRED_DefaultSPO_T DisableThrustersRED;// '<S3>/Disable Thrusters (RED)' 
  P_CustomControlRED_DefaultSPO_T CustomControlRED;// '<S3>/Custom Control (RED)' 
  P_Phase0Synchronization_Defau_T Phase6CleanShutdown;// '<S1>/Phase #6: Clean Shutdown' 
  P_Phase4ReturnHome_DefaultSPO_T Phase5HoldHome;// '<S1>/Phase #5: Hold Home'
  P_Phase4ReturnHome_DefaultSPO_T Phase4ReturnHome;// '<S1>/Phase #4: Return Home' 
  P_SubPhase1_DefaultSPOT_T SubPhase4; // '<S21>/Sub-Phase #4'
  P_SubPhase1_DefaultSPOT_T SubPhase3; // '<S21>/Sub-Phase #3 '
  P_SubPhase1_DefaultSPOT_T SubPhase2; // '<S21>/Sub-Phase #2 '
  P_SubPhase1_DefaultSPOT_T SubPhase1; // '<S21>/Sub-Phase #1'
...
extern "C"
{
  ...
  extern P_DefaultSPOT_T DefaultSPOT_P;
...
extern "C"
{
  ...
  extern struct B_DefaultSPOT_T DefaultSPOT_B;
...
extern struct DW_DefaultSPOT_T DefaultSPOT_DW;
...
extern "C"
{
  ...
  extern void DefaultSPOT_initialize(void);
  extern void DefaultSPOT_step(void);
  extern void DefaultSPOT_terminate(void);
...
extern "C"
{
  ...
  extern RT_MODEL_DefaultSPOT_T *const DefaultSPOT_M;
...
//
//  '<Root>' : 'DefaultSPOT'
//  '<S1>'   : 'DefaultSPOT/1 - Experiment Logic'
//  '<S2>'   : 'DefaultSPOT/2 - Guidance'
//  '<S3>'   : 'DefaultSPOT/3 - Control'
//  '<S4>'   : 'DefaultSPOT/Check  Connection'
//  '<S5>'   : 'DefaultSPOT/Data Logger Subsystem'
//  '<S6>'   : 'DefaultSPOT/Debugger'
//  '<S7>'   : 'DefaultSPOT/Float Code'
//  '<S8>'   : 'DefaultSPOT/Gyro.//Accel. Code'
//  '<S9>'   : 'DefaultSPOT/Manipulator Encoder Data'
//  '<S10>'  : 'DefaultSPOT/PhaseSpace Camera Code'
//  '<S11>'  : 'DefaultSPOT/Platform  Identification'
//  '<S12>'  : 'DefaultSPOT/Receive Data from Orin'
//  '<S13>'  : 'DefaultSPOT/Robotic  Arm Code'
//  '<S14>'  : 'DefaultSPOT/Send Data  to Orin'
//  '<S15>'  : 'DefaultSPOT/Simulation  Status'
//  '<S16>'  : 'DefaultSPOT/Thruster Control Code'
//  '<S17>'  : 'DefaultSPOT/Time Sync.'
//  '<S18>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #0: Synchronization'
//  '<S19>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #1: Start Floating '
//  '<S20>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #2: Initial Position'
//  '<S21>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment'
//  '<S22>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #4: Return Home'
//  '<S23>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #5: Hold Home'
//  '<S24>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #6: Clean Shutdown'
//  '<S25>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #2: Initial Position/Desired Joint Angles RED'
//  '<S26>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #2: Initial Position/Desired Position BLACK'
//  '<S27>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #2: Initial Position/Desired Position BLUE'
//  '<S28>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #2: Initial Position/Desired Position RED'
//  '<S29>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #1'
//  '<S30>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 '
//  '<S31>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 '
//  '<S32>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4'
//  '<S33>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #1/Desired Joint Angles RED'
//  '<S34>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #1/Desired Position BLACK'
//  '<S35>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #1/Desired Position BLUE'
//  '<S36>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #1/Desired Position RED'
//  '<S37>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #1/Desired Position BLACK/BLACK_Rz Desired'
//  '<S38>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #1/Desired Position BLACK/Wrap'
//  '<S39>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #1/Desired Position BLACK/BLACK_Rz Desired/Subsystem'
//  '<S40>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #1/Desired Position BLUE/Calculate Circular Tracking'
//  '<S41>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #1/Desired Position BLUE/Calculate Time since Phase #3 Start'
//  '<S42>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #1/Desired Position BLUE/Wrap'
//  '<S43>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #1/Desired Position BLUE/Calculate Time since Phase #3 Start/Subsystem'
//  '<S44>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #1/Desired Position RED/Calculate Circular Tracking'
//  '<S45>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #1/Desired Position RED/Calculate Time since Phase #3 Start'
//  '<S46>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #1/Desired Position RED/Wrap'
//  '<S47>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #1/Desired Position RED/Calculate Time since Phase #3 Start/Subsystem'
//  '<S48>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Desired Joint Angles RED'
//  '<S49>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Desired Position BLACK'
//  '<S50>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Desired Position BLUE'
//  '<S51>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Desired Position RED'
//  '<S52>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Desired Position BLACK/BLACK_Rz Desired'
//  '<S53>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Desired Position BLACK/Wrap'
//  '<S54>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Desired Position BLACK/BLACK_Rz Desired/Subsystem'
//  '<S55>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Desired Position BLUE/Calculate Circular Tracking'
//  '<S56>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Desired Position BLUE/Calculate Time since Phase #3 Start'
//  '<S57>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Desired Position BLUE/Wrap'
//  '<S58>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Desired Position BLUE/Calculate Time since Phase #3 Start/Subsystem'
//  '<S59>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Desired Position RED/Calculate Circular Tracking'
//  '<S60>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Desired Position RED/Calculate Time since Phase #3 Start'
//  '<S61>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Desired Position RED/Wrap'
//  '<S62>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #2 /Desired Position RED/Calculate Time since Phase #3 Start/Subsystem'
//  '<S63>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Joint Angles RED'
//  '<S64>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK'
//  '<S65>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLUE'
//  '<S66>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED'
//  '<S67>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK/BLACK_Rz Desired'
//  '<S68>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK/Wrap'
//  '<S69>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLACK/BLACK_Rz Desired/Subsystem'
//  '<S70>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLUE/Calculate Circular Tracking'
//  '<S71>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLUE/Calculate Time since Phase #3 Start'
//  '<S72>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLUE/Wrap'
//  '<S73>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position BLUE/Calculate Time since Phase #3 Start/Subsystem'
//  '<S74>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED/Calculate Circular Tracking'
//  '<S75>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED/Calculate Time since Phase #3 Start'
//  '<S76>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED/Wrap'
//  '<S77>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #3 /Desired Position RED/Calculate Time since Phase #3 Start/Subsystem'
//  '<S78>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Joint Angles RED'
//  '<S79>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLACK'
//  '<S80>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLUE'
//  '<S81>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED'
//  '<S82>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLACK/BLACK_Rz Desired'
//  '<S83>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLACK/Wrap'
//  '<S84>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLACK/BLACK_Rz Desired/Subsystem'
//  '<S85>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLUE/Calculate Circular Tracking'
//  '<S86>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLUE/Calculate Time since Phase #3 Start'
//  '<S87>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLUE/Wrap'
//  '<S88>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position BLUE/Calculate Time since Phase #3 Start/Subsystem'
//  '<S89>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED/Calculate Circular Tracking'
//  '<S90>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED/Calculate Time since Phase #3 Start'
//  '<S91>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED/Wrap'
//  '<S92>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #3: Experiment/Sub-Phase #4/Desired Position RED/Calculate Time since Phase #3 Start/Subsystem'
//  '<S93>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #4: Return Home/Desired Joint Angles RED'
//  '<S94>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #4: Return Home/Desired Position BLACK'
//  '<S95>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #4: Return Home/Desired Position BLUE'
//  '<S96>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #4: Return Home/Desired Position RED'
//  '<S97>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #5: Hold Home/Desired Joint Angles RED'
//  '<S98>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #5: Hold Home/Desired Position BLACK'
//  '<S99>'  : 'DefaultSPOT/1 - Experiment Logic/Phase #5: Hold Home/Desired Position BLUE'
//  '<S100>' : 'DefaultSPOT/1 - Experiment Logic/Phase #5: Hold Home/Desired Position RED'
//  '<S101>' : 'DefaultSPOT/2 - Guidance/Custom PPL (ARM)'
//  '<S102>' : 'DefaultSPOT/2 - Guidance/Custom PPL (BLACK)'
//  '<S103>' : 'DefaultSPOT/2 - Guidance/Custom PPL (BLUE)'
//  '<S104>' : 'DefaultSPOT/2 - Guidance/Custom PPL (RED)'
//  '<S105>' : 'DefaultSPOT/2 - Guidance/Disable PPL (ARM)'
//  '<S106>' : 'DefaultSPOT/2 - Guidance/Disable PPL (BLACK)'
//  '<S107>' : 'DefaultSPOT/2 - Guidance/Disable PPL (BLUE)'
//  '<S108>' : 'DefaultSPOT/2 - Guidance/Disable PPL (RED)'
//  '<S109>' : 'DefaultSPOT/2 - Guidance/Custom PPL (ARM)/Desired Position'
//  '<S110>' : 'DefaultSPOT/2 - Guidance/Custom PPL (BLACK)/Desired Position'
//  '<S111>' : 'DefaultSPOT/2 - Guidance/Custom PPL (BLUE)/Desired Position'
//  '<S112>' : 'DefaultSPOT/2 - Guidance/Custom PPL (RED)/Desired Position'
//  '<S113>' : 'DefaultSPOT/2 - Guidance/Disable PPL (ARM)/Desired Position'
//  '<S114>' : 'DefaultSPOT/2 - Guidance/Disable PPL (BLACK)/Desired Position'
//  '<S115>' : 'DefaultSPOT/2 - Guidance/Disable PPL (BLUE)/Desired Position'
//  '<S116>' : 'DefaultSPOT/2 - Guidance/Disable PPL (RED)/Desired Position'
//  '<S117>' : 'DefaultSPOT/3 - Control/Custom Control (ARM)'
//  '<S118>' : 'DefaultSPOT/3 - Control/Custom Control (RED)'
//  '<S119>' : 'DefaultSPOT/3 - Control/Default LQR Control (BLACK)'
//  '<S120>' : 'DefaultSPOT/3 - Control/Default LQR Control (BLUE)'
//  '<S121>' : 'DefaultSPOT/3 - Control/Default LQR Control (RED)'
//  '<S122>' : 'DefaultSPOT/3 - Control/Default PD (ARM)'
//  '<S123>' : 'DefaultSPOT/3 - Control/Default PD Control (BLACK)'
//  '<S124>' : 'DefaultSPOT/3 - Control/Default PD Control (BLUE)'
//  '<S125>' : 'DefaultSPOT/3 - Control/Default PD Control (RED)'
//  '<S126>' : 'DefaultSPOT/3 - Control/Disable Control (ARM)'
//  '<S127>' : 'DefaultSPOT/3 - Control/Disable Thrusters (BLACK)'
//  '<S128>' : 'DefaultSPOT/3 - Control/Disable Thrusters (BLUE)'
//  '<S129>' : 'DefaultSPOT/3 - Control/Disable Thrusters (RED)'
//  '<S130>' : 'DefaultSPOT/3 - Control/Default LQR Control (BLACK)/Calculate Error'
//  '<S131>' : 'DefaultSPOT/3 - Control/Default LQR Control (BLACK)/Discrete Derivative'
//  '<S132>' : 'DefaultSPOT/3 - Control/Default LQR Control (BLACK)/Discrete Derivative1'
//  '<S133>' : 'DefaultSPOT/3 - Control/Default LQR Control (BLACK)/Discrete Derivative2'
//  '<S134>' : 'DefaultSPOT/3 - Control/Default LQR Control (BLACK)/Calculate Error/MATLAB Function'
//  '<S135>' : 'DefaultSPOT/3 - Control/Default LQR Control (BLUE)/Calculate Error'
//  '<S136>' : 'DefaultSPOT/3 - Control/Default LQR Control (BLUE)/Discrete Derivative'
//  '<S137>' : 'DefaultSPOT/3 - Control/Default LQR Control (BLUE)/Discrete Derivative1'
//  '<S138>' : 'DefaultSPOT/3 - Control/Default LQR Control (BLUE)/Discrete Derivative2'
//  '<S139>' : 'DefaultSPOT/3 - Control/Default LQR Control (BLUE)/Calculate Error/MATLAB Function'
//  '<S140>' : 'DefaultSPOT/3 - Control/Default LQR Control (RED)/Calculate Error'
//  '<S141>' : 'DefaultSPOT/3 - Control/Default LQR Control (RED)/Discrete Derivative'
//  '<S142>' : 'DefaultSPOT/3 - Control/Default LQR Control (RED)/Discrete Derivative1'
//  '<S143>' : 'DefaultSPOT/3 - Control/Default LQR Control (RED)/Discrete Derivative2'
//  '<S144>' : 'DefaultSPOT/3 - Control/Default LQR Control (RED)/Calculate Error/MATLAB Function'
//  '<S145>' : 'DefaultSPOT/3 - Control/Default PD (ARM)/Passthrough for Experiment'
//  '<S146>' : 'DefaultSPOT/3 - Control/Default PD (ARM)/Simulated Position Controller'
//  '<S147>' : 'DefaultSPOT/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Elbow)'
//  '<S148>' : 'DefaultSPOT/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Shoulder)'
//  '<S149>' : 'DefaultSPOT/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Wrist)'
//  '<S150>' : 'DefaultSPOT/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Elbow)/Discrete Derivative1'
//  '<S151>' : 'DefaultSPOT/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Shoulder)/Discrete Derivative1'
//  '<S152>' : 'DefaultSPOT/3 - Control/Default PD (ARM)/Simulated Position Controller/Custom Discrete PD (Wrist)/Discrete Derivative1'
//  '<S153>' : 'DefaultSPOT/3 - Control/Default PD Control (BLACK)/Calculate Error'
//  '<S154>' : 'DefaultSPOT/3 - Control/Default PD Control (BLACK)/Discrete Derivative'
//  '<S155>' : 'DefaultSPOT/3 - Control/Default PD Control (BLACK)/Discrete Derivative1'
//  '<S156>' : 'DefaultSPOT/3 - Control/Default PD Control (BLACK)/Discrete Derivative2'
//  '<S157>' : 'DefaultSPOT/3 - Control/Default PD Control (BLACK)/Calculate Error/MATLAB Function'
//  '<S158>' : 'DefaultSPOT/3 - Control/Default PD Control (BLUE)/Calculate Error'
//  '<S159>' : 'DefaultSPOT/3 - Control/Default PD Control (BLUE)/Discrete Derivative'
//  '<S160>' : 'DefaultSPOT/3 - Control/Default PD Control (BLUE)/Discrete Derivative1'
//  '<S161>' : 'DefaultSPOT/3 - Control/Default PD Control (BLUE)/Discrete Derivative2'
//  '<S162>' : 'DefaultSPOT/3 - Control/Default PD Control (BLUE)/Calculate Error/MATLAB Function'
//  '<S163>' : 'DefaultSPOT/3 - Control/Default PD Control (RED)/Calculate Error'
//  '<S164>' : 'DefaultSPOT/3 - Control/Default PD Control (RED)/Discrete Derivative'
//  '<S165>' : 'DefaultSPOT/3 - Control/Default PD Control (RED)/Discrete Derivative1'
//  '<S166>' : 'DefaultSPOT/3 - Control/Default PD Control (RED)/Discrete Derivative2'
//  '<S167>' : 'DefaultSPOT/3 - Control/Default PD Control (RED)/Calculate Error/MATLAB Function'
//  '<S168>' : 'DefaultSPOT/Check  Connection/Change BLACK Behavior'
//  '<S169>' : 'DefaultSPOT/Check  Connection/Change BLUE Behavior'
//  '<S170>' : 'DefaultSPOT/Check  Connection/Change RED Behavior'
//  '<S171>' : 'DefaultSPOT/Data Logger Subsystem/Data Logger'
//  '<S172>' : 'DefaultSPOT/Data Logger Subsystem/Data Logger/MATLAB Function'
//  '<S173>' : 'DefaultSPOT/Debugger/Change BLACK Behavior'
//  '<S174>' : 'DefaultSPOT/Debugger/Change BLUE Behavior'
//  '<S175>' : 'DefaultSPOT/Debugger/Change RED Behavior'
//  '<S176>' : 'DefaultSPOT/Float Code/Enable Pucks'
//  '<S177>' : 'DefaultSPOT/Gyro.//Accel. Code/Log Gyro//Accel'
//  '<S178>' : 'DefaultSPOT/Gyro.//Accel. Code/Log Gyro//Accel/Parse IMU Data'
//  '<S179>' : 'DefaultSPOT/Manipulator Encoder Data/Change ARM Behavior'
//  '<S180>' : 'DefaultSPOT/PhaseSpace Camera Code/Initialize Universal Time (Simulation)'
//  '<S181>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States'
//  '<S182>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data'
//  '<S183>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data'
//  '<S184>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data'
//  '<S185>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data'
//  '<S186>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)'
//  '<S187>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Enabled Subsystem2'
//  '<S188>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/MATLAB Function'
//  '<S189>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/MATLAB Function1'
//  '<S190>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time'
//  '<S191>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time/Change BLACK Behavior'
//  '<S192>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time/Change BLUE Behavior'
//  '<S193>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Receive and Process Phasespace Data/Check for Sychronization (Updated)/Send Sync. Time/Change RED Behavior'
//  '<S194>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Calculate True  Time Step'
//  '<S195>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem1'
//  '<S196>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem2'
//  '<S197>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Wrap'
//  '<S198>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Calculate True  Time Step/Enabled Subsystem3'
//  '<S199>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Calculate True  Time Step/MATLAB Function'
//  '<S200>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem1/Enabled Subsystem'
//  '<S201>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem1/Enabled Subsystem/MATLAB Function'
//  '<S202>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem2/Enabled Subsystem'
//  '<S203>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLACK Data/Subsystem2/Enabled Subsystem/MATLAB Function'
//  '<S204>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Calculate True  Time Step'
//  '<S205>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem1'
//  '<S206>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem2'
//  '<S207>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Wrap'
//  '<S208>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Calculate True  Time Step/Enabled Subsystem3'
//  '<S209>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Calculate True  Time Step/MATLAB Function'
//  '<S210>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem1/Enabled Subsystem'
//  '<S211>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem1/Enabled Subsystem/MATLAB Function'
//  '<S212>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem2/Enabled Subsystem'
//  '<S213>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store BLUE Data/Subsystem2/Enabled Subsystem/MATLAB Function'
//  '<S214>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Calculate True  Time Step'
//  '<S215>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem1'
//  '<S216>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem2'
//  '<S217>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Wrap'
//  '<S218>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Calculate True  Time Step/Enabled Subsystem3'
//  '<S219>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Calculate True  Time Step/MATLAB Function'
//  '<S220>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem1/Enabled Subsystem'
//  '<S221>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem1/Enabled Subsystem/MATLAB Function'
//  '<S222>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem2/Enabled Subsystem'
//  '<S223>' : 'DefaultSPOT/PhaseSpace Camera Code/Use Hardware to Obtain States/Store RED Data/Subsystem2/Enabled Subsystem/MATLAB Function'
//  '<S224>' : 'DefaultSPOT/Platform  Identification/Subsystem'
//  '<S225>' : 'DefaultSPOT/Receive Data from Orin/Subsystem'
//  '<S226>' : 'DefaultSPOT/Robotic  Arm Code/Change ARM Behavior'
//  '<S227>' : 'DefaultSPOT/Send Data  to Orin/Subsystem'
//  '<S228>' : 'DefaultSPOT/Thruster Control Code/Change BLACK Behavior'
//  '<S229>' : 'DefaultSPOT/Thruster Control Code/Change BLUE Behavior'
//  '<S230>' : 'DefaultSPOT/Thruster Control Code/Change RED Behavior'
//  '<S231>' : 'DefaultSPOT/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle'
//  '<S232>' : 'DefaultSPOT/Thruster Control Code/Change BLACK Behavior/Rotate Forces to Body'
//  '<S233>' : 'DefaultSPOT/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Duty Cycle @ PWM'
//  '<S234>' : 'DefaultSPOT/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Generate Initial Guess'
//  '<S235>' : 'DefaultSPOT/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/MATLAB Function1'
//  '<S236>' : 'DefaultSPOT/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/MATLAB Function5'
//  '<S237>' : 'DefaultSPOT/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Rotate Forces to Inertial'
//  '<S238>' : 'DefaultSPOT/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem'
//  '<S239>' : 'DefaultSPOT/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem1'
//  '<S240>' : 'DefaultSPOT/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Generate Initial Guess/MATLAB Function'
//  '<S241>' : 'DefaultSPOT/Thruster Control Code/Change BLACK Behavior/Calculate Duty Cycle/Rotate Forces to Inertial/Create Rotation Matrix'
//  '<S242>' : 'DefaultSPOT/Thruster Control Code/Change BLACK Behavior/Rotate Forces to Body/Create Rotation Matrix'
//  '<S243>' : 'DefaultSPOT/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle'
//  '<S244>' : 'DefaultSPOT/Thruster Control Code/Change BLUE Behavior/Rotate Forces to Body'
//  '<S245>' : 'DefaultSPOT/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Duty Cycle @ PWM'
//  '<S246>' : 'DefaultSPOT/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Generate Initial Guess'
//  '<S247>' : 'DefaultSPOT/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/MATLAB Function1'
//  '<S248>' : 'DefaultSPOT/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/MATLAB Function5'
//  '<S249>' : 'DefaultSPOT/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Rotate Forces to Inertial'
//  '<S250>' : 'DefaultSPOT/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem'
//  '<S251>' : 'DefaultSPOT/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem1'
//  '<S252>' : 'DefaultSPOT/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Generate Initial Guess/MATLAB Function'
//  '<S253>' : 'DefaultSPOT/Thruster Control Code/Change BLUE Behavior/Calculate Duty Cycle/Rotate Forces to Inertial/Create Rotation Matrix'
//  '<S254>' : 'DefaultSPOT/Thruster Control Code/Change BLUE Behavior/Rotate Forces to Body/Create Rotation Matrix'
//  '<S255>' : 'DefaultSPOT/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle'
//  '<S256>' : 'DefaultSPOT/Thruster Control Code/Change RED Behavior/Rotate Forces to Body'
//  '<S257>' : 'DefaultSPOT/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Duty Cycle @ PWM'
//  '<S258>' : 'DefaultSPOT/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Generate Initial Guess'
//  '<S259>' : 'DefaultSPOT/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/MATLAB Function5'
//  '<S260>' : 'DefaultSPOT/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/MATLAB Function8'
//  '<S261>' : 'DefaultSPOT/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Rotate Forces to Inertial'
//  '<S262>' : 'DefaultSPOT/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem'
//  '<S263>' : 'DefaultSPOT/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Duty Cycle @ PWM/Enabled Subsystem1'
//  '<S264>' : 'DefaultSPOT/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Generate Initial Guess/MATLAB Function'
//  '<S265>' : 'DefaultSPOT/Thruster Control Code/Change RED Behavior/Calculate Duty Cycle/Rotate Forces to Inertial/Create Rotation Matrix'
//  '<S266>' : 'DefaultSPOT/Thruster Control Code/Change RED Behavior/Rotate Forces to Body/Create Rotation Matrix'
//  '<S267>' : 'DefaultSPOT/Time Sync./Change BLACK Behavior'
//  '<S268>' : 'DefaultSPOT/Time Sync./Change BLUE Behavior'
//  '<S269>' : 'DefaultSPOT/Time Sync./Change RED Behavior'

#endif                                 // DefaultSPOT_h_
