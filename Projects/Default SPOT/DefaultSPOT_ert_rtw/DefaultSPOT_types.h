...
//
#ifndef DefaultSPOT_types_h_
#define DefaultSPOT_types_h_
#include "rtwtypes.h"
#include "MW_SVD.h"
...
#ifndef struct_CustomDataLogger_DefaultSPOT_T
#define struct_CustomDataLogger_DefaultSPOT_T

struct CustomDataLogger_DefaultSPOT_T
{
...
#endif                                 // struct_CustomDataLogger_DefaultSPOT_T

#ifndef struct_GPIO_Write_DefaultSPOT_T
#define struct_GPIO_Write_DefaultSPOT_T

struct GPIO_Write_DefaultSPOT_T
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
  boolean_T isSetupComplete;
...
#endif                                 // struct_GPIO_Write_DefaultSPOT_T
...
#ifndef struct_b_bmi160_DefaultSPOT_T
#define struct_b_bmi160_DefaultSPOT_T

struct b_bmi160_DefaultSPOT_T
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
...
#endif                                 // struct_b_bmi160_DefaultSPOT_T
...
#ifndef struct_hb_cell_DefaultSPOT_T
#define struct_hb_cell_DefaultSPOT_T

struct hb_cell_DefaultSPOT_T
{
  f_matlabshared_sensors_simuli_T *f1;
  g_matlabshared_sensors_simuli_T *f2;
};

#endif                                 // struct_hb_cell_DefaultSPOT_T
...
#ifndef struct_IdentifyPlatform_DefaultSPOT_T
#define struct_IdentifyPlatform_DefaultSPOT_T

struct IdentifyPlatform_DefaultSPOT_T
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
  boolean_T isSetupComplete;
...
#endif                                 // struct_IdentifyPlatform_DefaultSPOT_T

#ifndef struct_Dynamixel_Controller_DefaultS_T
#define struct_Dynamixel_Controller_DefaultS_T

struct Dynamixel_Controller_DefaultS_T
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
  boolean_T isSetupComplete;
...
#endif                                // struct_Dynamixel_Controller_DefaultS_T
...
typedef struct P_SubPhase1_DefaultSPOT_T_ P_SubPhase1_DefaultSPOT_T;

// Parameters for system: '<S1>/Phase #4: Return Home'
typedef struct P_Phase4ReturnHome_DefaultSPO_T_ P_Phase4ReturnHome_DefaultSPO_T;

// Parameters for system: '<S3>/Custom Control (RED)'
typedef struct P_CustomControlRED_DefaultSPO_T_ P_CustomControlRED_DefaultSPO_T;
...
typedef struct P_EnabledSubsystem_DefaultSPO_T_ P_EnabledSubsystem_DefaultSPO_T;

// Parameters for system: '<S196>/Enabled Subsystem'
typedef struct P_EnabledSubsystem_DefaultS_c_T_ P_EnabledSubsystem_DefaultS_c_T;
...
typedef struct P_DefaultSPOT_T_ P_DefaultSPOT_T;

// Forward declaration for rtModel
typedef struct tag_RTM_DefaultSPOT_T RT_MODEL_DefaultSPOT_T;

#endif                                 // DefaultSPOT_types_h_
