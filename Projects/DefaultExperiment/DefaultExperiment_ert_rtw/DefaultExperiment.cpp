...
#include "DefaultExperiment_private.h"
#include <string.h>
#include <math.h>
...
B_DefaultExperiment_T DefaultExperiment_B;

// Block states (default storage)
DW_DefaultExperiment_T DefaultExperiment_DW;

// Real-time model
RT_MODEL_DefaultExperiment_T DefaultExperiment_M_ = RT_MODEL_DefaultExperiment_T
  ();
RT_MODEL_DefaultExperiment_T *const DefaultExperiment_M = &DefaultExperiment_M_;

// Forward declaration for local functions
static real_T DefaultExperiment_xzlangeM(const real_T x[24]);
static void DefaultExperiment_xzlascl(real_T cfrom, real_T cto, real_T A[24]);
static real_T DefaultExperiment_xnrm2(int32_T n, const real_T x[24], int32_T ix0);
static real_T DefaultExperiment_xdotc(int32_T n, const real_T x[24], int32_T ix0,
  const real_T y[24], int32_T iy0);
static void DefaultExperiment_xaxpy(int32_T n, real_T a, int32_T ix0, real_T y
  [24], int32_T iy0);
static real_T DefaultExperiment_xdotc_o(const real_T x[9], const real_T y[9],
  int32_T iy0);
static void DefaultExperiment_xaxpy_gop(real_T a, real_T y[9], int32_T iy0);
static real_T DefaultExperiment_xnrm2_p(const real_T x[3], int32_T ix0);
static void DefaultExperiment_xaxpy_g(int32_T n, real_T a, const real_T x[24],
  int32_T ix0, real_T y[8], int32_T iy0);
static void DefaultExperiment_xaxpy_go(int32_T n, real_T a, const real_T x[8],
  int32_T ix0, real_T y[24], int32_T iy0);
static void DefaultExperiment_xzlascl_i(real_T cfrom, real_T cto, real_T A[3]);
static void DefaultExperiment_xrotg(real_T a, real_T b, real_T *b_a, real_T *b_b,
  real_T *c, real_T *s);
static void DefaultExperiment_xrot_ps(real_T x[9], int32_T ix0, int32_T iy0,
  real_T c, real_T s);
static void DefaultExperiment_xrot_psj(real_T x[24], int32_T ix0, int32_T iy0,
  real_T c, real_T s);
static void DefaultExperiment_xswap_dj(real_T x[9], int32_T ix0, int32_T iy0);
static void DefaultExperiment_xswap_dj5(real_T x[24], int32_T ix0, int32_T iy0);
static void DefaultExperiment_svd(const real_T A[24], real_T U[24], real_T s[3],
  real_T V[9]);

// Forward declaration for local functions
static real_T DefaultExperiment_maximum(const real_T x[8]);

// Forward declaration for local functions
static real_T DefaultExperiment_maximum_e(const real_T x[8]);
static real_T DefaultExperiment_norm(const real_T x[3]);

// Forward declaration for local functions
static void DefaultExperiment_pause(real_T varargin_1);
static void D_bmi160_set_EnableSecondaryMag(b_bmi160_DefaultExperiment_T *obj);
static void DefaultExperim_SystemCore_setup(nvidiacoder_sensors_BMI160Blo_T *obj);
...
//
void DefaultEx_Phase0Synchronization(real_T *rtd_ARM_Control_Law_Enabler, real_T
...
//    '<S21>/Sub-Phase #4'
//
void DefaultExperiment_SubPhase1(real_T *rtd_ARM_Control_Law_Enabler, real_T
  ...
  P_SubPhase1_DefaultExperiment_T *localP)
{
  ...
  *rtd_BLUE_Control_Law_Enabler = localP->Constant8_Value;
  ...
  rtb_Gain_l = *rtd_Univ_Time - DefaultExperiment_P.Phase2_End;
  ...
  rtd_BLUE_Desired_States[0] = localP->Gain_Gain * rtb_Sum2_e +
    DefaultExperiment_P.xLength / 2.0;
  rtd_BLUE_Desired_States[1] = localP->Gain1_Gain * rtb_Atan2_i +
    DefaultExperiment_P.yLength / 2.0;
  ...
  rtd_BLACK_Desired_States[0] = DefaultExperiment_P.xLength / 2.0;
  rtd_BLACK_Desired_States[1] = DefaultExperiment_P.yLength / 2.0;
  ...
  rtd_RED_Desired_States[0] = DefaultExperiment_P.xLength / 2.0 + rtb_Gain_l;
  rtd_RED_Desired_States[1] = DefaultExperiment_P.yLength / 2.0 + rtb_Sum2_e;
...
//
void DefaultExperim_Phase4ReturnHome(real_T *rtd_ARM_Control_Law_Enabler, real_T
  rtd_ARM_Desired_States[3], real_T *rtd_ARM_Path_Planner_Selection, real_T
  *rtd_BLACK_Control_Law_Enabler, real_T rtd_BLACK_Desired_States[3], char_T
  rtd_BLACK_Logger[256], real_T *rtd_BLACK_Path_Planner_Selectio, real_T
  *rtd_BLUE_Control_Law_Enabler, real_T rtd_BLUE_Desired_States[3], char_T
  ...
  *rtd_RED_Path_Planner_Selection, P_Phase4ReturnHome_DefaultExp_T *localP)
{
  ...
  *rtd_BLUE_Control_Law_Enabler = localP->Constant8_Value;
  ...
  rtd_BLUE_Desired_States[0] = DefaultExperiment_P.home_states_BLUE[0];

  // DataStoreWrite: '<S22>/Data Store Write6' incorporates:
  //   Constant: '<S94>/Desired States (BLACK)'

  rtd_BLACK_Desired_States[0] = DefaultExperiment_P.home_states_BLACK[0];

  // DataStoreWrite: '<S22>/Data Store Write9' incorporates:
  //   Constant: '<S96>/Constant2'

  rtd_RED_Desired_States[0] = DefaultExperiment_P.home_states_RED[0];

  // DataStoreWrite: '<S22>/Data Store Write18' incorporates:
  //   Constant: '<S95>/Desired States (BLUE)'

  rtd_BLUE_Desired_States[1] = DefaultExperiment_P.home_states_BLUE[1];

  // DataStoreWrite: '<S22>/Data Store Write6' incorporates:
  //   Constant: '<S94>/Desired States (BLACK)'

  rtd_BLACK_Desired_States[1] = DefaultExperiment_P.home_states_BLACK[1];

  // DataStoreWrite: '<S22>/Data Store Write9' incorporates:
  //   Constant: '<S96>/Constant2'

  rtd_RED_Desired_States[1] = DefaultExperiment_P.home_states_RED[1];

  // DataStoreWrite: '<S22>/Data Store Write18' incorporates:
  //   Constant: '<S95>/Desired States (BLUE)'

  rtd_BLUE_Desired_States[2] = DefaultExperiment_P.home_states_BLUE[2];

  // DataStoreWrite: '<S22>/Data Store Write6' incorporates:
  //   Constant: '<S94>/Desired States (BLACK)'

  rtd_BLACK_Desired_States[2] = DefaultExperiment_P.home_states_BLACK[2];

  // DataStoreWrite: '<S22>/Data Store Write9' incorporates:
  //   Constant: '<S96>/Constant2'

  rtd_RED_Desired_States[2] = DefaultExperiment_P.home_states_RED[2];
}
...
//
void DefaultExperimen_MATLABFunction(real_T rtu_Rz_path, real_T rtu_Rz_measured,
  real_T *rty_Rz_error)
{
  real_T q;
  real_T r;
...
//
void DefaultExperim_CustomControlRED(real_T rty_u[3],
...
//
void DefaultEx_DisableThrustersBLACK(real_T rty_Out1[3],
...
//
void Defaul_ChangeBLACKBehavior_Init(RT_MODEL_DefaultExperiment_T * const
  ...
  P_ChangeBLACKBehavior_Default_T *localP)
{
  ...
  if (*sErr != 0) {
    ...
    if (*sErr != 0) {
      DefaultExperiment_M->setErrorStatus(sErr);
      DefaultExperiment_M->setStopRequested(1);
    }
  }
...
//    '<S4>/Change RED Behavior'
//
void DefaultExpe_ChangeBLACKBehavior(RT_MODEL_DefaultExperiment_T * const
  DefaultExperiment_M, DW_ChangeBLACKBehavior_Defaul_T *localDW,
  P_ChangeBLACKBehavior_Default_T *localP)
{
  char_T *sErr;
...
//    '<S4>/Change RED Behavior'
//
void Defaul_ChangeBLACKBehavior_Term(RT_MODEL_DefaultExperiment_T * const
  DefaultExperiment_M, DW_ChangeBLACKBehavior_Defaul_T *localDW)
{
  char_T *sErr;
...
//
void Defa_ChangeBLACKBehavior_j_Init(RT_MODEL_DefaultExperiment_T * const
...
//    '<S190>/Change RED Behavior'
//
void De_ChangeBLACKBehavior_d_Update(RT_MODEL_DefaultExperiment_T * const
...
//    '<S190>/Change RED Behavior'
//
void Defa_ChangeBLACKBehavior_h_Term(RT_MODEL_DefaultExperiment_T * const
  DefaultExperiment_M, DW_ChangeBLACKBehavior_Defa_l_T *localDW)
{
  char_T *sErr;
...
//
void DefaultExperim_MATLABFunction_j(real_T rtu_dt, real_T rtu_dataRate, real_T *
  rty_dt_out)
{
  if (rtu_dt <= 0.0) {
...
//
void DefaultEx_EnabledSubsystem_Init(real_T rty_dydt[3],
...
//    '<S215>/Enabled Subsystem'
//
void Defaul_EnabledSubsystem_Disable(DW_EnabledSubsystem_DefaultEx_T *localDW)
{
...
//    '<S215>/Enabled Subsystem'
//
void DefaultExperim_EnabledSubsystem(const boolean_T rtu_Enable[3], const real_T
  rtu_y[3], real_T rtu_dt, real_T rty_dydt[3], B_EnabledSubsystem_DefaultExp_T
  *localB, DW_EnabledSubsystem_DefaultEx_T *localDW,
  P_EnabledSubsystem_DefaultExp_T *localP)
{
  real_T Delay;
  real_T ema;
  real_T x;
...
//    '<S215>/Enabled Subsystem'
//
void Default_EnabledSubsystem_Update(B_EnabledSubsystem_DefaultExp_T *localB,
  DW_EnabledSubsystem_DefaultEx_T *localDW)
{
...
//
void Default_EnabledSubsystem_e_Init(real_T rty_dydt[3],
...
//    '<S216>/Enabled Subsystem'
//
void Defa_EnabledSubsystem_c_Disable(DW_EnabledSubsystem_Default_c_T *localDW)
{
  localDW->EnabledSubsystem_MODE = false;
}
...
//    '<S216>/Enabled Subsystem'
//
void DefaultExper_EnabledSubsystem_g(const boolean_T rtu_Enable[3], real_T rtu_y,
  ...
  *localDW, P_EnabledSubsystem_DefaultE_c_T *localP)
{
  ...
  if (rtu_Enable[0] || rtu_Enable[1] || rtu_Enable[2]) {
    ...
    Defa_EnabledSubsystem_c_Disable(localDW);
  }
...
//    '<S216>/Enabled Subsystem'
//
void Defau_EnabledSubsystem_m_Update(B_EnabledSubsystem_DefaultE_h_T *localB,
  ...
  real_T V[9])
{
  ...
  // Start for MATLABSystem: '<S234>/Pseudoinverse1'
  anrm = DefaultExperiment_xzlangeM(A);
  cscale = anrm;
  ...
  if ((anrm > 0.0) && (anrm < 6.7178761075670888E-139)) {
    ...
    DefaultExperiment_xzlascl(anrm, cscale, A_0);
  ...
  for (i = 0; i < 3; i++) {
    ...
    // Start for MATLABSystem: '<S234>/Pseudoinverse1'
    nrm = DefaultExperiment_xnrm2(8 - i, A_0, colqp1 + 1);
    if (nrm > 0.0) {
    ...
    for (qq = qp1; qq < 4; qq++) {
      ...
      if (apply_transform) {
        // Start for MATLABSystem: '<S234>/Pseudoinverse1'
        DefaultExperiment_xaxpy(8 - i, -(DefaultExperiment_xdotc(8 - i, A_0,
    ...
    if (i + 1 <= 1) {
      nrm = DefaultExperiment_xnrm2_p(e, i + 2);
      if (nrm == 0.0) {
        e[0] = 0.0;
      } else {
        if (e[i + 1] < 0.0) {
        ...
        for (colqp1 = qp1; colqp1 < 4; colqp1++) {
          DefaultExperiment_xaxpy_g(7 - i, e[colqp1 - 1], A_0, (i + ((colqp1 - 1)
            << 3)) + 2, work, i + 2);
        }

        for (colqp1 = qp1; colqp1 < 4; colqp1++) {
          DefaultExperiment_xaxpy_go(7 - i, -e[colqp1 - 1] / e[i + 1], work, i +
            2, A_0, (i + ((colqp1 - 1) << 3)) + 2);
        }
      }
  ...
  for (qp1 = 2; qp1 >= 0; qp1--) {
    ...
    if (s_0[qp1] != 0.0) {
      for (qq_tmp_tmp = qp1 + 2; qq_tmp_tmp < 4; qq_tmp_tmp++) {
        ...
        DefaultExperiment_xaxpy(8 - qp1, -(DefaultExperiment_xdotc(8 - qp1, U,
    ...
    if ((qp1 + 1 <= 1) && (e[0] != 0.0)) {
      DefaultExperiment_xaxpy_gop(-(DefaultExperiment_xdotc_o(Vf, Vf, 5) / Vf[1]),
        Vf, 5);
      DefaultExperiment_xaxpy_gop(-(DefaultExperiment_xdotc_o(Vf, Vf, 8) / Vf[1]),
        Vf, 8);
    }
    ...
    switch (qjj) {
     case 1:
      ...
      for (qq = i; qq >= colqp1 + 1; qq--) {
        DefaultExperiment_xrotg(s_0[qq - 1], nrm, &s_0[qq - 1], &nrm, &ztest,
          &sqds);
        if (qq > colqp1 + 1) {
          nrm = -sqds * e[0];
          e[0] *= ztest;
        ...
        DefaultExperiment_xrot_ps(Vf, 3 * (qq - 1) + 1, 3 * i + 1, ztest, sqds);
      }
      break;
     ...
     case 2:
      ...
      for (qq = colqp1 + 1; qq <= i + 1; qq++) {
        DefaultExperiment_xrotg(s_0[qq - 1], nrm, &s_0[qq - 1], &ztest, &sqds,
          &b);
        ztest = e[qq - 1];
        nrm = -b * ztest;
        e[qq - 1] = ztest * sqds;
        DefaultExperiment_xrot_psj(U, ((qq - 1) << 3) + 1, ((colqp1 - 1) << 3) +
          1, sqds, b);
      }
      break;
     ...
     case 3:
      ...
      for (qq = colqp1 + 1; qq <= i; qq++) {
        DefaultExperiment_xrotg(nrm, ztest, &smm1, &emm1, &sqds, &b);
        if (qq > colqp1 + 1) {
          e[0] = smm1;
        }
        ...
        ztest = b * s_0[qq];
        s_0[qq] *= sqds;
        DefaultExperiment_xrot_ps(Vf, 3 * (qq - 1) + 1, 3 * qq + 1, sqds, b);
        DefaultExperiment_xrotg(nrm * sqds + smm1 * b, ztest, &s_0[qq - 1],
          &a__3, &emm1, &d_sn);
        smm1 = e[qq - 1];
        ...
        ztest = d_sn * e[qq];
        e[qq] *= emm1;
        DefaultExperiment_xrot_psj(U, ((qq - 1) << 3) + 1, (qq << 3) + 1, emm1,
          d_sn);
      }
     ...
     default:
      ...
      while ((colqp1 + 1 < 3) && (s_0[colqp1] < s_0[qp1])) {
        ...
        s_0[colqp1] = s_0[qp1];
        s_0[qp1] = nrm;
        DefaultExperiment_xswap_dj(Vf, 3 * colqp1 + 1, 3 * (colqp1 + 1) + 1);
        DefaultExperiment_xswap_dj5(U, (colqp1 << 3) + 1, ((colqp1 + 1) << 3) +
          1);
        colqp1 = qp1;
        qp1++;
      }
  ...
  if (doscale) {
    // Start for MATLABSystem: '<S234>/Pseudoinverse1'
    DefaultExperiment_xzlascl_i(cscale, anrm, s);
  }
...
void DefaultExpe_Pseudoinverse1_Init(DW_Pseudoinverse1_DefaultExpe_T *localDW)
{
  // Start for MATLABSystem: '<S234>/Pseudoinverse1'
...
// Output and update for atomic system:
void DefaultExperimen_Pseudoinverse1(const real_T rtu_0[24],
...
//
void DefaultExperime_MATLABFunction1(const real_T rtu_ThrustPer[8], real_T
  rty_ThrustPer_Final[8])
{
  ...
  real_T maxval;
  int32_T i;
  TControl = 1.0 / DefaultExperiment_P.PWMFreq;
  maxval = DefaultExperiment_maximum(rtu_ThrustPer);
  for (i = 0; i < 8; i++) {
    if (maxval > 1.0) {
...
//
void DefaultExperime_MATLABFunction5(const real_T rtu_u_desired[3], const real_T
  ...
  rtp_max_iters, real_T rtp_tol)
{
  ...
  do {
    ...
    if (iter <= static_cast<int32_T>(rtp_max_iters) - 1) {
      current_obj = DefaultExperiment_P.F_red_X_nominal * thrust_decay_factor /
        2.0;
      gradient[0] = current_obj;
      gradient[1] = current_obj;
      thrust_decay_factor = DefaultExperiment_P.F_red_Y_nominal *
      ...
      for (i = 0; i < 8; i++) {
        ...
        b[3 * i] = b_0[i];
        b[3 * i + 1] = c[i];
        b[3 * i + 2] = DefaultExperiment_P.thruster_dist2CG_RED[i] / 1000.0;
      }
      ...
      while ((!exitg2) && (b_iter < 100)) {
        ...
        current_obj = DefaultExperiment_norm(H_0);
        ...
        while ((!exitg3) && (ls_iter < 20)) {
          ...
          new_obj = DefaultExperiment_norm(H_0);
          new_obj *= new_obj;
      ...
      thrust_decay_factor = DefaultExperiment_maximum_e(x);
      for (i = 0; i < 8; i++) {
        current_obj = x[i];
        rty_duty_cycles[i] = current_obj;
      ...
      for (iter = 0; iter < 8; iter++) {
        ...
        b[3 * iter] = b_0[iter];
        b[3 * iter + 1] = c[iter];
        b[3 * iter + 2] = DefaultExperiment_P.thruster_dist2CG_RED[iter] /
          1000.0;
      }
...
//
void DefaultExp_CreateRotationMatrix(real_T rtu_Rz, real_T rty_C_Ib[4])
{
  real_T x_tmp;
  real_T x_tmp_0;
  x_tmp = sin(rtu_Rz);
...
//
void DefaultE_CreateRotationMatrix_a(real_T rtu_Rz, real_T rty_C_bI[4])
{
  real_T tmp;
  real_T tmp_0;
  tmp = sin(rtu_Rz);
...
//
void Defa_ChangeBLACKBehavior_a_Init(RT_MODEL_DefaultExperiment_T * const
...
//    '<S17>/Change RED Behavior'
//
void DefaultEx_ChangeBLACKBehavior_i(RT_MODEL_DefaultExperiment_T * const
  DefaultExperiment_M, B_ChangeBLACKBehavior_Defau_m_T *localB)
{
  // Clock: '<S267>/Clock1'
  localB->Clock1 = DefaultExperiment_M->Timing.t[0];
}
...
//    '<S17>/Change RED Behavior'
//
void De_ChangeBLACKBehavior_f_Update(RT_MODEL_DefaultExperiment_T * const
  DefaultExperiment_M, B_ChangeBLACKBehavior_Defau_m_T *localB,
...
//    '<S17>/Change RED Behavior'
//
void Defa_ChangeBLACKBehavior_l_Term(RT_MODEL_DefaultExperiment_T * const
  DefaultExperiment_M, DW_ChangeBLACKBehavior_Defa_g_T *localDW)
{
  char_T *sErr;
...
static void DefaultExperiment_pause(real_T varargin_1)
{
  ...
  if (DefaultExperiment_DW.pauseState == 0) {
    real_T delay;
    real_T delayInt;
    delay = varargin_1;
...
static void D_bmi160_set_EnableSecondaryMag(b_bmi160_DefaultExperiment_T *obj)
{
  b_bmi160_DefaultExperiment_T *obj_0;
  b_bmi160_DefaultExperiment_T *obj_1;
...
static void DefaultExperim_SystemCore_setup(nvidiacoder_sensors_BMI160Blo_T *obj)
{
  b_bmi160_DefaultExperiment_T *b_obj;
  b_bmi160_DefaultExperiment_T *obj_2;
...
// Model step function
void DefaultExperiment_step(void)
{
...

  {
    ...
    ARM_Path[0] = DefaultExperiment_DW.ARM_Desired_States[0];
    ...
    BLACK_Path_idx_0 = DefaultExperiment_DW.BLACK_Desired_States[0];
    ...
    BLUE_Path_idx_0 = DefaultExperiment_DW.BLUE_Desired_States[0];
    ...
    rtb_Merge6[0] = DefaultExperiment_DW.RED_Desired_States[0];

    // End of Outputs for SubSystem: '<S2>/Disable PPL (RED)'
    RED_Path_idx_0 = DefaultExperiment_DW.RED_Desired_States[0];
    ...
    ARM_Path[1] = DefaultExperiment_DW.ARM_Desired_States[1];
    ...
    BLACK_Path_idx_1 = DefaultExperiment_DW.BLACK_Desired_States[1];
    ...
    BLUE_Path_idx_1 = DefaultExperiment_DW.BLUE_Desired_States[1];
    ...
    rtb_Merge6[1] = DefaultExperiment_DW.RED_Desired_States[1];

    // End of Outputs for SubSystem: '<S2>/Disable PPL (RED)'
    RED_Path_idx_1 = DefaultExperiment_DW.RED_Desired_States[1];
    ...
    ARM_Path[2] = DefaultExperiment_DW.ARM_Desired_States[2];
    ...
    BLACK_Path_idx_2 = DefaultExperiment_DW.BLACK_Desired_States[2];
    ...
    BLUE_Path_idx_2 = DefaultExperiment_DW.BLUE_Desired_States[2];
    ...
    RED_Desired_States = DefaultExperiment_DW.RED_Desired_States[2];

    // Outputs for IfAction SubSystem: '<S2>/Disable PPL (RED)' incorporates:
    //   ActionPort: '<S108>/Action Port'

    rtb_Merge6[2] = DefaultExperiment_DW.RED_Desired_States[2];
    ...
    if (DefaultExperiment_DW.BLACK_Control_Law_Enabler == 1.0) {
      ...
      //
      DefaultExperimen_MATLABFunction(DefaultExperiment_DW.BLACK_Desired_States
        [2], DefaultExperiment_DW.BLACK_Measured_States[2], &rtb_TSamp_k);
      rtb_TSamp_af = DefaultExperiment_DW.BLACK_Desired_States[0] *
        DefaultExperiment_P.TSamp_WtEt_i;
      ...
      DefaultExperiment_DW.UD_DSTATE_eh = rtb_TSamp_af -
        DefaultExperiment_DW.UD_DSTATE_eh;
      ...
      //   y = u * K where K = 1 / ( w * Ts )
      //
      rtb_TSamp_o = DefaultExperiment_DW.BLACK_Desired_States[1] *
        DefaultExperiment_P.TSamp_WtEt_hr;
      ...
      DefaultExperiment_DW.UD_DSTATE_hv = rtb_TSamp_o -
        DefaultExperiment_DW.UD_DSTATE_hv;
      ...
      //   y = u * K where K = 1 / ( w * Ts )
      //
      rtb_TSamp_n5 = DefaultExperiment_DW.BLACK_Desired_States[2] *
        DefaultExperiment_P.TSamp_WtEt_ca;
      ...
      DefaultExperiment_DW.UD_DSTATE_kv = rtb_TSamp_n5 -
        DefaultExperiment_DW.UD_DSTATE_kv;
      ...
      DefaultExperiment_DW.UD_DSTATE_eh =
        DefaultExperiment_DW.BLACK_Measured_States[3] -
        DefaultExperiment_DW.UD_DSTATE_eh;
      ...
      DefaultExperiment_DW.UD_DSTATE_hv =
        DefaultExperiment_DW.BLACK_Measured_States[4] -
        DefaultExperiment_DW.UD_DSTATE_hv;
      ...
      DefaultExperiment_DW.UD_DSTATE_kv =
        DefaultExperiment_DW.BLACK_Measured_States[5] -
        DefaultExperiment_DW.UD_DSTATE_kv;
      ...
      DefaultExperiment_B.Merge1[0] =
        ((DefaultExperiment_DW.BLACK_Measured_States[0] -
          DefaultExperiment_DW.BLACK_Desired_States[0]) *
         DefaultExperiment_P.Kp_xb + DefaultExperiment_P.Kd_xb *
         DefaultExperiment_DW.UD_DSTATE_eh) * DefaultExperiment_P.Gain6_Gain_g;
      DefaultExperiment_B.Merge1[1] =
        ((DefaultExperiment_DW.BLACK_Measured_States[1] -
          DefaultExperiment_DW.BLACK_Desired_States[1]) *
         DefaultExperiment_P.Kp_yb + DefaultExperiment_P.Kd_yb *
         DefaultExperiment_DW.UD_DSTATE_hv) * DefaultExperiment_P.Gain7_Gain_b;
      ...
      DefaultExperiment_B.Merge1[2] = (DefaultExperiment_P.Kp_tb * rtb_TSamp_k +
        DefaultExperiment_P.Kd_tb * DefaultExperiment_DW.UD_DSTATE_kv) *
        DefaultExperiment_P.Gain8_Gain_m;
    ...
    } else if (DefaultExperiment_DW.BLACK_Control_Law_Enabler == 2.0) {
      ...
      //
      DefaultExperimen_MATLABFunction(DefaultExperiment_DW.BLACK_Desired_States
        [2], DefaultExperiment_DW.BLACK_Measured_States[2], &tmp_0[2]);
      rtb_TSamp_k = DefaultExperiment_DW.BLACK_Desired_States[0] *
        DefaultExperiment_P.TSamp_WtEt_nd;
      ...
      DefaultExperiment_DW.UD_DSTATE_j = rtb_TSamp_k -
        DefaultExperiment_DW.UD_DSTATE_j;
      ...
      //   y = u * K where K = 1 / ( w * Ts )
      //
      rtb_TSamp_af = DefaultExperiment_DW.BLACK_Desired_States[1] *
        DefaultExperiment_P.TSamp_WtEt_co;
      ...
      DefaultExperiment_DW.UD_DSTATE_c = rtb_TSamp_af -
        DefaultExperiment_DW.UD_DSTATE_c;
      ...
      //   y = u * K where K = 1 / ( w * Ts )
      //
      rtb_TSamp_o = DefaultExperiment_DW.BLACK_Desired_States[2] *
        DefaultExperiment_P.TSamp_WtEt_no;
      ...
      DefaultExperiment_DW.UD_DSTATE_d = rtb_TSamp_o -
        DefaultExperiment_DW.UD_DSTATE_d;
      ...
      for (i = 0; i < 18; i++) {
        ...
        tmp[i] = -DefaultExperiment_P.K_BLACK[i];
      }
      ...
      tmp_0[0] = DefaultExperiment_DW.BLACK_Measured_States[0] -
        DefaultExperiment_DW.BLACK_Desired_States[0];
      tmp_0[1] = DefaultExperiment_DW.BLACK_Measured_States[1] -
        DefaultExperiment_DW.BLACK_Desired_States[1];
      ...
      tmp_0[3] = DefaultExperiment_DW.UD_DSTATE_j;
      tmp_0[4] = DefaultExperiment_DW.UD_DSTATE_c;
      tmp_0[5] = DefaultExperiment_DW.UD_DSTATE_d;
      for (i = 0; i < 3; i++) {
        // Product: '<S119>/Matrix Multiply' incorporates:
        //   Merge: '<S3>/Merge1'
        ...
        DefaultExperiment_B.Merge1[i] = rtb_TSamp_n5;
      }
      ...
      DefaultEx_DisableThrustersBLACK(DefaultExperiment_B.Merge1,
        &DefaultExperiment_P.DisableThrustersBLACK);
    ...
    rtb_TSamp_k = DefaultExperiment_B.Merge1[0];
    rtb_TSamp_af = DefaultExperiment_B.Merge1[1];
    rtb_TSamp_o = DefaultExperiment_B.Merge1[2];

    // If: '<S3>/If2' incorporates:
    //   DataStoreRead: '<S3>/Data Store Read2'

    if (DefaultExperiment_DW.BLUE_Control_Law_Enabler == 1.0) {
      ...
      //   y = u * K where K = 1 / ( w * Ts )
      //
      DefaultExperimen_MATLABFunction(DefaultExperiment_DW.BLUE_Desired_States[2],
        DefaultExperiment_DW.BLUE_Measured_States[2], &rtb_TSamp_n5);
      rtb_TSamp_d = DefaultExperiment_DW.BLUE_Desired_States[0] *
        DefaultExperiment_P.TSamp_WtEt_p;
      ...
      DefaultExperiment_DW.UD_DSTATE_o = rtb_TSamp_d -
        DefaultExperiment_DW.UD_DSTATE_o;
      ...
      //   y = u * K where K = 1 / ( w * Ts )
      //
      rtb_TSamp_ks = DefaultExperiment_DW.BLUE_Desired_States[1] *
        DefaultExperiment_P.TSamp_WtEt_o;
      ...
      DefaultExperiment_DW.UD_DSTATE_n = rtb_TSamp_ks -
        DefaultExperiment_DW.UD_DSTATE_n;
      ...
      //   y = u * K where K = 1 / ( w * Ts )
      //
      rtb_TSamp_e = DefaultExperiment_DW.BLUE_Desired_States[2] *
        DefaultExperiment_P.TSamp_WtEt_px;
      ...
      DefaultExperiment_DW.UD_DSTATE_hu = rtb_TSamp_e -
        DefaultExperiment_DW.UD_DSTATE_hu;
      ...
      DefaultExperiment_DW.UD_DSTATE_o =
        DefaultExperiment_DW.BLUE_Measured_States[3] -
        DefaultExperiment_DW.UD_DSTATE_o;
      ...
      DefaultExperiment_DW.UD_DSTATE_n =
        DefaultExperiment_DW.BLUE_Measured_States[4] -
        DefaultExperiment_DW.UD_DSTATE_n;
      ...
      DefaultExperiment_DW.UD_DSTATE_hu =
        DefaultExperiment_DW.BLUE_Measured_States[5] -
        DefaultExperiment_DW.UD_DSTATE_hu;
      ...
      DefaultExperiment_B.Merge2[0] =
        ((DefaultExperiment_DW.BLUE_Measured_States[0] -
          DefaultExperiment_DW.BLUE_Desired_States[0]) *
         DefaultExperiment_P.Kp_xblue + DefaultExperiment_P.Kd_xblue *
         DefaultExperiment_DW.UD_DSTATE_o) * DefaultExperiment_P.Gain6_Gain_a;
      DefaultExperiment_B.Merge2[1] =
        ((DefaultExperiment_DW.BLUE_Measured_States[1] -
          DefaultExperiment_DW.BLUE_Desired_States[1]) *
         DefaultExperiment_P.Kp_yblue + DefaultExperiment_P.Kd_yblue *
         DefaultExperiment_DW.UD_DSTATE_n) * DefaultExperiment_P.Gain7_Gain_e;
      ...
      DefaultExperiment_B.Merge2[2] = (DefaultExperiment_P.Kp_tblue *
        rtb_TSamp_n5 + DefaultExperiment_P.Kd_tblue *
        DefaultExperiment_DW.UD_DSTATE_hu) * DefaultExperiment_P.Gain8_Gain_g;
    ...
    } else if (DefaultExperiment_DW.BLUE_Control_Law_Enabler == 2.0) {
      ...
      //
      DefaultExperimen_MATLABFunction(DefaultExperiment_DW.BLUE_Desired_States[2],
        DefaultExperiment_DW.BLUE_Measured_States[2], &tmp_1[2]);
      rtb_TSamp_n5 = DefaultExperiment_DW.BLUE_Desired_States[0] *
        DefaultExperiment_P.TSamp_WtEt_ft;
      ...
      DefaultExperiment_DW.UD_DSTATE_l = rtb_TSamp_n5 -
        DefaultExperiment_DW.UD_DSTATE_l;
      ...
      //   y = u * K where K = 1 / ( w * Ts )
      //
      rtb_TSamp_d = DefaultExperiment_DW.BLUE_Desired_States[1] *
        DefaultExperiment_P.TSamp_WtEt_eh;
      ...
      DefaultExperiment_DW.UD_DSTATE_k = rtb_TSamp_d -
        DefaultExperiment_DW.UD_DSTATE_k;
      ...
      //   y = u * K where K = 1 / ( w * Ts )
      //
      rtb_TSamp_ks = DefaultExperiment_DW.BLUE_Desired_States[2] *
        DefaultExperiment_P.TSamp_WtEt_ii;
      ...
      DefaultExperiment_DW.UD_DSTATE_h = rtb_TSamp_ks -
        DefaultExperiment_DW.UD_DSTATE_h;
      ...
      for (i = 0; i < 18; i++) {
        ...
        tmp[i] = -DefaultExperiment_P.K_BLUE[i];
      }
      ...
      tmp_1[0] = DefaultExperiment_DW.BLUE_Measured_States[0] -
        DefaultExperiment_DW.BLUE_Desired_States[0];
      tmp_1[1] = DefaultExperiment_DW.BLUE_Measured_States[1] -
        DefaultExperiment_DW.BLUE_Desired_States[1];
      ...
      tmp_1[3] = DefaultExperiment_DW.UD_DSTATE_l;
      tmp_1[4] = DefaultExperiment_DW.UD_DSTATE_k;
      tmp_1[5] = DefaultExperiment_DW.UD_DSTATE_h;
      for (i = 0; i < 3; i++) {
        // Product: '<S120>/Matrix Multiply' incorporates:
        //   Merge: '<S3>/Merge2'
        ...
        DefaultExperiment_B.Merge2[i] = rtb_TSamp_e;
      }
      ...
      DefaultEx_DisableThrustersBLACK(DefaultExperiment_B.Merge2,
        &DefaultExperiment_P.DisableThrustersBLUE);
    ...
    rtb_TSamp_n5 = DefaultExperiment_B.Merge2[0];
    rtb_TSamp_d = DefaultExperiment_B.Merge2[1];
    rtb_TSamp_ks = DefaultExperiment_B.Merge2[2];

    // If: '<S3>/If3' incorporates:
    //   DataStoreRead: '<S3>/Data Store Read5'

    if (DefaultExperiment_DW.ARM_Control_Law_Enabler == 1.0) {
      ...
      DefaultExperiment_DW.ARM_Control_Mode =
        DefaultExperiment_P.Constant7_Value;
      ...
      if (DefaultExperiment_DW.isSim == 1.0) {
        ...
        rtb_TSamp_e = DefaultExperiment_DW.ARM_Desired_States[1] -
          DefaultExperiment_DW.ARM_Measured_States[1];
        ...
        //   y = u * K where K = 1 / ( w * Ts )
        //
        rtb_TSamp = rtb_TSamp_e * DefaultExperiment_P.TSamp_WtEt_pu;
        ...
        DefaultExperiment_DW.UD_DSTATE = (rtb_TSamp -
          DefaultExperiment_DW.UD_DSTATE) * DefaultExperiment_P.Kd_elarm +
          DefaultExperiment_P.Kp_elarm * rtb_TSamp_e;
        ...
        rtb_TSamp_e = DefaultExperiment_DW.ARM_Desired_States[0] -
          DefaultExperiment_DW.ARM_Measured_States[0];
        ...
        //   y = u * K where K = 1 / ( w * Ts )
        //
        rtb_TSamp_hx = rtb_TSamp_e * DefaultExperiment_P.TSamp_WtEt_f0;
        ...
        DefaultExperiment_DW.UD_DSTATE_e = (rtb_TSamp_hx -
          DefaultExperiment_DW.UD_DSTATE_e) * DefaultExperiment_P.Kd_sharm +
          DefaultExperiment_P.Kp_sharm * rtb_TSamp_e;
        ...
        rtb_TSamp_e = DefaultExperiment_DW.ARM_Desired_States[2] -
          DefaultExperiment_DW.ARM_Measured_States[2];
        ...
        //   y = u * K where K = 1 / ( w * Ts )
        //
        rtb_TSamp_h = rtb_TSamp_e * DefaultExperiment_P.TSamp_WtEt_nz;
        ...
        DefaultExperiment_DW.UD_DSTATE_a = (rtb_TSamp_h -
          DefaultExperiment_DW.UD_DSTATE_a) * DefaultExperiment_P.Kd_wrarm +
          DefaultExperiment_P.Kp_wrarm * rtb_TSamp_e;
        ...
        if (DefaultExperiment_DW.UD_DSTATE_e > DefaultExperiment_P.Tz_lim_sharm)
        {
          // Merge: '<S3>/Merge6' incorporates:
          //   Merge: '<S122>/Merge3'

          rtb_Merge6[0] = DefaultExperiment_P.Tz_lim_sharm;
        } else if (DefaultExperiment_DW.UD_DSTATE_e <
                   -DefaultExperiment_P.Tz_lim_sharm) {
          // Merge: '<S3>/Merge6' incorporates:
          //   Merge: '<S122>/Merge3'
          ...
          rtb_Merge6[0] = DefaultExperiment_DW.UD_DSTATE_e;
        }
        ...
        if (DefaultExperiment_DW.UD_DSTATE > DefaultExperiment_P.Tz_lim_elarm) {
          // Merge: '<S3>/Merge6' incorporates:
          //   Merge: '<S122>/Merge4'

          rtb_Merge6[1] = DefaultExperiment_P.Tz_lim_elarm;
        } else if (DefaultExperiment_DW.UD_DSTATE <
                   -DefaultExperiment_P.Tz_lim_elarm) {
          // Merge: '<S3>/Merge6' incorporates:
          //   Merge: '<S122>/Merge4'
          ...
          rtb_Merge6[1] = DefaultExperiment_DW.UD_DSTATE;
        }
        ...
        if (DefaultExperiment_DW.UD_DSTATE_a > DefaultExperiment_P.Tz_lim_wrarm)
        {
          // Merge: '<S3>/Merge6' incorporates:
          //   Merge: '<S122>/Merge5'

          rtb_Merge6[2] = DefaultExperiment_P.Tz_lim_wrarm;
        } else if (DefaultExperiment_DW.UD_DSTATE_a <
                   -DefaultExperiment_P.Tz_lim_wrarm) {
          // Merge: '<S3>/Merge6' incorporates:
          //   Merge: '<S122>/Merge5'
          ...
          rtb_Merge6[2] = DefaultExperiment_DW.UD_DSTATE_a;
        }
        ...
        rtb_Merge6[0] = DefaultExperiment_DW.ARM_Desired_States[0];
        rtb_Merge6[1] = DefaultExperiment_DW.ARM_Desired_States[1];
        rtb_Merge6[2] = DefaultExperiment_DW.ARM_Desired_States[2];
    ...
    } else if (DefaultExperiment_DW.ARM_Control_Law_Enabler == 2.0) {
      // Outputs for IfAction SubSystem: '<S3>/Custom Control (ARM)' incorporates:
      //   ActionPort: '<S117>/Action Port'

      DefaultExperim_CustomControlRED(rtb_Merge6,
        &DefaultExperiment_P.CustomControlARM);
      ...
      DefaultExperiment_DW.ARM_Control_Mode =
        DefaultExperiment_P.Constant7_Value_h;

      // Merge: '<S3>/Merge6' incorporates:
      //   Constant: '<S126>/Zero'
      //   SignalConversion generated from: '<S126>/Out1'

      rtb_Merge6[0] = DefaultExperiment_P.Zero_Value;
      rtb_Merge6[1] = DefaultExperiment_P.Zero_Value;
      rtb_Merge6[2] = DefaultExperiment_P.Zero_Value;
    ...
    if (DefaultExperiment_DW.RED_Control_Law_Enabler == 1.0) {
      ...
      //   y = u * K where K = 1 / ( w * Ts )
      //
      DefaultExperimen_MATLABFunction(DefaultExperiment_DW.RED_Desired_States[2],
        DefaultExperiment_DW.RED_Measured_States[2], &rtb_TSamp_e);
      rtb_TSamp = DefaultExperiment_DW.RED_Desired_States[0] *
        DefaultExperiment_P.TSamp_WtEt;
      ...
      DefaultExperiment_DW.UD_DSTATE_eg = rtb_TSamp -
        DefaultExperiment_DW.UD_DSTATE_eg;
      ...
      //   y = u * K where K = 1 / ( w * Ts )
      //
      rtb_TSamp_hx = DefaultExperiment_DW.RED_Desired_States[1] *
        DefaultExperiment_P.TSamp_WtEt_f;
      ...
      DefaultExperiment_DW.UD_DSTATE_cd = rtb_TSamp_hx -
        DefaultExperiment_DW.UD_DSTATE_cd;
      ...
      //   y = u * K where K = 1 / ( w * Ts )
      //
      rtb_TSamp_h = DefaultExperiment_DW.RED_Desired_States[2] *
        DefaultExperiment_P.TSamp_WtEt_c;
      ...
      DefaultExperiment_DW.UD_DSTATE_hd = rtb_TSamp_h -
        DefaultExperiment_DW.UD_DSTATE_hd;
      ...
      DefaultExperiment_DW.UD_DSTATE_eg =
        DefaultExperiment_DW.RED_Measured_States[3] -
        DefaultExperiment_DW.UD_DSTATE_eg;
      ...
      DefaultExperiment_DW.UD_DSTATE_cd =
        DefaultExperiment_DW.RED_Measured_States[4] -
        DefaultExperiment_DW.UD_DSTATE_cd;
      ...
      DefaultExperiment_DW.UD_DSTATE_hd =
        DefaultExperiment_DW.RED_Measured_States[5] -
        DefaultExperiment_DW.UD_DSTATE_hd;
      ...
      DefaultExperiment_B.Merge[0] = ((DefaultExperiment_DW.RED_Measured_States
        [0] - DefaultExperiment_DW.RED_Desired_States[0]) *
        DefaultExperiment_P.Kp_xr + DefaultExperiment_P.Kd_xr *
        DefaultExperiment_DW.UD_DSTATE_eg) * DefaultExperiment_P.Gain6_Gain;
      DefaultExperiment_B.Merge[1] = ((DefaultExperiment_DW.RED_Measured_States
        [1] - DefaultExperiment_DW.RED_Desired_States[1]) *
        DefaultExperiment_P.Kp_yr + DefaultExperiment_P.Kd_yr *
        DefaultExperiment_DW.UD_DSTATE_cd) * DefaultExperiment_P.Gain7_Gain;
      ...
      DefaultExperiment_B.Merge[2] = (DefaultExperiment_P.Kp_tr * rtb_TSamp_e +
        DefaultExperiment_P.Kd_tr * DefaultExperiment_DW.UD_DSTATE_hd) *
        DefaultExperiment_P.Gain8_Gain;
    ...
    } else if (DefaultExperiment_DW.RED_Control_Law_Enabler == 2.0) {
      ...
      //
      DefaultExperimen_MATLABFunction(DefaultExperiment_DW.RED_Desired_States[2],
        DefaultExperiment_DW.RED_Measured_States[2], &tmp_2[2]);
      rtb_TSamp_e = DefaultExperiment_DW.RED_Desired_States[0] *
        DefaultExperiment_P.TSamp_WtEt_h;
      ...
      DefaultExperiment_DW.UD_DSTATE_aq = rtb_TSamp_e -
        DefaultExperiment_DW.UD_DSTATE_aq;
      ...
      //   y = u * K where K = 1 / ( w * Ts )
      //
      rtb_TSamp = DefaultExperiment_DW.RED_Desired_States[1] *
        DefaultExperiment_P.TSamp_WtEt_e;
      ...
      DefaultExperiment_DW.UD_DSTATE_p = rtb_TSamp -
        DefaultExperiment_DW.UD_DSTATE_p;
      ...
      //   y = u * K where K = 1 / ( w * Ts )
      //
      rtb_TSamp_hx = DefaultExperiment_DW.RED_Desired_States[2] *
        DefaultExperiment_P.TSamp_WtEt_n;
      ...
      DefaultExperiment_DW.UD_DSTATE_pr = rtb_TSamp_hx -
        DefaultExperiment_DW.UD_DSTATE_pr;
      ...
      for (i = 0; i < 18; i++) {
        ...
        tmp[i] = -DefaultExperiment_P.K_RED[i];
      }
      ...
      tmp_2[0] = DefaultExperiment_DW.RED_Measured_States[0] -
        DefaultExperiment_DW.RED_Desired_States[0];
      tmp_2[1] = DefaultExperiment_DW.RED_Measured_States[1] -
        DefaultExperiment_DW.RED_Desired_States[1];
      ...
      tmp_2[3] = DefaultExperiment_DW.UD_DSTATE_aq;
      tmp_2[4] = DefaultExperiment_DW.UD_DSTATE_p;
      tmp_2[5] = DefaultExperiment_DW.UD_DSTATE_pr;
      for (i = 0; i < 3; i++) {
        // Product: '<S121>/Matrix Multiply' incorporates:
        //   Merge: '<S3>/Merge'
        ...
        DefaultExperiment_B.Merge[i] = rtb_TSamp_h;
      }
    ...
    } else if (DefaultExperiment_DW.RED_Control_Law_Enabler == 3.0) {
      // Outputs for IfAction SubSystem: '<S3>/Custom Control (RED)' incorporates:
      //   ActionPort: '<S118>/Action Port'

      DefaultExperim_CustomControlRED(DefaultExperiment_B.Merge,
        &DefaultExperiment_P.CustomControlRED);
      ...
      DefaultExperim_CustomControlRED(DefaultExperiment_B.Merge,
        &DefaultExperiment_P.DisableThrustersRED);
    ...
    b_u1[1] = DefaultExperiment_B.Merge[0];
    b_u1[2] = DefaultExperiment_B.Merge[1];
    b_u1[3] = DefaultExperiment_B.Merge[2];

    // DataStoreWrite: '<S15>/Data Store Write' incorporates:
    //   Constant: '<S15>/Constant'

    DefaultExperiment_DW.isSim = DefaultExperiment_P.simMode;
    ...
    if ((DefaultExperiment_DW.WhoAmI == 1.0) || (DefaultExperiment_DW.isSim ==
         1.0)) {
      ...
      DefaultExp_CreateRotationMatrix(DefaultExperiment_DW.RED_Measured_States[2],
        rtb_C_Ib);

      // MATLAB Function: '<S256>/Create Rotation Matrix' incorporates:
      //   DataStoreRead: '<S230>/Data Store Read1'

      DefaultE_CreateRotationMatrix_a(DefaultExperiment_DW.RED_Measured_States[2],
        &rtb_ThrustPer_Final_p[0]);

      // Product: '<S256>/Rotate F_I to F_b' incorporates:
      //   DataStoreWrite: '<S3>/RED Controls'

      rtb_TSamp_e = rtb_ThrustPer_Final_p[0] * DefaultExperiment_B.Merge[0] +
        DefaultExperiment_B.Merge[1] * rtb_ThrustPer_Final_p[2];
      ...
      rtb_TSamp = DefaultExperiment_B.Merge[0] * rtb_ThrustPer_Final_p[1] +
        DefaultExperiment_B.Merge[1] * rtb_ThrustPer_Final_p[3];

      // SignalConversion generated from: '<S258>/Product3' incorporates:
      //   DataStoreWrite: '<S3>/RED Controls'

      rtb_Product1[1] = rtb_TSamp;
      rtb_Product1[2] = DefaultExperiment_B.Merge[2];

      // MATLAB Function: '<S258>/MATLAB Function'
      for (i = 0; i < 8; i++) {
        rtb_Product3_f[i] = DefaultExperiment_P.F_thrusters_RED[i] / 2.0;
      }
      ...
      DefaultExperimen_Pseudoinverse1(rtb_H,
        &DefaultExperiment_B.Pseudoinverse1_pn);
      for (i = 0; i < 8; i++) {
        ...
        rtb_Product3[i] =
          (DefaultExperiment_B.Pseudoinverse1_pn.Pseudoinverse1[i + 8] *
           rtb_TSamp + DefaultExperiment_B.Pseudoinverse1_pn.Pseudoinverse1[i] *
           rtb_TSamp_e) + DefaultExperiment_B.Pseudoinverse1_pn.Pseudoinverse1[i
          + 16] * rtb_Product1[2];
      }
      ...
      DefaultExperime_MATLABFunction5(rtb_Product1, rtb_Product3, rtb_H_final,
        DefaultExperiment_B.duty_cycles,
        DefaultExperiment_P.MATLABFunction5_max_iters_e,
        DefaultExperiment_P.MATLABFunction5_tol_g);

      // MATLAB Function: '<S255>/MATLAB Function8'
      DefaultExperime_MATLABFunction1(DefaultExperiment_B.duty_cycles,
        rtb_ThrustPer_Final_p);

      // Outputs for Enabled SubSystem: '<S257>/Enabled Subsystem' incorporates:
      //   EnablePort: '<S262>/Enable'

      if (DefaultExperiment_DW.Delay_DSTATE >= 1.0 / DefaultExperiment_P.PWMFreq)
      {
        // SignalConversion generated from: '<S262>/In1' incorporates:
        //   DataStoreRead: '<S257>/Data Store Read'

        DefaultExperiment_B.In1 = DefaultExperiment_DW.Univ_Time;
      }
      ...
      DefaultExperiment_DW.Delay_DSTATE = DefaultExperiment_DW.Univ_Time -
        DefaultExperiment_B.In1;

      // Outputs for Enabled SubSystem: '<S257>/Enabled Subsystem1' incorporates:
      //   EnablePort: '<S263>/Enable'

      if (DefaultExperiment_DW.Delay_DSTATE ==
          DefaultExperiment_P.Constant2_Value_e) {
        // SignalConversion generated from: '<S263>/ThrustPer_Final'
        memcpy(&DefaultExperiment_B.ThrustPer_Final[0], &rtb_ThrustPer_Final_p[0],
               sizeof(real_T) << 3U);
      }
      ...
      for (i = 0; i < 3; i++) {
        ...
        for (idx = 0; idx < 8; idx++) {
          rtb_TSamp_e += rtb_H_final[3 * idx + i] *
            DefaultExperiment_B.ThrustPer_Final[idx];
        }
      ...
      DefaultExperiment_DW.RED_Saturated_Controls[0] = rtb_C_Ib[0] *
        rtb_Product1[0] + rtb_Product1[1] * rtb_C_Ib[2];
      DefaultExperiment_DW.RED_Saturated_Controls[1] = rtb_Product1[0] *
        rtb_C_Ib[1] + rtb_Product1[1] * rtb_C_Ib[3];
      DefaultExperiment_DW.RED_Saturated_Controls[2] = rtb_Product1[2];
    ...
    memcpy(&rtb_Product3[0], &DefaultExperiment_B.duty_cycles[0], sizeof(real_T)
           << 3U);
    ...
    if ((DefaultExperiment_DW.WhoAmI == 2.0) || (DefaultExperiment_DW.isSim ==
         1.0)) {
      ...
      DefaultExp_CreateRotationMatrix
        (DefaultExperiment_DW.BLACK_Measured_States[2], rtb_C_Ib);

      // MATLAB Function: '<S232>/Create Rotation Matrix' incorporates:
      //   DataStoreRead: '<S228>/BLACK States'

      DefaultE_CreateRotationMatrix_a
        (DefaultExperiment_DW.BLACK_Measured_States[2], &rtb_H_final_g[0]);

      // Product: '<S232>/Rotate F_I to F_b' incorporates:
      //   DataStoreWrite: '<S3>/BLACK Controls'

      rtb_TSamp_e = rtb_H_final_g[0] * DefaultExperiment_B.Merge1[0] +
        DefaultExperiment_B.Merge1[1] * rtb_H_final_g[2];
      ...
      rtb_TSamp = DefaultExperiment_B.Merge1[0] * rtb_H_final_g[1] +
        DefaultExperiment_B.Merge1[1] * rtb_H_final_g[3];

      // SignalConversion generated from: '<S234>/Product3' incorporates:
      //   DataStoreWrite: '<S3>/BLACK Controls'

      rtb_Product1[1] = rtb_TSamp;
      rtb_Product1[2] = DefaultExperiment_B.Merge1[2];

      // MATLAB Function: '<S234>/MATLAB Function'
      for (i = 0; i < 8; i++) {
        rtb_Product3_f[i] = DefaultExperiment_P.F_thrusters_BLACK[i] / 2.0;
      }
      ...
      for (i = 0; i < 8; i++) {
        ...
        b[3 * i] = b_0[i];
        b[3 * i + 1] = c[i];
        b[3 * i + 2] = DefaultExperiment_P.thruster_dist2CG_BLACK[i] / 1000.0;
      }
      ...
      DefaultExperimen_Pseudoinverse1(rtb_H, &DefaultExperiment_B.Pseudoinverse1);
      for (i = 0; i < 8; i++) {
        // Product: '<S234>/Product3' incorporates:
        //   MATLABSystem: '<S234>/Pseudoinverse1'
        //   Product: '<S232>/Rotate F_I to F_b'

        rtb_Product3_h[i] = (DefaultExperiment_B.Pseudoinverse1.Pseudoinverse1[i
                             + 8] * rtb_TSamp +
                             DefaultExperiment_B.Pseudoinverse1.Pseudoinverse1[i]
                             * rtb_TSamp_e) +
          DefaultExperiment_B.Pseudoinverse1.Pseudoinverse1[i + 16] *
          rtb_Product1[2];
      }
      ...
      DefaultExperime_MATLABFunction5(rtb_Product1, rtb_Product3_h,
        rtb_H_final_g, DefaultExperiment_B.duty_cycles_m,
        DefaultExperiment_P.MATLABFunction5_max_iters,
        DefaultExperiment_P.MATLABFunction5_tol);

      // MATLAB Function: '<S231>/MATLAB Function1'
      DefaultExperime_MATLABFunction1(DefaultExperiment_B.duty_cycles_m,
        rtb_Product3_h);

      // Outputs for Enabled SubSystem: '<S233>/Enabled Subsystem' incorporates:
      //   EnablePort: '<S238>/Enable'

      if (DefaultExperiment_DW.Delay_DSTATE_kz >= 1.0 /
          DefaultExperiment_P.PWMFreq) {
        // SignalConversion generated from: '<S238>/In1' incorporates:
        //   DataStoreRead: '<S233>/Data Store Read'

        DefaultExperiment_B.In1_g2 = DefaultExperiment_DW.Univ_Time;
      }
      ...
      DefaultExperiment_DW.Delay_DSTATE_kz = DefaultExperiment_DW.Univ_Time -
        DefaultExperiment_B.In1_g2;

      // Outputs for Enabled SubSystem: '<S233>/Enabled Subsystem1' incorporates:
      //   EnablePort: '<S239>/Enable'

      if (DefaultExperiment_DW.Delay_DSTATE_kz ==
          DefaultExperiment_P.Constant2_Value_h) {
        // SignalConversion generated from: '<S239>/ThrustPer_Final'
        memcpy(&DefaultExperiment_B.ThrustPer_Final_h5[0], &rtb_Product3_h[0],
               sizeof(real_T) << 3U);
      }
      ...
      for (i = 0; i < 3; i++) {
        ...
        for (idx = 0; idx < 8; idx++) {
          rtb_TSamp_e += rtb_H_final_g[3 * idx + i] *
            DefaultExperiment_B.ThrustPer_Final_h5[idx];
        }
      ...
      DefaultExperiment_DW.BLACK_Saturated_Controls[0] = rtb_C_Ib[0] *
        rtb_Product1[0] + rtb_Product1[1] * rtb_C_Ib[2];
      DefaultExperiment_DW.BLACK_Saturated_Controls[1] = rtb_Product1[0] *
        rtb_C_Ib[1] + rtb_Product1[1] * rtb_C_Ib[3];
      DefaultExperiment_DW.BLACK_Saturated_Controls[2] = rtb_Product1[2];
    ...
    memcpy(&rtb_Product3_h[0], &DefaultExperiment_B.duty_cycles_m[0], sizeof
           (real_T) << 3U);
    ...
    if ((DefaultExperiment_DW.WhoAmI == 3.0) || (DefaultExperiment_DW.isSim ==
         1.0)) {
      ...
      DefaultExp_CreateRotationMatrix(DefaultExperiment_DW.BLUE_Measured_States
        [2], rtb_C_Ib);

      // MATLAB Function: '<S244>/Create Rotation Matrix' incorporates:
      //   DataStoreRead: '<S229>/Data Store Read1'

      DefaultE_CreateRotationMatrix_a(DefaultExperiment_DW.BLUE_Measured_States
        [2], &rtb_H_final_j[0]);

      // Product: '<S244>/Rotate F_I to F_b' incorporates:
      //   DataStoreWrite: '<S3>/BLUE Controls'

      rtb_TSamp_e = rtb_H_final_j[0] * DefaultExperiment_B.Merge2[0] +
        DefaultExperiment_B.Merge2[1] * rtb_H_final_j[2];
      ...
      rtb_TSamp = DefaultExperiment_B.Merge2[0] * rtb_H_final_j[1] +
        DefaultExperiment_B.Merge2[1] * rtb_H_final_j[3];

      // SignalConversion generated from: '<S246>/Product3' incorporates:
      //   DataStoreWrite: '<S3>/BLUE Controls'

      rtb_Product1[1] = rtb_TSamp;
      rtb_Product1[2] = DefaultExperiment_B.Merge2[2];

      // MATLAB Function: '<S246>/MATLAB Function'
      for (i = 0; i < 8; i++) {
        rtb_Product3_f[i] = DefaultExperiment_P.F_thrusters_BLUE[i] / 2.0;
      }
      ...
      for (i = 0; i < 8; i++) {
        ...
        b[3 * i] = b_0[i];
        b[3 * i + 1] = c[i];
        b[3 * i + 2] = DefaultExperiment_P.thruster_dist2CG_BLUE[i] / 1000.0;
      }
      ...
      DefaultExperimen_Pseudoinverse1(rtb_H,
        &DefaultExperiment_B.Pseudoinverse1_p);
      for (i = 0; i < 8; i++) {
        ...
        rtb_Product3_f[i] =
          (DefaultExperiment_B.Pseudoinverse1_p.Pseudoinverse1[i + 8] *
           rtb_TSamp + DefaultExperiment_B.Pseudoinverse1_p.Pseudoinverse1[i] *
           rtb_TSamp_e) + DefaultExperiment_B.Pseudoinverse1_p.Pseudoinverse1[i
          + 16] * rtb_Product1[2];
      }
      ...
      DefaultExperime_MATLABFunction5(rtb_Product1, rtb_Product3_f,
        rtb_H_final_j, DefaultExperiment_B.duty_cycles_j,
        DefaultExperiment_P.MATLABFunction5_max_iters_b,
        DefaultExperiment_P.MATLABFunction5_tol_j);

      // MATLAB Function: '<S243>/MATLAB Function1'
      DefaultExperime_MATLABFunction1(DefaultExperiment_B.duty_cycles_j,
        rtb_Product3_f);

      // Outputs for Enabled SubSystem: '<S245>/Enabled Subsystem' incorporates:
      //   EnablePort: '<S250>/Enable'

      if (DefaultExperiment_DW.Delay_DSTATE_k >= 1.0 /
          DefaultExperiment_P.PWMFreq) {
        // SignalConversion generated from: '<S250>/In1' incorporates:
        //   DataStoreRead: '<S245>/Data Store Read'

        DefaultExperiment_B.In1_g = DefaultExperiment_DW.Univ_Time;
      }
      ...
      DefaultExperiment_DW.Delay_DSTATE_k = DefaultExperiment_DW.Univ_Time -
        DefaultExperiment_B.In1_g;

      // Outputs for Enabled SubSystem: '<S245>/Enabled Subsystem1' incorporates:
      //   EnablePort: '<S251>/Enable'

      if (DefaultExperiment_DW.Delay_DSTATE_k ==
          DefaultExperiment_P.Constant2_Value_f) {
        // SignalConversion generated from: '<S251>/ThrustPer_Final'
        memcpy(&DefaultExperiment_B.ThrustPer_Final_h[0], &rtb_Product3_f[0],
               sizeof(real_T) << 3U);
      }
      ...
      for (i = 0; i < 3; i++) {
        ...
        for (idx = 0; idx < 8; idx++) {
          rtb_TSamp_e += rtb_H_final_j[3 * idx + i] *
            DefaultExperiment_B.ThrustPer_Final_h[idx];
        }
      ...
      DefaultExperiment_DW.BLUE_Saturated_Controls[0] = rtb_C_Ib[0] *
        rtb_Product1[0] + rtb_Product1[1] * rtb_C_Ib[2];
      DefaultExperiment_DW.BLUE_Saturated_Controls[1] = rtb_Product1[0] *
        rtb_C_Ib[1] + rtb_Product1[1] * rtb_C_Ib[3];
      DefaultExperiment_DW.BLUE_Saturated_Controls[2] = rtb_Product1[2];
    ...
    memcpy(&rtb_Product3_f[0], &DefaultExperiment_B.duty_cycles_j[0], sizeof
           (real_T) << 3U);
    ...
    DefaultExperiment_B.TmpSignalConversionAtUDPSendInp[0] =
      DefaultExperiment_P.SafetyNumber_Value;
    DefaultExperiment_B.TmpSignalConversionAtUDPSendInp[1] =
      DefaultExperiment_P.PWMFreq;
    DefaultExperiment_B.TmpSignalConversionAtUDPSendInp[2] =
      ((DefaultExperiment_B.duty_cycles[0] + DefaultExperiment_B.duty_cycles_m[0])
       + DefaultExperiment_B.duty_cycles_j[0]) * DefaultExperiment_P.Gain_Gain;
    DefaultExperiment_B.TmpSignalConversionAtUDPSendInp[3] =
      ((DefaultExperiment_B.duty_cycles[1] + DefaultExperiment_B.duty_cycles_m[1])
       + DefaultExperiment_B.duty_cycles_j[1]) * DefaultExperiment_P.Gain1_Gain;
    DefaultExperiment_B.TmpSignalConversionAtUDPSendInp[4] =
      ((DefaultExperiment_B.duty_cycles[2] + DefaultExperiment_B.duty_cycles_m[2])
       + DefaultExperiment_B.duty_cycles_j[2]) * DefaultExperiment_P.Gain2_Gain;
    DefaultExperiment_B.TmpSignalConversionAtUDPSendInp[5] =
      ((DefaultExperiment_B.duty_cycles[3] + DefaultExperiment_B.duty_cycles_m[3])
       + DefaultExperiment_B.duty_cycles_j[3]) * DefaultExperiment_P.Gain3_Gain;
    DefaultExperiment_B.TmpSignalConversionAtUDPSendInp[6] =
      ((DefaultExperiment_B.duty_cycles[4] + DefaultExperiment_B.duty_cycles_m[4])
       + DefaultExperiment_B.duty_cycles_j[4]) * DefaultExperiment_P.Gain4_Gain;
    DefaultExperiment_B.TmpSignalConversionAtUDPSendInp[7] =
      ((DefaultExperiment_B.duty_cycles[5] + DefaultExperiment_B.duty_cycles_m[5])
       + DefaultExperiment_B.duty_cycles_j[5]) * DefaultExperiment_P.Gain5_Gain;
    DefaultExperiment_B.TmpSignalConversionAtUDPSendInp[8] =
      ((DefaultExperiment_B.duty_cycles[6] + DefaultExperiment_B.duty_cycles_m[6])
       + DefaultExperiment_B.duty_cycles_j[6]) *
      DefaultExperiment_P.Gain6_Gain_c;
    DefaultExperiment_B.TmpSignalConversionAtUDPSendInp[9] =
      ((DefaultExperiment_B.duty_cycles[7] + DefaultExperiment_B.duty_cycles_m[7])
       + DefaultExperiment_B.duty_cycles_j[7]) *
      DefaultExperiment_P.Gain7_Gain_l;
    ...
    if (DefaultExperiment_DW.Univ_Time < DefaultExperiment_P.Phase0_End) {
      // Outputs for IfAction SubSystem: '<S1>/Phase #0: Synchronization' incorporates:
      //   ActionPort: '<S18>/Action Port'

      DefaultEx_Phase0Synchronization
        (&DefaultExperiment_DW.ARM_Control_Law_Enabler, &rtb_TSamp_e,
         &DefaultExperiment_DW.BLACK_Control_Law_Enabler,
         DefaultExperiment_DW.BLACK_Logger, &rtb_TSamp,
         &DefaultExperiment_DW.BLUE_Control_Law_Enabler,
         DefaultExperiment_DW.BLUE_Logger, &rtb_TSamp_hx,
         &DefaultExperiment_DW.Float_State,
         &DefaultExperiment_DW.RED_Control_Law_Enabler,
         DefaultExperiment_DW.RED_Logger, &rtb_TSamp_h,
         &DefaultExperiment_P.Phase0Synchronization);

      // End of Outputs for SubSystem: '<S1>/Phase #0: Synchronization'
    } else if ((DefaultExperiment_DW.Univ_Time < DefaultExperiment_P.Phase1_End)
               && (DefaultExperiment_DW.Univ_Time >=
                   DefaultExperiment_P.Phase0_End)) {
      ...
      DefaultEx_Phase0Synchronization
        (&DefaultExperiment_DW.ARM_Control_Law_Enabler, &rtb_TSamp_e,
         ...
         &DefaultExperiment_DW.RED_Control_Law_Enabler,
         DefaultExperiment_DW.RED_Logger, &rtb_TSamp_h,
         &DefaultExperiment_P.Phase1StartFloating);

      // End of Outputs for SubSystem: '<S1>/Phase #1: Start Floating '
    } else if ((DefaultExperiment_DW.Univ_Time < DefaultExperiment_P.Phase2_End)
               && (DefaultExperiment_DW.Univ_Time >=
                   DefaultExperiment_P.Phase1_End)) {
      ...
      DefaultExperiment_DW.ARM_Control_Law_Enabler =
        DefaultExperiment_P.Constant18_Value;

      // DataStoreWrite: '<S20>/Data Store Write4' incorporates:
      //   Constant: '<S20>/Constant4'

      DefaultExperiment_DW.BLACK_Control_Law_Enabler =
        DefaultExperiment_P.Constant4_Value;

      // DataStoreWrite: '<S20>/Data Store Write8' incorporates:
      //   Constant: '<S20>/Constant5'

      DefaultExperiment_DW.RED_Control_Law_Enabler =
        DefaultExperiment_P.Constant5_Value;

      // DataStoreWrite: '<S20>/Data Store Write7' incorporates:
      //   Constant: '<S20>/Constant6'

      DefaultExperiment_DW.Float_State = DefaultExperiment_P.Constant6_Value;

      // DataStoreWrite: '<S20>/Data Store Write16' incorporates:
      //   Constant: '<S20>/Constant8'

      DefaultExperiment_DW.BLUE_Control_Law_Enabler =
        DefaultExperiment_P.Constant8_Value;
      strncpy(&DefaultExperiment_DW.BLACK_Logger[0],
              &DefaultExperiment_P.StringConstant1_String[0], 255U);
      DefaultExperiment_DW.BLACK_Logger[255] = '\x00';
      strncpy(&DefaultExperiment_DW.BLUE_Logger[0],
              &DefaultExperiment_P.StringConstant2_String[0], 255U);
      DefaultExperiment_DW.BLUE_Logger[255] = '\x00';
      ...
      DefaultExperiment_DW.ARM_Desired_States[0] =
        DefaultExperiment_P.Constant3_Value;
      DefaultExperiment_DW.ARM_Desired_States[1] =
        DefaultExperiment_P.Constant1_Value;
      DefaultExperiment_DW.ARM_Desired_States[2] =
        DefaultExperiment_P.Constant2_Value;
      strncpy(&DefaultExperiment_DW.RED_Logger[0],
              &DefaultExperiment_P.StringConstant_String[0], 255U);
      DefaultExperiment_DW.RED_Logger[255] = '\x00';
      ...
      DefaultExperiment_DW.BLACK_Desired_States[0] =
        DefaultExperiment_P.init_states_BLACK[0];

      // DataStoreWrite: '<S20>/Data Store Write18' incorporates:
      //   Constant: '<S27>/Desired States (BLUE)'

      DefaultExperiment_DW.BLUE_Desired_States[0] =
        DefaultExperiment_P.init_states_BLUE[0];

      // DataStoreWrite: '<S20>/Data Store Write9' incorporates:
      //   Constant: '<S28>/Constant2'

      DefaultExperiment_DW.RED_Desired_States[0] =
        DefaultExperiment_P.init_states_RED[0];

      // DataStoreWrite: '<S20>/Data Store Write1' incorporates:
      //   Constant: '<S26>/Desired States (BLACK)'

      DefaultExperiment_DW.BLACK_Desired_States[1] =
        DefaultExperiment_P.init_states_BLACK[1];

      // DataStoreWrite: '<S20>/Data Store Write18' incorporates:
      //   Constant: '<S27>/Desired States (BLUE)'

      DefaultExperiment_DW.BLUE_Desired_States[1] =
        DefaultExperiment_P.init_states_BLUE[1];

      // DataStoreWrite: '<S20>/Data Store Write9' incorporates:
      //   Constant: '<S28>/Constant2'

      DefaultExperiment_DW.RED_Desired_States[1] =
        DefaultExperiment_P.init_states_RED[1];

      // DataStoreWrite: '<S20>/Data Store Write1' incorporates:
      //   Constant: '<S26>/Desired States (BLACK)'

      DefaultExperiment_DW.BLACK_Desired_States[2] =
        DefaultExperiment_P.init_states_BLACK[2];

      // DataStoreWrite: '<S20>/Data Store Write18' incorporates:
      //   Constant: '<S27>/Desired States (BLUE)'

      DefaultExperiment_DW.BLUE_Desired_States[2] =
        DefaultExperiment_P.init_states_BLUE[2];

      // DataStoreWrite: '<S20>/Data Store Write9' incorporates:
      //   Constant: '<S28>/Constant2'

      DefaultExperiment_DW.RED_Desired_States[2] =
        DefaultExperiment_P.init_states_RED[2];

      // End of Outputs for SubSystem: '<S1>/Phase #2: Initial Position'
    } else if ((DefaultExperiment_DW.Univ_Time < DefaultExperiment_P.Phase3_End)
               && (DefaultExperiment_DW.Univ_Time >=
                   DefaultExperiment_P.Phase2_End)) {
      ...
      if (DefaultExperiment_DW.Univ_Time <
          DefaultExperiment_P.Phase3_SubPhase1_End) {
        // Outputs for IfAction SubSystem: '<S21>/Sub-Phase #1' incorporates:
        //   ActionPort: '<S29>/Action Port'

        DefaultExperiment_SubPhase1
          (&DefaultExperiment_DW.ARM_Control_Law_Enabler,
           DefaultExperiment_DW.ARM_Desired_States, &rtb_TSamp_e,
           &DefaultExperiment_DW.BLACK_Control_Law_Enabler,
           DefaultExperiment_DW.BLACK_Desired_States,
           DefaultExperiment_DW.BLACK_Logger, &rtb_TSamp,
           &DefaultExperiment_DW.BLUE_Control_Law_Enabler,
           DefaultExperiment_DW.BLUE_Desired_States,
           DefaultExperiment_DW.BLUE_Logger, &rtb_TSamp_hx,
           &DefaultExperiment_DW.Float_State,
           &DefaultExperiment_DW.RED_Control_Law_Enabler,
           DefaultExperiment_DW.RED_Desired_States,
           DefaultExperiment_DW.RED_Logger, &rtb_TSamp_h,
           &DefaultExperiment_DW.Univ_Time, &DefaultExperiment_P.SubPhase1);

        // End of Outputs for SubSystem: '<S21>/Sub-Phase #1'
      } else if ((DefaultExperiment_DW.Univ_Time <
                  DefaultExperiment_P.Phase3_SubPhase2_End) &&
                 (DefaultExperiment_DW.Univ_Time >=
                  DefaultExperiment_P.Phase3_SubPhase1_End)) {
        ...
        DefaultExperiment_SubPhase1
          (&DefaultExperiment_DW.ARM_Control_Law_Enabler,
           ...
           DefaultExperiment_DW.RED_Desired_States,
           DefaultExperiment_DW.RED_Logger, &rtb_TSamp_h,
           &DefaultExperiment_DW.Univ_Time, &DefaultExperiment_P.SubPhase2);

        // End of Outputs for SubSystem: '<S21>/Sub-Phase #2 '
      } else if ((DefaultExperiment_DW.Univ_Time <
                  DefaultExperiment_P.Phase3_SubPhase3_End) &&
                 (DefaultExperiment_DW.Univ_Time >=
                  DefaultExperiment_P.Phase3_SubPhase2_End)) {
        ...
        DefaultExperiment_SubPhase1
          (&DefaultExperiment_DW.ARM_Control_Law_Enabler,
           ...
           DefaultExperiment_DW.RED_Desired_States,
           DefaultExperiment_DW.RED_Logger, &rtb_TSamp_h,
           &DefaultExperiment_DW.Univ_Time, &DefaultExperiment_P.SubPhase3);

        // End of Outputs for SubSystem: '<S21>/Sub-Phase #3 '
      } else if ((DefaultExperiment_DW.Univ_Time <
                  DefaultExperiment_P.Phase3_SubPhase4_End) &&
                 (DefaultExperiment_DW.Univ_Time >=
                  DefaultExperiment_P.Phase3_SubPhase3_End)) {
        ...
        DefaultExperiment_SubPhase1
          (&DefaultExperiment_DW.ARM_Control_Law_Enabler,
           ...
           DefaultExperiment_DW.RED_Desired_States,
           DefaultExperiment_DW.RED_Logger, &rtb_TSamp_h,
           &DefaultExperiment_DW.Univ_Time, &DefaultExperiment_P.SubPhase4);
    ...
    } else if ((DefaultExperiment_DW.Univ_Time < DefaultExperiment_P.Phase4_End)
               && (DefaultExperiment_DW.Univ_Time >=
                   DefaultExperiment_P.Phase3_End)) {
      // Outputs for IfAction SubSystem: '<S1>/Phase #4: Return Home' incorporates:
      //   ActionPort: '<S22>/Action Port'

      DefaultExperim_Phase4ReturnHome
        (&DefaultExperiment_DW.ARM_Control_Law_Enabler,
         DefaultExperiment_DW.ARM_Desired_States, &rtb_TSamp_e,
         &DefaultExperiment_DW.BLACK_Control_Law_Enabler,
         DefaultExperiment_DW.BLACK_Desired_States,
         ...
         DefaultExperiment_DW.RED_Desired_States,
         DefaultExperiment_DW.RED_Logger, &rtb_TSamp_h,
         &DefaultExperiment_P.Phase4ReturnHome);

      // End of Outputs for SubSystem: '<S1>/Phase #4: Return Home'
    } else if ((DefaultExperiment_DW.Univ_Time < DefaultExperiment_P.Phase5_End)
               && (DefaultExperiment_DW.Univ_Time >=
                   DefaultExperiment_P.Phase4_End)) {
      ...
      DefaultExperim_Phase4ReturnHome
        (&DefaultExperiment_DW.ARM_Control_Law_Enabler,
         ...
         DefaultExperiment_DW.RED_Desired_States,
         DefaultExperiment_DW.RED_Logger, &rtb_TSamp_h,
         &DefaultExperiment_P.Phase5HoldHome);
    ...
    } else if (DefaultExperiment_DW.Univ_Time >= DefaultExperiment_P.Phase5_End)
    {
      ...
      DefaultEx_Phase0Synchronization
        (&DefaultExperiment_DW.ARM_Control_Law_Enabler, &rtb_TSamp_e,
         ...
         &DefaultExperiment_DW.RED_Control_Law_Enabler,
         DefaultExperiment_DW.RED_Logger, &rtb_TSamp_h,
         &DefaultExperiment_P.Phase6CleanShutdown);
    ...
    if ((DefaultExperiment_DW.WhoAmI == 2.0) && (DefaultExperiment_DW.isSim ==
      ...
      DefaultExpe_ChangeBLACKBehavior(DefaultExperiment_M,
        &DefaultExperiment_DW.ChangeBLACKBehavior,
        &DefaultExperiment_P.ChangeBLACKBehavior);
    ...
    if ((DefaultExperiment_DW.WhoAmI == 3.0) && (DefaultExperiment_DW.isSim ==
      ...
      DefaultExpe_ChangeBLACKBehavior(DefaultExperiment_M,
        &DefaultExperiment_DW.ChangeBLUEBehavior,
        &DefaultExperiment_P.ChangeBLUEBehavior);
    ...
    if ((DefaultExperiment_DW.WhoAmI == 1.0) && (DefaultExperiment_DW.isSim ==
      ...
      DefaultExpe_ChangeBLACKBehavior(DefaultExperiment_M,
        &DefaultExperiment_DW.ChangeREDBehavior,
        &DefaultExperiment_P.ChangeREDBehavior);
    ...
    b_u1[0] = DefaultExperiment_DW.Univ_Time;
    b_u1[4] = DefaultExperiment_DW.RED_Saturated_Controls[0];
    b_u1[5] = DefaultExperiment_DW.RED_Saturated_Controls[1];
    b_u1[6] = DefaultExperiment_DW.RED_Saturated_Controls[2];
    memcpy(&b_u1[7], &DefaultExperiment_DW.RED_Measured_States[0], 9U * sizeof
           (real_T));
    b_u1[16] = DefaultExperiment_DW.RED_Desired_States[0];
    b_u1[19] = DefaultExperiment_DW.RED_IMU_Measurements[0];
    b_u1[17] = DefaultExperiment_DW.RED_Desired_States[1];
    b_u1[20] = DefaultExperiment_DW.RED_IMU_Measurements[1];
    b_u1[18] = DefaultExperiment_DW.RED_Desired_States[2];
    b_u1[21] = DefaultExperiment_DW.RED_IMU_Measurements[2];
    memcpy(&b_u1[22], &rtb_Product3[0], sizeof(real_T) << 3U);
    b_u1[30] = DefaultExperiment_DW.RED_Control_Law_Enabler;
    b_u1[34] = DefaultExperiment_DW.ARM_Control_Mode;
    ...
    for (i = 0; i < 6; i++) {
      b_u1[i + 38] = DefaultExperiment_DW.ARM_Measured_States[i];
    }

    b_u1[44] = ARM_Path[0];
    b_u1[47] = DefaultExperiment_DW.ARM_Desired_States[0];
    b_u1[50] = rtb_TSamp_k;
    b_u1[53] = DefaultExperiment_DW.BLACK_Saturated_Controls[0];
    b_u1[45] = ARM_Path[1];
    b_u1[48] = DefaultExperiment_DW.ARM_Desired_States[1];
    b_u1[51] = rtb_TSamp_af;
    b_u1[54] = DefaultExperiment_DW.BLACK_Saturated_Controls[1];
    b_u1[46] = ARM_Path[2];
    b_u1[49] = DefaultExperiment_DW.ARM_Desired_States[2];
    b_u1[52] = rtb_TSamp_o;
    b_u1[55] = DefaultExperiment_DW.BLACK_Saturated_Controls[2];
    memcpy(&b_u1[56], &DefaultExperiment_DW.BLACK_Measured_States[0], 9U *
           sizeof(real_T));
    b_u1[65] = DefaultExperiment_DW.BLACK_Desired_States[0];
    b_u1[68] = DefaultExperiment_DW.BLACK_IMU_Measurements[0];
    b_u1[66] = DefaultExperiment_DW.BLACK_Desired_States[1];
    b_u1[69] = DefaultExperiment_DW.BLACK_IMU_Measurements[1];
    b_u1[67] = DefaultExperiment_DW.BLACK_Desired_States[2];
    b_u1[70] = DefaultExperiment_DW.BLACK_IMU_Measurements[2];
    memcpy(&b_u1[71], &rtb_Product3_h[0], sizeof(real_T) << 3U);
    b_u1[79] = DefaultExperiment_DW.BLACK_Control_Law_Enabler;
    b_u1[80] = BLACK_Path_idx_0;
    b_u1[83] = rtb_TSamp_n5;
    b_u1[86] = DefaultExperiment_DW.BLUE_Saturated_Controls[0];
    b_u1[81] = BLACK_Path_idx_1;
    b_u1[84] = rtb_TSamp_d;
    b_u1[87] = DefaultExperiment_DW.BLUE_Saturated_Controls[1];
    b_u1[82] = BLACK_Path_idx_2;
    b_u1[85] = rtb_TSamp_ks;
    b_u1[88] = DefaultExperiment_DW.BLUE_Saturated_Controls[2];
    memcpy(&b_u1[89], &DefaultExperiment_DW.BLUE_Measured_States[0], 9U * sizeof
           (real_T));
    b_u1[98] = DefaultExperiment_DW.BLUE_Desired_States[0];
    b_u1[101] = DefaultExperiment_DW.BLUE_IMU_Measurements[0];
    b_u1[99] = DefaultExperiment_DW.BLUE_Desired_States[1];
    b_u1[102] = DefaultExperiment_DW.BLUE_IMU_Measurements[1];
    b_u1[100] = DefaultExperiment_DW.BLUE_Desired_States[2];
    b_u1[103] = DefaultExperiment_DW.BLUE_IMU_Measurements[2];
    memcpy(&b_u1[104], &rtb_Product3_f[0], sizeof(real_T) << 3U);
    b_u1[112] = DefaultExperiment_DW.BLUE_Control_Law_Enabler;
    b_u1[116] = DefaultExperiment_DW.Float_State;
    b_u1[117] = DefaultExperiment_DW.WhoAmI;
    b_u1[118] = DefaultExperiment_DW.isSim;
    b_u1[113] = BLUE_Path_idx_0;
    b_u1[119] = DefaultExperiment_DW.VIS_Measured_States[0];
    b_u1[114] = BLUE_Path_idx_1;
    b_u1[120] = DefaultExperiment_DW.VIS_Measured_States[1];
    b_u1[115] = BLUE_Path_idx_2;
    b_u1[121] = DefaultExperiment_DW.VIS_Measured_States[2];
    b_u1[122] = DefaultExperiment_DW.VIS_Confidence;
    ...
    if ((DefaultExperiment_DW.WhoAmI == 2.0) && (DefaultExperiment_DW.isSim ==
      ...
      strncpy((char_T *)&DefaultExperiment_B.StringtoASCII1[0],
              &DefaultExperiment_DW.BLACK_Logger[0], 31U);

      // Update for S-Function (sdspToNetwork): '<S173>/UDP Send1' incorporates:
      //   StringToASCII: '<S173>/String to ASCII1'
      //
      sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPSend1_NetworkLib[0U]);
      LibUpdate_Network(&DefaultExperiment_DW.UDPSend1_NetworkLib[0U],
                        &DefaultExperiment_B.StringtoASCII1[0U], 31);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
      }
    ...
    if ((DefaultExperiment_DW.WhoAmI == 3.0) && (DefaultExperiment_DW.isSim ==
      ...
      strncpy((char_T *)&DefaultExperiment_B.StringtoASCII2[0],
              &DefaultExperiment_DW.BLUE_Logger[0], 31U);

      // Update for S-Function (sdspToNetwork): '<S174>/UDP Send2' incorporates:
      //   StringToASCII: '<S174>/String to ASCII2'
      //
      sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPSend2_NetworkLib[0U]);
      LibUpdate_Network(&DefaultExperiment_DW.UDPSend2_NetworkLib[0U],
                        &DefaultExperiment_B.StringtoASCII2[0U], 31);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
      }
    ...
    if ((DefaultExperiment_DW.WhoAmI == 1.0) && (DefaultExperiment_DW.isSim ==
      ...
      strncpy((char_T *)&DefaultExperiment_B.StringtoASCII[0],
              &DefaultExperiment_DW.RED_Logger[0], 31U);

      // Update for S-Function (sdspToNetwork): '<S175>/UDP Send3' incorporates:
      //   StringToASCII: '<S175>/String to ASCII'
      //
      sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPSend3_NetworkLib[0U]);
      LibUpdate_Network(&DefaultExperiment_DW.UDPSend3_NetworkLib[0U],
                        &DefaultExperiment_B.StringtoASCII[0U], 31);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
      }
    ...
    if (DefaultExperiment_DW.isSim == 0.0) {
      ...
      if (DefaultExperiment_DW.obj_l.gpioPin !=
          DefaultExperiment_P.GPIOWrite1_gpioPin) {
        DefaultExperiment_DW.obj_l.gpioPin =
          DefaultExperiment_P.GPIOWrite1_gpioPin;
      }

      if (DefaultExperiment_DW.obj_l.pinDirection !=
          DefaultExperiment_P.GPIOWrite1_pinDirection) {
        DefaultExperiment_DW.obj_l.pinDirection =
          DefaultExperiment_P.GPIOWrite1_pinDirection;
      }
      ...
      set_pin_direction(DefaultExperiment_DW.obj_l.gpioPin,
                        DefaultExperiment_DW.obj_l.pinDirection);
      change_gpio_value(DefaultExperiment_DW.obj_l.gpioPin,
                        DefaultExperiment_DW.Float_State);
      ...
      if (DefaultExperiment_DW.obj.SampleTime !=
          DefaultExperiment_P.GyroscopeAccelerometer_SampleTi) {
        DefaultExperiment_DW.obj.SampleTime =
          DefaultExperiment_P.GyroscopeAccelerometer_SampleTi;
      }

      if (DefaultExperiment_DW.obj.TunablePropsChanged) {
        DefaultExperiment_DW.obj.TunablePropsChanged = false;
      }

      obj = DefaultExperiment_DW.obj.SensorObject->Device;
      ...
      if (DefaultExperiment_DW.WhoAmI == 1.0) {
        // DataStoreWrite: '<S177>/Data Store Write9'
        DefaultExperiment_DW.RED_IMU_Measurements[0] = ARM_Path[0];
        DefaultExperiment_DW.RED_IMU_Measurements[1] = ARM_Path[1];
        DefaultExperiment_DW.RED_IMU_Measurements[2] = BLACK_Path_idx_2;

        // DataStoreWrite: '<S177>/Data Store Write10'
        DefaultExperiment_DW.BLACK_IMU_Measurements[0] = 0.0;
        DefaultExperiment_DW.BLACK_IMU_Measurements[1] = 0.0;
        DefaultExperiment_DW.BLACK_IMU_Measurements[2] = 0.0;

        // DataStoreWrite: '<S177>/Data Store Write11'
        DefaultExperiment_DW.BLUE_IMU_Measurements[0] = 0.0;
        DefaultExperiment_DW.BLUE_IMU_Measurements[1] = 0.0;
        DefaultExperiment_DW.BLUE_IMU_Measurements[2] = 0.0;
      } else if (DefaultExperiment_DW.WhoAmI == 2.0) {
        // DataStoreWrite: '<S177>/Data Store Write9'
        DefaultExperiment_DW.RED_IMU_Measurements[0] = 0.0;
        DefaultExperiment_DW.RED_IMU_Measurements[1] = 0.0;
        DefaultExperiment_DW.RED_IMU_Measurements[2] = 0.0;

        // DataStoreWrite: '<S177>/Data Store Write10'
        DefaultExperiment_DW.BLACK_IMU_Measurements[0] = ARM_Path[0];
        DefaultExperiment_DW.BLACK_IMU_Measurements[1] = ARM_Path[1];
        DefaultExperiment_DW.BLACK_IMU_Measurements[2] = BLACK_Path_idx_2;

        // DataStoreWrite: '<S177>/Data Store Write11'
        DefaultExperiment_DW.BLUE_IMU_Measurements[0] = 0.0;
        DefaultExperiment_DW.BLUE_IMU_Measurements[1] = 0.0;
        DefaultExperiment_DW.BLUE_IMU_Measurements[2] = 0.0;
      } else if (DefaultExperiment_DW.WhoAmI == 3.0) {
        // DataStoreWrite: '<S177>/Data Store Write9'
        DefaultExperiment_DW.RED_IMU_Measurements[0] = 0.0;
        DefaultExperiment_DW.RED_IMU_Measurements[1] = 0.0;
        DefaultExperiment_DW.RED_IMU_Measurements[2] = 0.0;
        ...
        // DataStoreWrite: '<S177>/Data Store Write11'
        DefaultExperiment_DW.BLUE_IMU_Measurements[0] = ARM_Path[0];
        DefaultExperiment_DW.BLUE_IMU_Measurements[1] = ARM_Path[1];
        DefaultExperiment_DW.BLUE_IMU_Measurements[2] = BLACK_Path_idx_2;
      } else {
        // DataStoreWrite: '<S177>/Data Store Write9'
        DefaultExperiment_DW.RED_IMU_Measurements[0] = 0.0;
        DefaultExperiment_DW.RED_IMU_Measurements[1] = 0.0;
    ...
    if ((DefaultExperiment_DW.WhoAmI == 1.0) && (DefaultExperiment_DW.isSim ==
      ...
      if (DefaultExperiment_DW.obj_d.SampleTime != DefaultExperiment_P.baseRate)
      {
        if (((!rtIsInf(DefaultExperiment_P.baseRate)) && (!rtIsNaN
              (DefaultExperiment_P.baseRate))) || rtIsInf
            (DefaultExperiment_P.baseRate)) {
          sampleTime = DefaultExperiment_P.baseRate;
        }

        DefaultExperiment_DW.obj_d.SampleTime = sampleTime;
      }
      ...
      DefaultExperiment_DW.ARM_Measured_States[3] = 0.0;
      DefaultExperiment_DW.ARM_Measured_States[4] = 0.0;
      DefaultExperiment_DW.ARM_Measured_States[5] = 0.0;
      read_dynamixel_position(&BLACK_Path_idx_0, &BLUE_Path_idx_0,
        &RED_Path_idx_0, &DefaultExperiment_DW.ARM_Measured_States[3],
        &DefaultExperiment_DW.ARM_Measured_States[4],
        &DefaultExperiment_DW.ARM_Measured_States[5],
        DefaultExperiment_DW.Delay_DSTATE_o,
        DefaultExperiment_DW.Delay1_DSTATE_cg,
        DefaultExperiment_DW.Delay2_DSTATE_h);
      ...
      DefaultExperiment_DW.Delay_DSTATE_o = BLACK_Path_idx_0;
      DefaultExperiment_DW.Delay1_DSTATE_cg = BLUE_Path_idx_0;
      DefaultExperiment_DW.Delay2_DSTATE_h = RED_Path_idx_0;
    ...
    rtPrevAction = DefaultExperiment_DW.Ifperforminganexperimentgrabthe;
    rtAction = -1;
    if (DefaultExperiment_DW.isSim == 0.0) {
      rtAction = 0;
    } else if (DefaultExperiment_DW.isSim == 1.0) {
      rtAction = 1;
    }

    DefaultExperiment_DW.Ifperforminganexperimentgrabthe = rtAction;
    if (rtPrevAction != rtAction) {
      rtsiSetBlockStateForSolverChangedAtMajorStep
        (&DefaultExperiment_M->solverInfo, true);
      if (rtPrevAction == 0) {
        // Disable for Enabled SubSystem: '<S196>/Enabled Subsystem'
        if (DefaultExperiment_DW.EnabledSubsystem_g.EnabledSubsystem_MODE) {
          Defa_EnabledSubsystem_c_Disable
            (&DefaultExperiment_DW.EnabledSubsystem_g);
        }

        // End of Disable for SubSystem: '<S196>/Enabled Subsystem'

        // Disable for Enabled SubSystem: '<S195>/Enabled Subsystem'
        if (DefaultExperiment_DW.EnabledSubsystem.EnabledSubsystem_MODE) {
          Defaul_EnabledSubsystem_Disable(&DefaultExperiment_DW.EnabledSubsystem);
        }

        // End of Disable for SubSystem: '<S195>/Enabled Subsystem'

        // Disable for Enabled SubSystem: '<S206>/Enabled Subsystem'
        if (DefaultExperiment_DW.EnabledSubsystem_d.EnabledSubsystem_MODE) {
          Defa_EnabledSubsystem_c_Disable
            (&DefaultExperiment_DW.EnabledSubsystem_d);
        }

        // End of Disable for SubSystem: '<S206>/Enabled Subsystem'

        // Disable for Enabled SubSystem: '<S205>/Enabled Subsystem'
        if (DefaultExperiment_DW.EnabledSubsystem_l.EnabledSubsystem_MODE) {
          Defaul_EnabledSubsystem_Disable
            (&DefaultExperiment_DW.EnabledSubsystem_l);
        }

        // End of Disable for SubSystem: '<S205>/Enabled Subsystem'

        // Disable for Enabled SubSystem: '<S216>/Enabled Subsystem'
        if (DefaultExperiment_DW.EnabledSubsystem_l1.EnabledSubsystem_MODE) {
          Defa_EnabledSubsystem_c_Disable
            (&DefaultExperiment_DW.EnabledSubsystem_l1);
        }

        // End of Disable for SubSystem: '<S216>/Enabled Subsystem'

        // Disable for Enabled SubSystem: '<S215>/Enabled Subsystem'
        if (DefaultExperiment_DW.EnabledSubsystem_k.EnabledSubsystem_MODE) {
          Defaul_EnabledSubsystem_Disable
            (&DefaultExperiment_DW.EnabledSubsystem_k);
        }
    ...
    switch (rtAction) {
     case 0:
      ...
      sErr = GetErrorBuffer
        (&DefaultExperiment_DW.ReceivePhaseSpaceData_NetworkLi[0U]);
      samplesRead = 19;
      LibOutputs_Network(&DefaultExperiment_DW.ReceivePhaseSpaceData_NetworkLi
                         [0U], &DefaultExperiment_B.ReceivePhaseSpaceData_o1[0U],
                         &samplesRead);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
      ...
      DefaultExperiment_B.ConvertBLAXfrommmtom =
        DefaultExperiment_P.ConvertBLAXfrommmtom_Gain *
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[4];

      // Gain: '<S183>/Convert BLAY from [mm] to [m]'
      BLACK_Path_idx_0 = DefaultExperiment_P.ConvertBLAYfrommmtom_Gain *
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[5];

      // Trigonometry: '<S197>/Sin'
      RED_Path_idx_0 = sin(DefaultExperiment_B.ReceivePhaseSpaceData_o1[6]);

      // Trigonometry: '<S197>/Cos'
      BLUE_Path_idx_0 = cos(DefaultExperiment_B.ReceivePhaseSpaceData_o1[6]);
      ...
      DefaultExperiment_DW.BLACK_Measured_States[2] = rt_atan2d_snf
        (RED_Path_idx_0, BLUE_Path_idx_0);
      DefaultExperiment_DW.BLACK_Measured_States[3] =
        DefaultExperiment_P.ConvertBLACKVXfrommmtom_Gain *
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[13];
      DefaultExperiment_DW.BLACK_Measured_States[4] =
        DefaultExperiment_P.ConvertBLACKVYfrommmtom_Gain *
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[14];

      // Sum: '<S194>/Subtract1' incorporates:
      //   Delay: '<S194>/Delay2'

      BLUE_Path_idx_0 = DefaultExperiment_B.ReceivePhaseSpaceData_o1[0] -
        DefaultExperiment_DW.Delay2_DSTATE;

      // Outputs for Enabled SubSystem: '<S194>/Enabled Subsystem3' incorporates:
      //   EnablePort: '<S198>/Enable'

      if (DefaultExperiment_B.ConvertBLAXfrommmtom -
          DefaultExperiment_DW.Delay1_DSTATE !=
          DefaultExperiment_P.Constant3_Value_e) {
        // SignalConversion generated from: '<S198>/y2-y1'
        DefaultExperiment_B.y2y1_ob = BLUE_Path_idx_0;
      }
      ...
      DefaultExperim_MATLABFunction_j(DefaultExperiment_B.y2y1_ob,
        DefaultExperiment_P.dataRate, &BLUE_Path_idx_0);

      // Sum: '<S196>/Subtract1' incorporates:
      //   Delay: '<S196>/Delay1'

      ARM_Path[2] = DefaultExperiment_B.ReceivePhaseSpaceData_o1[6] -
        DefaultExperiment_DW.Delay1_DSTATE_g[2];
      ...
      RelationalOperator_i[0] = (DefaultExperiment_B.ConvertBLAXfrommmtom -
        DefaultExperiment_DW.Delay1_DSTATE_g[0] !=
        DefaultExperiment_P.Constant3_Value_a);
      RelationalOperator_i[1] = (BLACK_Path_idx_0 -
        DefaultExperiment_DW.Delay1_DSTATE_g[1] !=
        DefaultExperiment_P.Constant3_Value_a);
      RelationalOperator_i[2] = (ARM_Path[2] !=
        DefaultExperiment_P.Constant3_Value_a);

      // Outputs for Enabled SubSystem: '<S196>/Enabled Subsystem'
      DefaultExper_EnabledSubsystem_g(RelationalOperator_i,
        DefaultExperiment_B.ConvertBLAXfrommmtom, BLACK_Path_idx_0,
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[6], BLUE_Path_idx_0,
        DefaultExperiment_B.dy_p, &DefaultExperiment_B.EnabledSubsystem_g,
        &DefaultExperiment_DW.EnabledSubsystem_g,
        &DefaultExperiment_P.EnabledSubsystem_g);
      ...
      RelationalOperator_i[0] = (DefaultExperiment_B.dy_p[0] -
        DefaultExperiment_DW.Delay1_DSTATE_b[0] !=
        DefaultExperiment_P.Constant3_Value_d);
      RelationalOperator_i[1] = (DefaultExperiment_B.dy_p[1] -
        DefaultExperiment_DW.Delay1_DSTATE_b[1] !=
        DefaultExperiment_P.Constant3_Value_d);
      RelationalOperator_i[2] = (DefaultExperiment_B.dy_p[2] -
        DefaultExperiment_DW.Delay1_DSTATE_b[2] !=
        DefaultExperiment_P.Constant3_Value_d);

      // Outputs for Enabled SubSystem: '<S195>/Enabled Subsystem'
      DefaultExperim_EnabledSubsystem(RelationalOperator_i,
        DefaultExperiment_B.dy_p, BLUE_Path_idx_0, DefaultExperiment_B.dy_g,
        &DefaultExperiment_B.EnabledSubsystem,
        &DefaultExperiment_DW.EnabledSubsystem,
        &DefaultExperiment_P.EnabledSubsystem);
      ...
      DefaultExperiment_DW.BLACK_Measured_States[0] =
        DefaultExperiment_B.ConvertBLAXfrommmtom;
      DefaultExperiment_DW.BLACK_Measured_States[1] = BLACK_Path_idx_0;
      DefaultExperiment_DW.BLACK_Measured_States[5] =
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[15];
      DefaultExperiment_DW.BLACK_Measured_States[6] = DefaultExperiment_B.dy_g[0];
      DefaultExperiment_DW.BLACK_Measured_States[7] = DefaultExperiment_B.dy_g[1];
      DefaultExperiment_DW.BLACK_Measured_States[8] = DefaultExperiment_B.dy_g[2];
      ...
      DefaultExperiment_DW.Delay1_DSTATE_g[0] =
        DefaultExperiment_B.ConvertBLAXfrommmtom;
      DefaultExperiment_DW.Delay1_DSTATE_g[1] = BLACK_Path_idx_0;
      DefaultExperiment_DW.Delay1_DSTATE_g[2] =
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[6];

      // Gain: '<S184>/Convert BLUX from [mm] to [m]'
      DefaultExperiment_B.ConvertBLUXfrommmtom =
        DefaultExperiment_P.ConvertBLUXfrommmtom_Gain *
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[7];

      // Gain: '<S184>/Convert BLUY from [mm] to [m]'
      BLACK_Path_idx_0 = DefaultExperiment_P.ConvertBLUYfrommmtom_Gain *
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[8];

      // Trigonometry: '<S207>/Sin'
      RED_Path_idx_0 = sin(DefaultExperiment_B.ReceivePhaseSpaceData_o1[9]);

      // Trigonometry: '<S207>/Cos'
      BLUE_Path_idx_0 = cos(DefaultExperiment_B.ReceivePhaseSpaceData_o1[9]);
      ...
      DefaultExperiment_DW.BLUE_Measured_States[2] = rt_atan2d_snf
        (RED_Path_idx_0, BLUE_Path_idx_0);
      DefaultExperiment_DW.BLUE_Measured_States[3] =
        DefaultExperiment_P.ConvertBLUEVXfrommmtom_Gain *
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[16];
      DefaultExperiment_DW.BLUE_Measured_States[4] =
        DefaultExperiment_P.ConvertBLUEVYfrommmtom_Gain *
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[17];

      // Sum: '<S204>/Subtract1' incorporates:
      //   Delay: '<S204>/Delay2'

      BLUE_Path_idx_0 = DefaultExperiment_B.ReceivePhaseSpaceData_o1[0] -
        DefaultExperiment_DW.Delay2_DSTATE_l;

      // Outputs for Enabled SubSystem: '<S204>/Enabled Subsystem3' incorporates:
      //   EnablePort: '<S208>/Enable'

      if (DefaultExperiment_B.ConvertBLUXfrommmtom -
          DefaultExperiment_DW.Delay1_DSTATE_l !=
          DefaultExperiment_P.Constant3_Value_o) {
        // SignalConversion generated from: '<S208>/y2-y1'
        DefaultExperiment_B.y2y1_o = BLUE_Path_idx_0;
      }
      ...
      DefaultExperim_MATLABFunction_j(DefaultExperiment_B.y2y1_o,
        DefaultExperiment_P.dataRate, &BLUE_Path_idx_0);

      // Sum: '<S206>/Subtract1' incorporates:
      //   Delay: '<S206>/Delay1'

      ARM_Path[2] = DefaultExperiment_B.ReceivePhaseSpaceData_o1[9] -
        DefaultExperiment_DW.Delay1_DSTATE_m[2];
      ...
      RelationalOperator_i[0] = (DefaultExperiment_B.ConvertBLUXfrommmtom -
        DefaultExperiment_DW.Delay1_DSTATE_m[0] !=
        DefaultExperiment_P.Constant3_Value_c);
      RelationalOperator_i[1] = (BLACK_Path_idx_0 -
        DefaultExperiment_DW.Delay1_DSTATE_m[1] !=
        DefaultExperiment_P.Constant3_Value_c);
      RelationalOperator_i[2] = (ARM_Path[2] !=
        DefaultExperiment_P.Constant3_Value_c);
      ...
      DefaultExper_EnabledSubsystem_g(RelationalOperator_i,
        DefaultExperiment_B.ConvertBLUXfrommmtom, BLACK_Path_idx_0,
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[9], BLUE_Path_idx_0,
        DefaultExperiment_B.dy_c, &DefaultExperiment_B.EnabledSubsystem_d,
        &DefaultExperiment_DW.EnabledSubsystem_d,
        &DefaultExperiment_P.EnabledSubsystem_d);
      ...
      RelationalOperator_i[0] = (DefaultExperiment_B.dy_c[0] -
        DefaultExperiment_DW.Delay1_DSTATE_lv[0] !=
        DefaultExperiment_P.Constant3_Value_k);
      RelationalOperator_i[1] = (DefaultExperiment_B.dy_c[1] -
        DefaultExperiment_DW.Delay1_DSTATE_lv[1] !=
        DefaultExperiment_P.Constant3_Value_k);
      RelationalOperator_i[2] = (DefaultExperiment_B.dy_c[2] -
        DefaultExperiment_DW.Delay1_DSTATE_lv[2] !=
        DefaultExperiment_P.Constant3_Value_k);

      // Outputs for Enabled SubSystem: '<S205>/Enabled Subsystem'
      DefaultExperim_EnabledSubsystem(RelationalOperator_i,
        DefaultExperiment_B.dy_c, BLUE_Path_idx_0, DefaultExperiment_B.dy_d,
        &DefaultExperiment_B.EnabledSubsystem_l,
        &DefaultExperiment_DW.EnabledSubsystem_l,
        &DefaultExperiment_P.EnabledSubsystem_l);
      ...
      DefaultExperiment_DW.BLUE_Measured_States[0] =
        DefaultExperiment_B.ConvertBLUXfrommmtom;
      DefaultExperiment_DW.BLUE_Measured_States[1] = BLACK_Path_idx_0;
      DefaultExperiment_DW.BLUE_Measured_States[5] =
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[18];
      DefaultExperiment_DW.BLUE_Measured_States[6] = DefaultExperiment_B.dy_d[0];
      DefaultExperiment_DW.BLUE_Measured_States[7] = DefaultExperiment_B.dy_d[1];
      DefaultExperiment_DW.BLUE_Measured_States[8] = DefaultExperiment_B.dy_d[2];
      ...
      DefaultExperiment_DW.Delay1_DSTATE_m[0] =
        DefaultExperiment_B.ConvertBLUXfrommmtom;
      DefaultExperiment_DW.Delay1_DSTATE_m[1] = BLACK_Path_idx_0;
      DefaultExperiment_DW.Delay1_DSTATE_m[2] =
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[9];

      // Gain: '<S185>/Convert REDX from [mm] to [m]'
      DefaultExperiment_B.ConvertREDXfrommmtom =
        DefaultExperiment_P.ConvertREDXfrommmtom_Gain *
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[1];

      // Gain: '<S185>/Convert REDY from [mm] to [m]'
      BLACK_Path_idx_0 = DefaultExperiment_P.ConvertREDYfrommmtom_Gain *
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[2];

      // Trigonometry: '<S217>/Sin'
      RED_Path_idx_0 = sin(DefaultExperiment_B.ReceivePhaseSpaceData_o1[3]);

      // Trigonometry: '<S217>/Cos'
      BLUE_Path_idx_0 = cos(DefaultExperiment_B.ReceivePhaseSpaceData_o1[3]);
      ...
      DefaultExperiment_DW.RED_Measured_States[2] = rt_atan2d_snf(RED_Path_idx_0,
        BLUE_Path_idx_0);
      DefaultExperiment_DW.RED_Measured_States[3] =
        DefaultExperiment_P.ConvertREDVXfrommmtom_Gain *
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[10];
      DefaultExperiment_DW.RED_Measured_States[4] =
        DefaultExperiment_P.ConvertREDVYfrommmtom_Gain *
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[11];

      // Sum: '<S214>/Subtract1' incorporates:
      //   Delay: '<S214>/Delay2'

      BLUE_Path_idx_0 = DefaultExperiment_B.ReceivePhaseSpaceData_o1[0] -
        DefaultExperiment_DW.Delay2_DSTATE_l0;

      // Outputs for Enabled SubSystem: '<S214>/Enabled Subsystem3' incorporates:
      //   EnablePort: '<S218>/Enable'

      if (DefaultExperiment_B.ConvertREDXfrommmtom -
          DefaultExperiment_DW.Delay1_DSTATE_ld !=
          DefaultExperiment_P.Constant3_Value_f) {
        // SignalConversion generated from: '<S218>/y2-y1'
        DefaultExperiment_B.y2y1 = BLUE_Path_idx_0;
      }
      ...
      DefaultExperim_MATLABFunction_j(DefaultExperiment_B.y2y1,
        DefaultExperiment_P.dataRate, &BLUE_Path_idx_0);

      // Sum: '<S216>/Subtract1' incorporates:
      //   Delay: '<S216>/Delay1'

      ARM_Path[2] = DefaultExperiment_B.ReceivePhaseSpaceData_o1[3] -
        DefaultExperiment_DW.Delay1_DSTATE_c[2];
      ...
      RelationalOperator_i[0] = (DefaultExperiment_B.ConvertREDXfrommmtom -
        DefaultExperiment_DW.Delay1_DSTATE_c[0] !=
        DefaultExperiment_P.Constant3_Value_dh);
      RelationalOperator_i[1] = (BLACK_Path_idx_0 -
        DefaultExperiment_DW.Delay1_DSTATE_c[1] !=
        DefaultExperiment_P.Constant3_Value_dh);
      RelationalOperator_i[2] = (ARM_Path[2] !=
        DefaultExperiment_P.Constant3_Value_dh);
      ...
      DefaultExper_EnabledSubsystem_g(RelationalOperator_i,
        DefaultExperiment_B.ConvertREDXfrommmtom, BLACK_Path_idx_0,
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[3], BLUE_Path_idx_0,
        DefaultExperiment_B.dy, &DefaultExperiment_B.EnabledSubsystem_l1,
        &DefaultExperiment_DW.EnabledSubsystem_l1,
        &DefaultExperiment_P.EnabledSubsystem_l1);
      ...
      RelationalOperator_i[0] = (DefaultExperiment_B.dy[0] -
        DefaultExperiment_DW.Delay1_DSTATE_cq[0] !=
        DefaultExperiment_P.Constant3_Value_dz);
      RelationalOperator_i[1] = (DefaultExperiment_B.dy[1] -
        DefaultExperiment_DW.Delay1_DSTATE_cq[1] !=
        DefaultExperiment_P.Constant3_Value_dz);
      RelationalOperator_i[2] = (DefaultExperiment_B.dy[2] -
        DefaultExperiment_DW.Delay1_DSTATE_cq[2] !=
        DefaultExperiment_P.Constant3_Value_dz);

      // Outputs for Enabled SubSystem: '<S215>/Enabled Subsystem'
      DefaultExperim_EnabledSubsystem(RelationalOperator_i,
        DefaultExperiment_B.dy, BLUE_Path_idx_0, DefaultExperiment_B.dy_h,
        &DefaultExperiment_B.EnabledSubsystem_k,
        &DefaultExperiment_DW.EnabledSubsystem_k,
        &DefaultExperiment_P.EnabledSubsystem_k);
      ...
      DefaultExperiment_DW.RED_Measured_States[0] =
        DefaultExperiment_B.ConvertREDXfrommmtom;
      DefaultExperiment_DW.RED_Measured_States[1] = BLACK_Path_idx_0;
      DefaultExperiment_DW.RED_Measured_States[5] =
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[12];
      DefaultExperiment_DW.RED_Measured_States[6] = DefaultExperiment_B.dy_h[0];
      DefaultExperiment_DW.RED_Measured_States[7] = DefaultExperiment_B.dy_h[1];
      DefaultExperiment_DW.RED_Measured_States[8] = DefaultExperiment_B.dy_h[2];

      // S-Function (sdspFromNetwork): '<S186>/UDP Receive (RED Clock)'
      sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPReceiveREDClock_NetworkLib
                            [0U]);
      samplesRead_1 = 1;
      LibOutputs_Network(&DefaultExperiment_DW.UDPReceiveREDClock_NetworkLib[0U],
                         &DefaultExperiment_B.UDPReceiveREDClock_o1,
                         &samplesRead_1);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
      ...
      sErr = GetErrorBuffer
        (&DefaultExperiment_DW.UDPReceiveBLACKClock_NetworkLib[0U]);
      samplesRead_2 = 1;
      LibOutputs_Network(&DefaultExperiment_DW.UDPReceiveBLACKClock_NetworkLib
                         [0U], &DefaultExperiment_B.UDPReceiveBLACKClock_o1,
                         &samplesRead_2);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
      ...
      sErr = GetErrorBuffer
        (&DefaultExperiment_DW.UDPReceiveBLUEClock_NetworkLib[0U]);
      samplesRead_3 = 1;
      LibOutputs_Network(&DefaultExperiment_DW.UDPReceiveBLUEClock_NetworkLib[0U],
                         &DefaultExperiment_B.UDPReceiveBLUEClock_o1,
                         &samplesRead_3);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
      ...
      ARM_Path[0] = DefaultExperiment_B.UDPReceiveREDClock_o1;
      ARM_Path[1] = DefaultExperiment_B.UDPReceiveBLACKClock_o1;
      ARM_Path[2] = DefaultExperiment_B.UDPReceiveBLUEClock_o1;
      ...
      i = 0;
      if (DefaultExperiment_P.platformSelection == 1.0) {
        i = (DefaultExperiment_B.UDPReceiveREDClock_o1 != 0.0);
      } else if (DefaultExperiment_P.platformSelection == 2.0) {
        i = (DefaultExperiment_B.UDPReceiveBLACKClock_o1 != 0.0);
      } else if (DefaultExperiment_P.platformSelection == 3.0) {
        i = ((DefaultExperiment_B.UDPReceiveREDClock_o1 != 0.0) &&
             (DefaultExperiment_B.UDPReceiveBLACKClock_o1 != 0.0));
      } else if (DefaultExperiment_P.platformSelection == 4.0) {
        i = ((DefaultExperiment_B.UDPReceiveREDClock_o1 != 1.0) &&
             (DefaultExperiment_B.UDPReceiveBLACKClock_o1 != 1.0));
      } else if (DefaultExperiment_P.platformSelection == 5.0) {
        i = (DefaultExperiment_B.UDPReceiveREDClock_o1 != 1.0);
      } else if (DefaultExperiment_P.platformSelection == 6.0) {
        i = (DefaultExperiment_B.UDPReceiveBLUEClock_o1 != 1.0);
      } else if (DefaultExperiment_P.platformSelection == 7.0) {
        i = ((DefaultExperiment_B.UDPReceiveREDClock_o1 != 1.0) &&
             (DefaultExperiment_B.UDPReceiveBLUEClock_o1 != 1.0));
      } else if (DefaultExperiment_P.platformSelection == 8.0) {
        i = ((DefaultExperiment_B.UDPReceiveREDClock_o1 != 1.0) &&
             (DefaultExperiment_B.UDPReceiveBLACKClock_o1 != 1.0) &&
             (DefaultExperiment_B.UDPReceiveBLUEClock_o1 != 1.0));
      } else if (DefaultExperiment_P.platformSelection == 9.0) {
        i = ((DefaultExperiment_B.UDPReceiveBLACKClock_o1 != 1.0) &&
             (DefaultExperiment_B.UDPReceiveBLUEClock_o1 != 1.0));
      } else if (DefaultExperiment_P.platformSelection == 10.0) {
        i = ((DefaultExperiment_B.UDPReceiveREDClock_o1 != 1.0) &&
             (DefaultExperiment_B.UDPReceiveBLUEClock_o1 != 1.0));
      } else if (DefaultExperiment_P.platformSelection == 11.0) {
        i = ((DefaultExperiment_B.UDPReceiveREDClock_o1 != 1.0) &&
             (DefaultExperiment_B.UDPReceiveBLACKClock_o1 != 1.0) &&
             (DefaultExperiment_B.UDPReceiveBLUEClock_o1 != 1.0));
      }
      ...
      if (i == DefaultExperiment_P.Constant_Value) {
        // SignalConversion generated from: '<S187>/In1'
        DefaultExperiment_B.In1_g20 = RED_Path_idx_0;
      }
      ...
      DefaultExperiment_DW.Univ_Time = DefaultExperiment_B.In1_g20;
      ...
      DefaultExperiment_DW.Delay1_DSTATE_c[0] =
        DefaultExperiment_B.ConvertREDXfrommmtom;
      DefaultExperiment_DW.Delay1_DSTATE_c[1] = BLACK_Path_idx_0;
      DefaultExperiment_DW.Delay1_DSTATE_c[2] =
        DefaultExperiment_B.ReceivePhaseSpaceData_o1[3];
      ...
      if ((DefaultExperiment_DW.WhoAmI == 2.0) && (DefaultExperiment_DW.isSim ==
           0.0)) {
        DefaultExperiment_DW.ThisIFblockdetermineswhether_ch = 0;
      }
      ...
      if ((DefaultExperiment_DW.WhoAmI == 3.0) && (DefaultExperiment_DW.isSim ==
           0.0)) {
        DefaultExperiment_DW.ThisIFblockdetermineswhether_cs = 0;
      }
      ...
      if ((DefaultExperiment_DW.WhoAmI == 1.0) && (DefaultExperiment_DW.isSim ==
           0.0)) {
        DefaultExperiment_DW.ThisIFblockdetermineswhethero_d = 0;
      }
     ...
     case 1:
      ...
      DefaultExperiment_DW.Univ_Time = DefaultExperiment_M->Timing.t[0];
    ...
    if (DefaultExperiment_DW.isSim == 0.0) {
      ...
      if (DefaultExperiment_DW.obj_dk.SampleTime != DefaultExperiment_P.baseRate)
      {
        if (((!rtIsInf(DefaultExperiment_P.baseRate)) && (!rtIsNaN
              (DefaultExperiment_P.baseRate))) || rtIsInf
            (DefaultExperiment_P.baseRate)) {
          sampleTime_0 = DefaultExperiment_P.baseRate;
        }

        DefaultExperiment_DW.obj_dk.SampleTime = sampleTime_0;
      }

      //         %% Define output properties
      //  Call C-function implementing device output
      DefaultExperiment_DW.WhoAmI = WhoAmI();
      ...
      sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPReceive_NetworkLib[0U]);
      samplesRead_0 = 4;
      LibOutputs_Network(&DefaultExperiment_DW.UDPReceive_NetworkLib[0U],
                         &DefaultExperiment_B.UDPReceive_o1[0U], &samplesRead_0);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
      }
      ...
      DefaultExperiment_DW.VIS_Measured_States[0] =
        DefaultExperiment_B.UDPReceive_o1[0];
      DefaultExperiment_DW.VIS_Measured_States[1] =
        DefaultExperiment_B.UDPReceive_o1[1];
      DefaultExperiment_DW.VIS_Measured_States[2] =
        DefaultExperiment_B.UDPReceive_o1[2];

      // DataTypeConversion: '<S225>/Cast To Double3' incorporates:
      //   DataStoreWrite: '<S225>/Data Store Write1'

      DefaultExperiment_DW.VIS_Confidence = DefaultExperiment_B.UDPReceive_o1[3];
    ...
    if ((DefaultExperiment_DW.WhoAmI == 1.0) && (DefaultExperiment_DW.isSim ==
      ...
      if (DefaultExperiment_DW.obj_n.POSITION_P_GAIN !=
          DefaultExperiment_P.ControlDynamixelActuatorsineith) {
        DefaultExperiment_DW.obj_n.POSITION_P_GAIN =
          DefaultExperiment_P.ControlDynamixelActuatorsineith;
      }

      if (DefaultExperiment_DW.obj_n.POSITION_I_GAIN !=
          DefaultExperiment_P.ControlDynamixelActuatorsinei_b) {
        DefaultExperiment_DW.obj_n.POSITION_I_GAIN =
          DefaultExperiment_P.ControlDynamixelActuatorsinei_b;
      }

      if (DefaultExperiment_DW.obj_n.POSITION_D_GAIN !=
          DefaultExperiment_P.ControlDynamixelActuatorsinei_h) {
        DefaultExperiment_DW.obj_n.POSITION_D_GAIN =
          DefaultExperiment_P.ControlDynamixelActuatorsinei_h;
      }

      if (DefaultExperiment_DW.obj_n.MAX_POSITION !=
          DefaultExperiment_P.ControlDynamixelActuatorsinei_j) {
        DefaultExperiment_DW.obj_n.MAX_POSITION =
          DefaultExperiment_P.ControlDynamixelActuatorsinei_j;
      }

      if (DefaultExperiment_DW.obj_n.MIN_POSITION !=
          DefaultExperiment_P.ControlDynamixelActuatorsinei_m) {
        DefaultExperiment_DW.obj_n.MIN_POSITION =
          DefaultExperiment_P.ControlDynamixelActuatorsinei_m;
      }

      if (DefaultExperiment_DW.obj_n.MOVE_TIME !=
          DefaultExperiment_P.ControlDynamixelActuatorsine_hy) {
        DefaultExperiment_DW.obj_n.MOVE_TIME =
          DefaultExperiment_P.ControlDynamixelActuatorsine_hy;
      }

      if (DefaultExperiment_DW.obj_n.CURRENT_LIMIT !=
          DefaultExperiment_P.ControlDynamixelActuatorsinei_i) {
        DefaultExperiment_DW.obj_n.CURRENT_LIMIT =
          DefaultExperiment_P.ControlDynamixelActuatorsinei_i;
      }

      if (DefaultExperiment_DW.obj_n.SPEED_P_GAIN !=
          DefaultExperiment_P.ControlDynamixelActuatorsinei_g) {
        DefaultExperiment_DW.obj_n.SPEED_P_GAIN =
          DefaultExperiment_P.ControlDynamixelActuatorsinei_g;
      }

      if (DefaultExperiment_DW.obj_n.SPEED_I_GAIN !=
          DefaultExperiment_P.ControlDynamixelActuatorsine_g3) {
        DefaultExperiment_DW.obj_n.SPEED_I_GAIN =
          DefaultExperiment_P.ControlDynamixelActuatorsine_g3;
      }

      if (DefaultExperiment_DW.obj_n.VELOCITY_LIMIT !=
          DefaultExperiment_P.ControlDynamixelActuatorsine_bf) {
        DefaultExperiment_DW.obj_n.VELOCITY_LIMIT =
          DefaultExperiment_P.ControlDynamixelActuatorsine_bf;
      }

      if (DefaultExperiment_DW.obj_n.ACCELERATION_TIME !=
          DefaultExperiment_P.ControlDynamixelActuatorsinei_l) {
        DefaultExperiment_DW.obj_n.ACCELERATION_TIME =
          DefaultExperiment_P.ControlDynamixelActuatorsinei_l;
      }

      if (DefaultExperiment_DW.obj_n.SampleTime != DefaultExperiment_P.baseRate)
      {
        if (((!rtIsInf(DefaultExperiment_P.baseRate)) && (!rtIsNaN
              (DefaultExperiment_P.baseRate))) || rtIsInf
            (DefaultExperiment_P.baseRate)) {
          sampleTime_1 = DefaultExperiment_P.baseRate;
        }

        DefaultExperiment_DW.obj_n.SampleTime = sampleTime_1;
      }
      ...
      //  motor
      dynamixel_controller(DefaultExperiment_DW.ARM_Control_Mode,
                           DefaultExperiment_DW.obj_n.POSITION_P_GAIN,
                           DefaultExperiment_DW.obj_n.POSITION_I_GAIN,
                           DefaultExperiment_DW.obj_n.POSITION_D_GAIN,
                           DefaultExperiment_DW.obj_n.MAX_POSITION,
                           DefaultExperiment_DW.obj_n.MIN_POSITION,
                           DefaultExperiment_DW.obj_n.MOVE_TIME, rtb_Merge6[0],
                           rtb_Merge6[1], rtb_Merge6[2],
                           DefaultExperiment_DW.obj_n.CURRENT_LIMIT, rtb_Merge6
                           [0], rtb_Merge6[1], rtb_Merge6[2],
                           DefaultExperiment_DW.obj_n.SPEED_P_GAIN,
                           DefaultExperiment_DW.obj_n.SPEED_I_GAIN,
                           DefaultExperiment_DW.obj_n.VELOCITY_LIMIT,
                           rtb_Merge6[0], rtb_Merge6[1], rtb_Merge6[2],
                           DefaultExperiment_DW.obj_n.ACCELERATION_TIME);
    ...
    if (DefaultExperiment_DW.isSim == 0.0) {
      ...
      DefaultExperiment_B.TmpSignalConversionAtUDPSendI_o[0] =
        DefaultExperiment_DW.Univ_Time;
      for (i = 0; i < 9; i++) {
        DefaultExperiment_B.TmpSignalConversionAtUDPSendI_o[i + 1] =
          DefaultExperiment_DW.RED_Measured_States[i];
        DefaultExperiment_B.TmpSignalConversionAtUDPSendI_o[i + 10] =
          DefaultExperiment_DW.BLACK_Measured_States[i];
        DefaultExperiment_B.TmpSignalConversionAtUDPSendI_o[i + 19] =
          DefaultExperiment_DW.BLUE_Measured_States[i];
      }

      // Update for S-Function (sdspToNetwork): '<S227>/UDP Send' incorporates:
      //   SignalConversion generated from: '<S227>/UDP Send'
      //
      sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPSend_NetworkLib_m[0U]);
      LibUpdate_Network(&DefaultExperiment_DW.UDPSend_NetworkLib_m[0U],
                        &DefaultExperiment_B.TmpSignalConversionAtUDPSendI_o[0U],
                        28);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
    ...
    DefaultExperiment_DW.ThisIFblockdetermineswhetherorn = -1;
    if ((DefaultExperiment_DW.WhoAmI == 2.0) && (DefaultExperiment_DW.isSim ==
         0.0)) {
      DefaultExperiment_DW.ThisIFblockdetermineswhetherorn = 0;

      // Outputs for IfAction SubSystem: '<S17>/Change BLACK Behavior' incorporates:
      //   ActionPort: '<S267>/Action Port'

      DefaultEx_ChangeBLACKBehavior_i(DefaultExperiment_M,
        &DefaultExperiment_B.ChangeBLACKBehavior_i);
    ...
    DefaultExperiment_DW.ThisIFblockdetermineswhethero_b = -1;
    if ((DefaultExperiment_DW.WhoAmI == 3.0) && (DefaultExperiment_DW.isSim ==
         0.0)) {
      DefaultExperiment_DW.ThisIFblockdetermineswhethero_b = 0;

      // Outputs for IfAction SubSystem: '<S17>/Change BLUE Behavior' incorporates:
      //   ActionPort: '<S268>/Action Port'

      DefaultEx_ChangeBLACKBehavior_i(DefaultExperiment_M,
        &DefaultExperiment_B.ChangeBLUEBehavior_e);
    ...
    DefaultExperiment_DW.ThisIFblockdetermineswhethero_c = -1;
    if ((DefaultExperiment_DW.WhoAmI == 1.0) && (DefaultExperiment_DW.isSim ==
         0.0)) {
      DefaultExperiment_DW.ThisIFblockdetermineswhethero_c = 0;

      // Outputs for IfAction SubSystem: '<S17>/Change RED Behavior' incorporates:
      //   ActionPort: '<S269>/Action Port'

      DefaultEx_ChangeBLACKBehavior_i(DefaultExperiment_M,
        &DefaultExperiment_B.ChangeREDBehavior_h);
...

  {
    ...
    sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPSend_NetworkLib[0U]);
    LibUpdate_Network(&DefaultExperiment_DW.UDPSend_NetworkLib[0U],
                      &DefaultExperiment_B.TmpSignalConversionAtUDPSendInp[0U],
                      10);
    if (*sErr != 0) {
      DefaultExperiment_M->setErrorStatus(sErr);
      DefaultExperiment_M->setStopRequested(1);
    ...
    if (DefaultExperiment_DW.Ifperforminganexperimentgrabthe == 0) {
      ...
      Defau_EnabledSubsystem_m_Update(&DefaultExperiment_B.EnabledSubsystem_g,
        &DefaultExperiment_DW.EnabledSubsystem_g);

      // End of Update for SubSystem: '<S196>/Enabled Subsystem'

      // Update for Delay: '<S195>/Delay1'
      DefaultExperiment_DW.Delay1_DSTATE_b[0] = DefaultExperiment_B.dy_p[0];
      DefaultExperiment_DW.Delay1_DSTATE_b[1] = DefaultExperiment_B.dy_p[1];
      DefaultExperiment_DW.Delay1_DSTATE_b[2] = DefaultExperiment_B.dy_p[2];

      // Update for Enabled SubSystem: '<S195>/Enabled Subsystem'
      Default_EnabledSubsystem_Update(&DefaultExperiment_B.EnabledSubsystem,
        &DefaultExperiment_DW.EnabledSubsystem);
      ...
      Defau_EnabledSubsystem_m_Update(&DefaultExperiment_B.EnabledSubsystem_d,
        &DefaultExperiment_DW.EnabledSubsystem_d);

      // End of Update for SubSystem: '<S206>/Enabled Subsystem'

      // Update for Delay: '<S205>/Delay1'
      DefaultExperiment_DW.Delay1_DSTATE_lv[0] = DefaultExperiment_B.dy_c[0];
      DefaultExperiment_DW.Delay1_DSTATE_lv[1] = DefaultExperiment_B.dy_c[1];
      DefaultExperiment_DW.Delay1_DSTATE_lv[2] = DefaultExperiment_B.dy_c[2];

      // Update for Enabled SubSystem: '<S205>/Enabled Subsystem'
      Default_EnabledSubsystem_Update(&DefaultExperiment_B.EnabledSubsystem_l,
        &DefaultExperiment_DW.EnabledSubsystem_l);
      ...
      Defau_EnabledSubsystem_m_Update(&DefaultExperiment_B.EnabledSubsystem_l1,
        &DefaultExperiment_DW.EnabledSubsystem_l1);

      // End of Update for SubSystem: '<S216>/Enabled Subsystem'

      // Update for Delay: '<S215>/Delay1'
      DefaultExperiment_DW.Delay1_DSTATE_cq[0] = DefaultExperiment_B.dy[0];
      DefaultExperiment_DW.Delay1_DSTATE_cq[1] = DefaultExperiment_B.dy[1];
      DefaultExperiment_DW.Delay1_DSTATE_cq[2] = DefaultExperiment_B.dy[2];

      // Update for Enabled SubSystem: '<S215>/Enabled Subsystem'
      Default_EnabledSubsystem_Update(&DefaultExperiment_B.EnabledSubsystem_k,
        &DefaultExperiment_DW.EnabledSubsystem_k);
      ...
      if (DefaultExperiment_DW.ThisIFblockdetermineswhether_ch == 0) {
        // Update for IfAction SubSystem: '<S190>/Change BLACK Behavior' incorporates:
        //   ActionPort: '<S191>/Action Port'

        De_ChangeBLACKBehavior_d_Update(DefaultExperiment_M,
          DefaultExperiment_B.In1_g20,
          &DefaultExperiment_DW.ChangeBLACKBehavior_e);
      ...
      if (DefaultExperiment_DW.ThisIFblockdetermineswhether_cs == 0) {
        // Update for IfAction SubSystem: '<S190>/Change BLUE Behavior' incorporates:
        //   ActionPort: '<S192>/Action Port'

        De_ChangeBLACKBehavior_d_Update(DefaultExperiment_M,
          DefaultExperiment_B.In1_g20,
          &DefaultExperiment_DW.ChangeBLUEBehavior_f);
      ...
      if (DefaultExperiment_DW.ThisIFblockdetermineswhethero_d == 0) {
        // Update for IfAction SubSystem: '<S190>/Change RED Behavior' incorporates:
        //   ActionPort: '<S193>/Action Port'

        De_ChangeBLACKBehavior_d_Update(DefaultExperiment_M,
          DefaultExperiment_B.In1_g20, &DefaultExperiment_DW.ChangeREDBehavior_d);
    ...
    if (DefaultExperiment_DW.ThisIFblockdetermineswhetherorn == 0) {
      // Update for IfAction SubSystem: '<S17>/Change BLACK Behavior' incorporates:
      //   ActionPort: '<S267>/Action Port'

      De_ChangeBLACKBehavior_f_Update(DefaultExperiment_M,
        &DefaultExperiment_B.ChangeBLACKBehavior_i,
        &DefaultExperiment_DW.ChangeBLACKBehavior_i);
    ...
    if (DefaultExperiment_DW.ThisIFblockdetermineswhethero_b == 0) {
      // Update for IfAction SubSystem: '<S17>/Change BLUE Behavior' incorporates:
      //   ActionPort: '<S268>/Action Port'

      De_ChangeBLACKBehavior_f_Update(DefaultExperiment_M,
        &DefaultExperiment_B.ChangeBLUEBehavior_e,
        &DefaultExperiment_DW.ChangeBLUEBehavior_e);
    ...
    if (DefaultExperiment_DW.ThisIFblockdetermineswhethero_c == 0) {
      // Update for IfAction SubSystem: '<S17>/Change RED Behavior' incorporates:
      //   ActionPort: '<S269>/Action Port'

      De_ChangeBLACKBehavior_f_Update(DefaultExperiment_M,
        &DefaultExperiment_B.ChangeREDBehavior_h,
        &DefaultExperiment_DW.ChangeREDBehavior_h);
  ...
  DefaultExperiment_M->Timing.t[0] =
    ((time_T)(++DefaultExperiment_M->Timing.clockTick0)) *
    DefaultExperiment_M->Timing.stepSize0;

  {
    ...
    DefaultExperiment_M->Timing.clockTick1++;
  }
}

// Model initialize function
void DefaultExperiment_initialize(void)
{
  // Registration code
  ...
  {
    // Setup solver object
    rtsiSetSimTimeStepPtr(&DefaultExperiment_M->solverInfo,
                          &DefaultExperiment_M->Timing.simTimeStep);
    rtsiSetTPtr(&DefaultExperiment_M->solverInfo,
                DefaultExperiment_M->getTPtrPtr());
    rtsiSetStepSizePtr(&DefaultExperiment_M->solverInfo,
                       &DefaultExperiment_M->Timing.stepSize0);
    rtsiSetErrorStatusPtr(&DefaultExperiment_M->solverInfo,
                          DefaultExperiment_M->getErrorStatusPtr());
    rtsiSetRTModelPtr(&DefaultExperiment_M->solverInfo, DefaultExperiment_M);
  }

  rtsiSetSimTimeStep(&DefaultExperiment_M->solverInfo, MAJOR_TIME_STEP);
  rtsiSetIsMinorTimeStepWithModeChange(&DefaultExperiment_M->solverInfo, false);
  rtsiSetIsContModeFrozen(&DefaultExperiment_M->solverInfo, false);
  rtsiSetSolverName(&DefaultExperiment_M->solverInfo,"FixedStepDiscrete");
  DefaultExperiment_M->setTPtr(&DefaultExperiment_M->Timing.tArray[0]);
  DefaultExperiment_M->Timing.stepSize0 = 0.05;

  {
    ...
    sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPSend_NetworkLib[0U]);
    CreateUDPInterface(&DefaultExperiment_DW.UDPSend_NetworkLib[0U]);
    if (*sErr == 0) {
      LibCreate_Network(&DefaultExperiment_DW.UDPSend_NetworkLib[0U], 1,
                        "0.0.0.0", -1, "127.0.0.1",
                        DefaultExperiment_P.UDPSend_Port_h, 8192, 8, 0);
    }

    if (*sErr == 0) {
      LibStart(&DefaultExperiment_DW.UDPSend_NetworkLib[0U]);
    }

    if (*sErr != 0) {
      DestroyUDPInterface(&DefaultExperiment_DW.UDPSend_NetworkLib[0U]);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
      }
    ...
    DefaultExperiment_DW.Ifperforminganexperimentgrabthe = -1;
    ...
    DefaultExperiment_DW.BLUE_Control_Law_Enabler =
      DefaultExperiment_P.RED_Tz1_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Tz15'
    DefaultExperiment_DW.ARM_Control_Mode =
      DefaultExperiment_P.RED_Tz15_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Tz20'
    DefaultExperiment_DW.RED_Control_Law_Enabler =
      DefaultExperiment_P.RED_Tz20_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Tz3'
    strncpy(&DefaultExperiment_DW.RED_Logger[0],
            &DefaultExperiment_P.RED_Tz3_InitialValue[0], 255U);
    DefaultExperiment_DW.RED_Logger[255] = '\x00';

    // Start for DataStoreMemory: '<Root>/RED_Tz38'
    DefaultExperiment_DW.ARM_Control_Law_Enabler =
      DefaultExperiment_P.RED_Tz38_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Tz4'
    strncpy(&DefaultExperiment_DW.BLACK_Logger[0],
            &DefaultExperiment_P.RED_Tz4_InitialValue[0], 255U);
    DefaultExperiment_DW.BLACK_Logger[255] = '\x00';

    // Start for DataStoreMemory: '<Root>/RED_Tz5'
    strncpy(&DefaultExperiment_DW.BLUE_Logger[0],
            &DefaultExperiment_P.RED_Tz5_InitialValue[0], 255U);
    DefaultExperiment_DW.BLUE_Logger[255] = '\x00';

    // Start for DataStoreMemory: '<Root>/RED_Tz7'
    DefaultExperiment_DW.Float_State = DefaultExperiment_P.RED_Tz7_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Tz8'
    DefaultExperiment_DW.BLACK_Control_Law_Enabler =
      DefaultExperiment_P.RED_Tz8_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time'
    DefaultExperiment_DW.Univ_Time =
      DefaultExperiment_P.Universal_Time_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time10'
    memcpy(&DefaultExperiment_DW.BLACK_Measured_States[0],
           &DefaultExperiment_P.Universal_Time10_InitialValue[0], 9U * sizeof
           (real_T));

    // Start for DataStoreMemory: '<Root>/Universal_Time19'
    DefaultExperiment_DW.WhoAmI =
      DefaultExperiment_P.Universal_Time19_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time20'
    DefaultExperiment_DW.isSim =
      DefaultExperiment_P.Universal_Time20_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time13'
    DefaultExperiment_DW.BLUE_Desired_States[0] =
      DefaultExperiment_P.Universal_Time13_InitialValue[0];

    // Start for DataStoreMemory: '<Root>/Universal_Time15'
    DefaultExperiment_DW.BLACK_Saturated_Controls[0] =
      DefaultExperiment_P.Universal_Time15_InitialValue[0];

    // Start for DataStoreMemory: '<Root>/Universal_Time22'
    DefaultExperiment_DW.VIS_Measured_States[0] =
      DefaultExperiment_P.Universal_Time22_InitialValue[0];

    // Start for DataStoreMemory: '<Root>/Universal_Time13'
    DefaultExperiment_DW.BLUE_Desired_States[1] =
      DefaultExperiment_P.Universal_Time13_InitialValue[1];

    // Start for DataStoreMemory: '<Root>/Universal_Time15'
    DefaultExperiment_DW.BLACK_Saturated_Controls[1] =
      DefaultExperiment_P.Universal_Time15_InitialValue[1];

    // Start for DataStoreMemory: '<Root>/Universal_Time22'
    DefaultExperiment_DW.VIS_Measured_States[1] =
      DefaultExperiment_P.Universal_Time22_InitialValue[1];

    // Start for DataStoreMemory: '<Root>/Universal_Time13'
    DefaultExperiment_DW.BLUE_Desired_States[2] =
      DefaultExperiment_P.Universal_Time13_InitialValue[2];

    // Start for DataStoreMemory: '<Root>/Universal_Time15'
    DefaultExperiment_DW.BLACK_Saturated_Controls[2] =
      DefaultExperiment_P.Universal_Time15_InitialValue[2];

    // Start for DataStoreMemory: '<Root>/Universal_Time22'
    DefaultExperiment_DW.VIS_Measured_States[2] =
      DefaultExperiment_P.Universal_Time22_InitialValue[2];

    // Start for DataStoreMemory: '<Root>/Universal_Time24'
    for (i = 0; i < 6; i++) {
      DefaultExperiment_DW.ARM_Measured_States[i] =
        DefaultExperiment_P.Universal_Time24_InitialValue[i];
    }
    ...
    DefaultExperiment_DW.BLACK_Desired_States[0] =
      DefaultExperiment_P.Universal_Time25_InitialValue[0];
    DefaultExperiment_DW.BLACK_Desired_States[1] =
      DefaultExperiment_P.Universal_Time25_InitialValue[1];
    DefaultExperiment_DW.BLACK_Desired_States[2] =
      DefaultExperiment_P.Universal_Time25_InitialValue[2];

    // Start for DataStoreMemory: '<Root>/Universal_Time28'
    DefaultExperiment_DW.RED_Saturated_Controls[0] =
      DefaultExperiment_P.Universal_Time28_InitialValue[0];

    // Start for DataStoreMemory: '<Root>/Universal_Time29'
    DefaultExperiment_DW.RED_Desired_States[0] =
      DefaultExperiment_P.Universal_Time29_InitialValue[0];

    // Start for DataStoreMemory: '<Root>/Universal_Time31'
    DefaultExperiment_DW.RED_IMU_Measurements[0] =
      DefaultExperiment_P.Universal_Time31_InitialValue[0];

    // Start for DataStoreMemory: '<Root>/Universal_Time33'
    DefaultExperiment_DW.BLACK_IMU_Measurements[0] =
      DefaultExperiment_P.Universal_Time33_InitialValue[0];

    // Start for DataStoreMemory: '<Root>/Universal_Time34'
    DefaultExperiment_DW.BLUE_IMU_Measurements[0] =
      DefaultExperiment_P.Universal_Time34_InitialValue[0];

    // Start for DataStoreMemory: '<Root>/Universal_Time28'
    DefaultExperiment_DW.RED_Saturated_Controls[1] =
      DefaultExperiment_P.Universal_Time28_InitialValue[1];

    // Start for DataStoreMemory: '<Root>/Universal_Time29'
    DefaultExperiment_DW.RED_Desired_States[1] =
      DefaultExperiment_P.Universal_Time29_InitialValue[1];

    // Start for DataStoreMemory: '<Root>/Universal_Time31'
    DefaultExperiment_DW.RED_IMU_Measurements[1] =
      DefaultExperiment_P.Universal_Time31_InitialValue[1];

    // Start for DataStoreMemory: '<Root>/Universal_Time33'
    DefaultExperiment_DW.BLACK_IMU_Measurements[1] =
      DefaultExperiment_P.Universal_Time33_InitialValue[1];

    // Start for DataStoreMemory: '<Root>/Universal_Time34'
    DefaultExperiment_DW.BLUE_IMU_Measurements[1] =
      DefaultExperiment_P.Universal_Time34_InitialValue[1];

    // Start for DataStoreMemory: '<Root>/Universal_Time28'
    DefaultExperiment_DW.RED_Saturated_Controls[2] =
      DefaultExperiment_P.Universal_Time28_InitialValue[2];

    // Start for DataStoreMemory: '<Root>/Universal_Time29'
    DefaultExperiment_DW.RED_Desired_States[2] =
      DefaultExperiment_P.Universal_Time29_InitialValue[2];

    // Start for DataStoreMemory: '<Root>/Universal_Time31'
    DefaultExperiment_DW.RED_IMU_Measurements[2] =
      DefaultExperiment_P.Universal_Time31_InitialValue[2];

    // Start for DataStoreMemory: '<Root>/Universal_Time33'
    DefaultExperiment_DW.BLACK_IMU_Measurements[2] =
      DefaultExperiment_P.Universal_Time33_InitialValue[2];

    // Start for DataStoreMemory: '<Root>/Universal_Time34'
    DefaultExperiment_DW.BLUE_IMU_Measurements[2] =
      DefaultExperiment_P.Universal_Time34_InitialValue[2];

    // Start for DataStoreMemory: '<Root>/Universal_Time26'
    memcpy(&DefaultExperiment_DW.RED_Measured_States[0],
           &DefaultExperiment_P.Universal_Time26_InitialValue[0], 9U * sizeof
           (real_T));

    // Start for DataStoreMemory: '<Root>/Universal_Time4'
    memcpy(&DefaultExperiment_DW.BLUE_Measured_States[0],
           &DefaultExperiment_P.Universal_Time4_InitialValue[0], 9U * sizeof
           (real_T));

    // Start for DataStoreMemory: '<Root>/Universal_Time6'
    DefaultExperiment_DW.BLUE_Saturated_Controls[0] =
      DefaultExperiment_P.Universal_Time6_InitialValue[0];

    // Start for DataStoreMemory: '<Root>/Universal_Time8'
    DefaultExperiment_DW.ARM_Desired_States[0] =
      DefaultExperiment_P.Universal_Time8_InitialValue[0];

    // Start for DataStoreMemory: '<Root>/Universal_Time6'
    DefaultExperiment_DW.BLUE_Saturated_Controls[1] =
      DefaultExperiment_P.Universal_Time6_InitialValue[1];

    // Start for DataStoreMemory: '<Root>/Universal_Time8'
    DefaultExperiment_DW.ARM_Desired_States[1] =
      DefaultExperiment_P.Universal_Time8_InitialValue[1];

    // Start for DataStoreMemory: '<Root>/Universal_Time6'
    DefaultExperiment_DW.BLUE_Saturated_Controls[2] =
      DefaultExperiment_P.Universal_Time6_InitialValue[2];

    // Start for DataStoreMemory: '<Root>/Universal_Time8'
    DefaultExperiment_DW.ARM_Desired_States[2] =
      DefaultExperiment_P.Universal_Time8_InitialValue[2];

    // Start for DataStoreMemory: '<Root>/Universal_Time9'
    DefaultExperiment_DW.VIS_Confidence =
      DefaultExperiment_P.Universal_Time9_InitialValue;
    ...
    DefaultExperiment_DW.UD_DSTATE_eh =
      DefaultExperiment_P.DiscreteDerivative_ICPrevScal_p;
    ...
    DefaultExperiment_DW.UD_DSTATE_hv =
      DefaultExperiment_P.DiscreteDerivative1_ICPrevSca_m;
    ...
    DefaultExperiment_DW.UD_DSTATE_kv =
      DefaultExperiment_P.DiscreteDerivative2_ICPrevSca_a;
    ...
    DefaultExperiment_DW.UD_DSTATE_j =
      DefaultExperiment_P.DiscreteDerivative_ICPrevScal_d;
    ...
    DefaultExperiment_DW.UD_DSTATE_c =
      DefaultExperiment_P.DiscreteDerivative1_ICPrevSca_i;
    ...
    DefaultExperiment_DW.UD_DSTATE_d =
      DefaultExperiment_P.DiscreteDerivative2_ICPrevSc_oo;
    ...
    DefaultExperiment_DW.UD_DSTATE_o =
      DefaultExperiment_P.DiscreteDerivative_ICPrevSca_pf;
    ...
    DefaultExperiment_DW.UD_DSTATE_n =
      DefaultExperiment_P.DiscreteDerivative1_ICPrevSca_l;
    ...
    DefaultExperiment_DW.UD_DSTATE_hu =
      DefaultExperiment_P.DiscreteDerivative2_ICPrevSc_on;
    ...
    DefaultExperiment_DW.UD_DSTATE_l =
      DefaultExperiment_P.DiscreteDerivative_ICPrevScal_n;
    ...
    DefaultExperiment_DW.UD_DSTATE_k =
      DefaultExperiment_P.DiscreteDerivative1_ICPrevSca_f;
    ...
    DefaultExperiment_DW.UD_DSTATE_h =
      DefaultExperiment_P.DiscreteDerivative2_ICPrevSca_g;
    ...
    DefaultExperiment_DW.UD_DSTATE =
      DefaultExperiment_P.DiscreteDerivative1_ICPrevSca_j;
    ...
    DefaultExperiment_DW.UD_DSTATE_e =
      DefaultExperiment_P.DiscreteDerivative1_ICPrevSca_a;
    ...
    DefaultExperiment_DW.UD_DSTATE_a =
      DefaultExperiment_P.DiscreteDerivative1_ICPrevSca_k;
    ...
    DefaultExperiment_DW.UD_DSTATE_eg =
      DefaultExperiment_P.DiscreteDerivative_ICPrevScaled;
    ...
    DefaultExperiment_DW.UD_DSTATE_cd =
      DefaultExperiment_P.DiscreteDerivative1_ICPrevScale;
    ...
    DefaultExperiment_DW.UD_DSTATE_hd =
      DefaultExperiment_P.DiscreteDerivative2_ICPrevScale;
    ...
    DefaultExperiment_DW.UD_DSTATE_aq =
      DefaultExperiment_P.DiscreteDerivative_ICPrevScal_i;
    ...
    DefaultExperiment_DW.UD_DSTATE_p =
      DefaultExperiment_P.DiscreteDerivative1_ICPrevSca_e;
    ...
    DefaultExperiment_DW.UD_DSTATE_pr =
      DefaultExperiment_P.DiscreteDerivative2_ICPrevSca_o;

    // End of SystemInitialize for SubSystem: '<S3>/Default LQR Control (RED)'

    // SystemInitialize for Merge: '<S3>/Merge1'
    DefaultExperiment_B.Merge1[0] = DefaultExperiment_P.Merge1_InitialOutput;

    // SystemInitialize for Merge: '<S3>/Merge2'
    DefaultExperiment_B.Merge2[0] = DefaultExperiment_P.Merge2_InitialOutput;

    // SystemInitialize for Merge: '<S3>/Merge'
    DefaultExperiment_B.Merge[0] = DefaultExperiment_P.Merge_InitialOutput;

    // SystemInitialize for Merge: '<S3>/Merge1'
    DefaultExperiment_B.Merge1[1] = DefaultExperiment_P.Merge1_InitialOutput;

    // SystemInitialize for Merge: '<S3>/Merge2'
    DefaultExperiment_B.Merge2[1] = DefaultExperiment_P.Merge2_InitialOutput;

    // SystemInitialize for Merge: '<S3>/Merge'
    DefaultExperiment_B.Merge[1] = DefaultExperiment_P.Merge_InitialOutput;

    // SystemInitialize for Merge: '<S3>/Merge1'
    DefaultExperiment_B.Merge1[2] = DefaultExperiment_P.Merge1_InitialOutput;

    // SystemInitialize for Merge: '<S3>/Merge2'
    DefaultExperiment_B.Merge2[2] = DefaultExperiment_P.Merge2_InitialOutput;

    // SystemInitialize for Merge: '<S3>/Merge'
    DefaultExperiment_B.Merge[2] = DefaultExperiment_P.Merge_InitialOutput;

    // SystemInitialize for IfAction SubSystem: '<S16>/Change RED Behavior'
    // InitializeConditions for Delay: '<S257>/Delay'
    DefaultExperiment_DW.Delay_DSTATE =
      DefaultExperiment_P.Delay_InitialCondition_p;
    ...
    DefaultExperiment_B.In1 = DefaultExperiment_P.Out1_Y0_c;
    ...
    for (i = 0; i < 8; i++) {
      ...
      DefaultExperiment_B.ThrustPer_Final[i] = DefaultExperiment_P.Out1_Y0_d;
    }

    // End of SystemInitialize for SubSystem: '<S257>/Enabled Subsystem1'
    DefaultExpe_Pseudoinverse1_Init(&DefaultExperiment_DW.Pseudoinverse1_pn);
    ...
    DefaultExperiment_DW.Delay_DSTATE_kz =
      DefaultExperiment_P.Delay_InitialCondition_i;
    ...
    DefaultExperiment_B.In1_g2 = DefaultExperiment_P.Out1_Y0;
    ...
    for (i = 0; i < 8; i++) {
      ...
      DefaultExperiment_B.duty_cycles[i] = DefaultExperiment_P.REDDC_Y0;

      // SystemInitialize for SignalConversion generated from: '<S239>/ThrustPer_Final' incorporates:
      //   Outport: '<S239>/Out1'

      DefaultExperiment_B.ThrustPer_Final_h5[i] = DefaultExperiment_P.Out1_Y0_j;
    }

    // End of SystemInitialize for SubSystem: '<S16>/Change RED Behavior'
    // End of SystemInitialize for SubSystem: '<S233>/Enabled Subsystem1'
    DefaultExpe_Pseudoinverse1_Init(&DefaultExperiment_DW.Pseudoinverse1);
    ...
    DefaultExperiment_DW.Delay_DSTATE_k =
      DefaultExperiment_P.Delay_InitialCondition_n;
    ...
    DefaultExperiment_B.In1_g = DefaultExperiment_P.Out1_Y0_n;
    ...
    for (i = 0; i < 8; i++) {
      ...
      DefaultExperiment_B.duty_cycles_m[i] = DefaultExperiment_P.BLACKDC_Y0;

      // SystemInitialize for SignalConversion generated from: '<S251>/ThrustPer_Final' incorporates:
      //   Outport: '<S251>/Out1'

      DefaultExperiment_B.ThrustPer_Final_h[i] = DefaultExperiment_P.Out1_Y0_js;
    }

    // End of SystemInitialize for SubSystem: '<S16>/Change BLACK Behavior'
    // End of SystemInitialize for SubSystem: '<S245>/Enabled Subsystem1'
    DefaultExpe_Pseudoinverse1_Init(&DefaultExperiment_DW.Pseudoinverse1_p);

    // SystemInitialize for Outport: '<S229>/BLUE DC'
    for (i = 0; i < 8; i++) {
      DefaultExperiment_B.duty_cycles_j[i] = DefaultExperiment_P.BLUEDC_Y0;
    }
    ...
    Defaul_ChangeBLACKBehavior_Init(DefaultExperiment_M,
      &DefaultExperiment_DW.ChangeBLACKBehavior,
      &DefaultExperiment_P.ChangeBLACKBehavior);
    ...
    sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPSend1_NetworkLib[0U]);
    CreateUDPInterface(&DefaultExperiment_DW.UDPSend1_NetworkLib[0U]);
    if (*sErr == 0) {
      LibCreate_Network(&DefaultExperiment_DW.UDPSend1_NetworkLib[0U], 1,
                        "0.0.0.0", -1, "255.255.255.255",
                        DefaultExperiment_P.UDPSend1_Port, 8192, 1, 0);
    }

    if (*sErr == 0) {
      LibStart(&DefaultExperiment_DW.UDPSend1_NetworkLib[0U]);
    }

    if (*sErr != 0) {
      DestroyUDPInterface(&DefaultExperiment_DW.UDPSend1_NetworkLib[0U]);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
      }
    ...
    sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPSend2_NetworkLib[0U]);
    CreateUDPInterface(&DefaultExperiment_DW.UDPSend2_NetworkLib[0U]);
    if (*sErr == 0) {
      LibCreate_Network(&DefaultExperiment_DW.UDPSend2_NetworkLib[0U], 1,
                        "0.0.0.0", -1, "255.255.255.255",
                        DefaultExperiment_P.UDPSend2_Port, 8192, 1, 0);
    }

    if (*sErr == 0) {
      LibStart(&DefaultExperiment_DW.UDPSend2_NetworkLib[0U]);
    }

    if (*sErr != 0) {
      DestroyUDPInterface(&DefaultExperiment_DW.UDPSend2_NetworkLib[0U]);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
      }
    ...
    sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPSend3_NetworkLib[0U]);
    CreateUDPInterface(&DefaultExperiment_DW.UDPSend3_NetworkLib[0U]);
    if (*sErr == 0) {
      LibCreate_Network(&DefaultExperiment_DW.UDPSend3_NetworkLib[0U], 1,
                        "0.0.0.0", -1, "255.255.255.255",
                        DefaultExperiment_P.UDPSend3_Port, 8192, 1, 0);
    }

    if (*sErr == 0) {
      LibStart(&DefaultExperiment_DW.UDPSend3_NetworkLib[0U]);
    }

    if (*sErr != 0) {
      DestroyUDPInterface(&DefaultExperiment_DW.UDPSend3_NetworkLib[0U]);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
      }
    ...
    DefaultExperiment_DW.obj_l.matlabCodegenIsDeleted = false;
    DefaultExperiment_DW.obj_l.gpioPin = DefaultExperiment_P.GPIOWrite1_gpioPin;
    DefaultExperiment_DW.obj_l.pinDirection =
      DefaultExperiment_P.GPIOWrite1_pinDirection;
    DefaultExperiment_DW.obj_l.isInitialized = 1;

    //         %% Define input properties
    //  Call C-function implementing device initialization
    export_gpio(DefaultExperiment_DW.obj_l.gpioPin);
    set_pin_direction(DefaultExperiment_DW.obj_l.gpioPin,
                      DefaultExperiment_DW.obj_l.pinDirection);
    DefaultExperiment_DW.obj_l.isSetupComplete = true;

    // End of SystemInitialize for SubSystem: '<S7>/Enable Pucks'

    // SystemInitialize for IfAction SubSystem: '<S8>/Log Gyro//Accel'
    // Start for MATLABSystem: '<S177>/Gyroscope//Accelerometer'
    DefaultExperiment_DW.obj._pobj2.matlabCodegenIsDeleted = true;
    DefaultExperiment_DW.obj.isInitialized = 0;
    DefaultExperiment_DW.obj.matlabCodegenIsDeleted = false;
    DefaultExperiment_DW.obj.SampleTime =
      DefaultExperiment_P.GyroscopeAccelerometer_SampleTi;
    DefaultExperim_SystemCore_setup(&DefaultExperiment_DW.obj);
    ...
    DefaultExperiment_DW.Delay_DSTATE_o =
      DefaultExperiment_P.Delay_InitialCondition;

    // InitializeConditions for Delay: '<S179>/Delay1'
    DefaultExperiment_DW.Delay1_DSTATE_cg =
      DefaultExperiment_P.Delay1_InitialCondition;

    // InitializeConditions for Delay: '<S179>/Delay2'
    DefaultExperiment_DW.Delay2_DSTATE_h =
      DefaultExperiment_P.Delay2_InitialCondition;

    // Start for MATLABSystem: '<S179>/Read Joint Positions using  Dynamixel Encoders' 
    DefaultExperiment_DW.obj_d.matlabCodegenIsDeleted = false;
    if (((!rtIsInf(DefaultExperiment_P.baseRate)) && (!rtIsNaN
          (DefaultExperiment_P.baseRate))) || rtIsInf
        (DefaultExperiment_P.baseRate)) {
      sampleTime = DefaultExperiment_P.baseRate;
    ...
    DefaultExperiment_DW.obj_d.SampleTime = sampleTime;
    DefaultExperiment_DW.obj_d.isInitialized = 1;

    //         %% Define input properties
    //  Call C-function implementing device initialization
    DefaultExperiment_DW.obj_d.isSetupComplete = true;
    ...
    sErr = GetErrorBuffer(&DefaultExperiment_DW.ReceivePhaseSpaceData_NetworkLi
                          [0U]);
    CreateUDPInterface(&DefaultExperiment_DW.ReceivePhaseSpaceData_NetworkLi[0U]);
    if (*sErr == 0) {
      LibCreate_Network(&DefaultExperiment_DW.ReceivePhaseSpaceData_NetworkLi[0U],
                        0, "0.0.0.0",
                        DefaultExperiment_P.ReceivePhaseSpaceData_Port,
                        "0.0.0.0", -1, 8192, 8, 0);
    }

    if (*sErr == 0) {
      LibStart(&DefaultExperiment_DW.ReceivePhaseSpaceData_NetworkLi[0U]);
    }

    if (*sErr != 0) {
      DestroyUDPInterface(&DefaultExperiment_DW.ReceivePhaseSpaceData_NetworkLi
                          [0U]);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
    ...
    sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPReceiveREDClock_NetworkLib[0U]);
    CreateUDPInterface(&DefaultExperiment_DW.UDPReceiveREDClock_NetworkLib[0U]);
    if (*sErr == 0) {
      LibCreate_Network(&DefaultExperiment_DW.UDPReceiveREDClock_NetworkLib[0U],
                        0, "0.0.0.0",
                        DefaultExperiment_P.UDPReceiveREDClock_Port, "0.0.0.0",
                        -1, 8192, 8, 0);
    }

    if (*sErr == 0) {
      LibStart(&DefaultExperiment_DW.UDPReceiveREDClock_NetworkLib[0U]);
    }

    if (*sErr != 0) {
      DestroyUDPInterface(&DefaultExperiment_DW.UDPReceiveREDClock_NetworkLib[0U]);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
      }
    ...
    sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPReceiveBLACKClock_NetworkLib
                          [0U]);
    CreateUDPInterface(&DefaultExperiment_DW.UDPReceiveBLACKClock_NetworkLib[0U]);
    if (*sErr == 0) {
      LibCreate_Network(&DefaultExperiment_DW.UDPReceiveBLACKClock_NetworkLib[0U],
                        0, "0.0.0.0",
                        DefaultExperiment_P.UDPReceiveBLACKClock_Port, "0.0.0.0",
                        -1, 8192, 8, 0);
    }

    if (*sErr == 0) {
      LibStart(&DefaultExperiment_DW.UDPReceiveBLACKClock_NetworkLib[0U]);
    }

    if (*sErr != 0) {
      DestroyUDPInterface(&DefaultExperiment_DW.UDPReceiveBLACKClock_NetworkLib
                          [0U]);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
    ...
    sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPReceiveBLUEClock_NetworkLib
                          [0U]);
    CreateUDPInterface(&DefaultExperiment_DW.UDPReceiveBLUEClock_NetworkLib[0U]);
    if (*sErr == 0) {
      LibCreate_Network(&DefaultExperiment_DW.UDPReceiveBLUEClock_NetworkLib[0U],
                        0, "0.0.0.0",
                        DefaultExperiment_P.UDPReceiveBLUEClock_Port, "0.0.0.0",
                        -1, 8192, 8, 0);
    }

    if (*sErr == 0) {
      LibStart(&DefaultExperiment_DW.UDPReceiveBLUEClock_NetworkLib[0U]);
    }

    if (*sErr != 0) {
      DestroyUDPInterface(&DefaultExperiment_DW.UDPReceiveBLUEClock_NetworkLib
                          [0U]);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
    ...
    DefaultExperiment_DW.Delay2_DSTATE =
      DefaultExperiment_P.Delay2_InitialCondition_e;

    // InitializeConditions for Delay: '<S194>/Delay1'
    DefaultExperiment_DW.Delay1_DSTATE =
      DefaultExperiment_P.Delay1_InitialCondition_m;

    // InitializeConditions for Delay: '<S204>/Delay2'
    DefaultExperiment_DW.Delay2_DSTATE_l =
      DefaultExperiment_P.Delay2_InitialCondition_a;

    // InitializeConditions for Delay: '<S204>/Delay1'
    DefaultExperiment_DW.Delay1_DSTATE_l =
      DefaultExperiment_P.Delay1_InitialCondition_i3;

    // InitializeConditions for Delay: '<S214>/Delay2'
    DefaultExperiment_DW.Delay2_DSTATE_l0 =
      DefaultExperiment_P.Delay2_InitialCondition_m;

    // InitializeConditions for Delay: '<S214>/Delay1'
    DefaultExperiment_DW.Delay1_DSTATE_ld =
      DefaultExperiment_P.Delay1_InitialCondition_l;

    // InitializeConditions for Delay: '<S196>/Delay1'
    DefaultExperiment_DW.Delay1_DSTATE_g[0] =
      DefaultExperiment_P.Delay1_InitialCondition_i;

    // InitializeConditions for Delay: '<S195>/Delay1'
    DefaultExperiment_DW.Delay1_DSTATE_b[0] =
      DefaultExperiment_P.Delay1_InitialCondition_it;

    // InitializeConditions for Delay: '<S206>/Delay1'
    DefaultExperiment_DW.Delay1_DSTATE_m[0] =
      DefaultExperiment_P.Delay1_InitialCondition_h;

    // InitializeConditions for Delay: '<S205>/Delay1'
    DefaultExperiment_DW.Delay1_DSTATE_lv[0] =
      DefaultExperiment_P.Delay1_InitialCondition_j;

    // InitializeConditions for Delay: '<S216>/Delay1'
    DefaultExperiment_DW.Delay1_DSTATE_c[0] =
      DefaultExperiment_P.Delay1_InitialCondition_k;

    // InitializeConditions for Delay: '<S215>/Delay1'
    DefaultExperiment_DW.Delay1_DSTATE_cq[0] =
      DefaultExperiment_P.Delay1_InitialCondition_c;
    ...
    DefaultExperiment_B.y2y1_ob = DefaultExperiment_P.dytdt_Y0;
    ...
    Default_EnabledSubsystem_e_Init(DefaultExperiment_B.dy_p,
      &DefaultExperiment_DW.EnabledSubsystem_g,
      &DefaultExperiment_P.EnabledSubsystem_g);
    ...
    DefaultEx_EnabledSubsystem_Init(DefaultExperiment_B.dy_g,
      &DefaultExperiment_DW.EnabledSubsystem,
      &DefaultExperiment_P.EnabledSubsystem);
    ...
    DefaultExperiment_B.y2y1_o = DefaultExperiment_P.dytdt_Y0_j;
    ...
    Default_EnabledSubsystem_e_Init(DefaultExperiment_B.dy_c,
      &DefaultExperiment_DW.EnabledSubsystem_d,
      &DefaultExperiment_P.EnabledSubsystem_d);
    ...
    DefaultEx_EnabledSubsystem_Init(DefaultExperiment_B.dy_d,
      &DefaultExperiment_DW.EnabledSubsystem_l,
      &DefaultExperiment_P.EnabledSubsystem_l);
    ...
    DefaultExperiment_B.y2y1 = DefaultExperiment_P.dytdt_Y0_d;
    ...
    Default_EnabledSubsystem_e_Init(DefaultExperiment_B.dy,
      &DefaultExperiment_DW.EnabledSubsystem_l1,
      &DefaultExperiment_P.EnabledSubsystem_l1);
    ...
    DefaultEx_EnabledSubsystem_Init(DefaultExperiment_B.dy_h,
      &DefaultExperiment_DW.EnabledSubsystem_k,
      &DefaultExperiment_P.EnabledSubsystem_k);
    ...
    DefaultExperiment_B.In1_g20 = DefaultExperiment_P.UniversalTime_Y0;
    ...
    Defa_ChangeBLACKBehavior_j_Init(DefaultExperiment_M,
      &DefaultExperiment_DW.ChangeBLACKBehavior_e,
      &DefaultExperiment_P.ChangeBLACKBehavior_e);
    ...
    Defa_ChangeBLACKBehavior_j_Init(DefaultExperiment_M,
      &DefaultExperiment_DW.ChangeBLUEBehavior_f,
      &DefaultExperiment_P.ChangeBLUEBehavior_f);
    ...
    Defa_ChangeBLACKBehavior_j_Init(DefaultExperiment_M,
      &DefaultExperiment_DW.ChangeREDBehavior_d,
      &DefaultExperiment_P.ChangeREDBehavior_d);
    ...
    //  Constructor
    //  Support name-value pair arguments when constructing the object.
    DefaultExperiment_DW.obj_dk.matlabCodegenIsDeleted = false;
    if (((!rtIsInf(DefaultExperiment_P.baseRate)) && (!rtIsNaN
          (DefaultExperiment_P.baseRate))) || rtIsInf
        (DefaultExperiment_P.baseRate)) {
      sampleTime_0 = DefaultExperiment_P.baseRate;
    ...
    DefaultExperiment_DW.obj_dk.SampleTime = sampleTime_0;
    DefaultExperiment_DW.obj_dk.isInitialized = 1;

    //         %% Define output properties
    //  Call C-function implementing device initialization
    DefaultExperiment_DW.obj_dk.isSetupComplete = true;
    ...
    sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPReceive_NetworkLib[0U]);
    CreateUDPInterface(&DefaultExperiment_DW.UDPReceive_NetworkLib[0U]);
    if (*sErr == 0) {
      LibCreate_Network(&DefaultExperiment_DW.UDPReceive_NetworkLib[0U], 0,
                        "0.0.0.0", DefaultExperiment_P.UDPReceive_Port,
                        "0.0.0.0", -1, 8192, 4, 0);
    }

    if (*sErr == 0) {
      LibStart(&DefaultExperiment_DW.UDPReceive_NetworkLib[0U]);
    }

    if (*sErr != 0) {
      DestroyUDPInterface(&DefaultExperiment_DW.UDPReceive_NetworkLib[0U]);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
      }
    ...
    //  Constructor
    //  Support name-value pair arguments when constructing the object.
    DefaultExperiment_DW.obj_n.matlabCodegenIsDeleted = false;
    DefaultExperiment_DW.obj_n.POSITION_P_GAIN =
      DefaultExperiment_P.ControlDynamixelActuatorsineith;
    DefaultExperiment_DW.obj_n.POSITION_I_GAIN =
      DefaultExperiment_P.ControlDynamixelActuatorsinei_b;
    ...
    DefaultExperiment_DW.obj_n.SampleTime = sampleTime_1;
    DefaultExperiment_DW.obj_n.isInitialized = 1;

    //         %% Define input properties
    initialize_dynamixel();
    DefaultExperiment_DW.obj_n.isSetupComplete = true;
    ...
    sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPSend_NetworkLib_m[0U]);
    CreateUDPInterface(&DefaultExperiment_DW.UDPSend_NetworkLib_m[0U]);
    if (*sErr == 0) {
      LibCreate_Network(&DefaultExperiment_DW.UDPSend_NetworkLib_m[0U], 1,
                        "0.0.0.0", -1, "192.168.1.115",
                        DefaultExperiment_P.UDPSend_Port, 8192, 8, 0);
    }

    if (*sErr == 0) {
      LibStart(&DefaultExperiment_DW.UDPSend_NetworkLib_m[0U]);
    }

    if (*sErr != 0) {
      DestroyUDPInterface(&DefaultExperiment_DW.UDPSend_NetworkLib_m[0U]);
      if (*sErr != 0) {
        DefaultExperiment_M->setErrorStatus(sErr);
        DefaultExperiment_M->setStopRequested(1);
      }
    ...
    Defa_ChangeBLACKBehavior_a_Init(DefaultExperiment_M,
      &DefaultExperiment_DW.ChangeBLACKBehavior_i,
      &DefaultExperiment_P.ChangeBLACKBehavior_i);
    ...
    Defa_ChangeBLACKBehavior_a_Init(DefaultExperiment_M,
      &DefaultExperiment_DW.ChangeBLUEBehavior_e,
      &DefaultExperiment_P.ChangeBLUEBehavior_e);
    ...
    Defa_ChangeBLACKBehavior_a_Init(DefaultExperiment_M,
      &DefaultExperiment_DW.ChangeREDBehavior_h,
      &DefaultExperiment_P.ChangeREDBehavior_h);
    ...
    //  Constructor
    //  Support name-value pair arguments when constructing the object.
    DefaultExperiment_DW.obj_f.matlabCodegenIsDeleted = false;
    DefaultExperiment_DW.obj_f.isInitialized = 1;

    //         %% Define input properties
    //  Call C-function implementing device initialization
    createFile();
    DefaultExperiment_DW.obj_f.isSetupComplete = true;
  }
}

// Model terminate function
void DefaultExperiment_terminate(void)
{
  char_T *sErr;

  // Terminate for S-Function (sdspToNetwork): '<S16>/UDP Send'
  sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPSend_NetworkLib[0U]);
  LibTerminate(&DefaultExperiment_DW.UDPSend_NetworkLib[0U]);
  if (*sErr != 0) {
    DefaultExperiment_M->setErrorStatus(sErr);
    DefaultExperiment_M->setStopRequested(1);
  }

  LibDestroy(&DefaultExperiment_DW.UDPSend_NetworkLib[0U], 1);
  DestroyUDPInterface(&DefaultExperiment_DW.UDPSend_NetworkLib[0U]);

  // End of Terminate for S-Function (sdspToNetwork): '<S16>/UDP Send'

  // Terminate for IfAction SubSystem: '<S4>/Change BLACK Behavior'
  Defaul_ChangeBLACKBehavior_Term(DefaultExperiment_M,
    &DefaultExperiment_DW.ChangeBLACKBehavior);
  ...
  if (!DefaultExperiment_DW.obj_f.matlabCodegenIsDeleted) {
    DefaultExperiment_DW.obj_f.matlabCodegenIsDeleted = true;
  }
  ...
  sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPSend1_NetworkLib[0U]);
  LibTerminate(&DefaultExperiment_DW.UDPSend1_NetworkLib[0U]);
  if (*sErr != 0) {
    DefaultExperiment_M->setErrorStatus(sErr);
    DefaultExperiment_M->setStopRequested(1);
  }

  LibDestroy(&DefaultExperiment_DW.UDPSend1_NetworkLib[0U], 1);
  DestroyUDPInterface(&DefaultExperiment_DW.UDPSend1_NetworkLib[0U]);
  ...
  sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPSend2_NetworkLib[0U]);
  LibTerminate(&DefaultExperiment_DW.UDPSend2_NetworkLib[0U]);
  if (*sErr != 0) {
    DefaultExperiment_M->setErrorStatus(sErr);
    DefaultExperiment_M->setStopRequested(1);
  }

  LibDestroy(&DefaultExperiment_DW.UDPSend2_NetworkLib[0U], 1);
  DestroyUDPInterface(&DefaultExperiment_DW.UDPSend2_NetworkLib[0U]);
  ...
  sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPSend3_NetworkLib[0U]);
  LibTerminate(&DefaultExperiment_DW.UDPSend3_NetworkLib[0U]);
  if (*sErr != 0) {
    DefaultExperiment_M->setErrorStatus(sErr);
    DefaultExperiment_M->setStopRequested(1);
  }

  LibDestroy(&DefaultExperiment_DW.UDPSend3_NetworkLib[0U], 1);
  DestroyUDPInterface(&DefaultExperiment_DW.UDPSend3_NetworkLib[0U]);
  ...
  if (!DefaultExperiment_DW.obj_l.matlabCodegenIsDeleted) {
    DefaultExperiment_DW.obj_l.matlabCodegenIsDeleted = true;
    if ((DefaultExperiment_DW.obj_l.isInitialized == 1) &&
        DefaultExperiment_DW.obj_l.isSetupComplete) {
      //  Call C-function implementing device termination
      change_gpio_value(DefaultExperiment_DW.obj_l.gpioPin, 0.0);
      unexport_gpio(DefaultExperiment_DW.obj_l.gpioPin);
    }
  }
  ...
  if (!DefaultExperiment_DW.obj.matlabCodegenIsDeleted) {
    DefaultExperiment_DW.obj.matlabCodegenIsDeleted = true;
  }

  if (!DefaultExperiment_DW.obj._pobj2.matlabCodegenIsDeleted) {
    DefaultExperiment_DW.obj._pobj2.matlabCodegenIsDeleted = true;
    if (DefaultExperiment_DW.obj._pobj2.isInitialized == 1) {
      DefaultExperiment_DW.obj._pobj2.isInitialized = 2;
    }
  }
  ...
  if (!DefaultExperiment_DW.obj_d.matlabCodegenIsDeleted) {
    DefaultExperiment_DW.obj_d.matlabCodegenIsDeleted = true;
  }
  ...
  sErr = GetErrorBuffer(&DefaultExperiment_DW.ReceivePhaseSpaceData_NetworkLi[0U]);
  LibTerminate(&DefaultExperiment_DW.ReceivePhaseSpaceData_NetworkLi[0U]);
  if (*sErr != 0) {
    DefaultExperiment_M->setErrorStatus(sErr);
    DefaultExperiment_M->setStopRequested(1);
  }

  LibDestroy(&DefaultExperiment_DW.ReceivePhaseSpaceData_NetworkLi[0U], 0);
  DestroyUDPInterface(&DefaultExperiment_DW.ReceivePhaseSpaceData_NetworkLi[0U]);
  ...
  sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPReceiveREDClock_NetworkLib[0U]);
  LibTerminate(&DefaultExperiment_DW.UDPReceiveREDClock_NetworkLib[0U]);
  if (*sErr != 0) {
    DefaultExperiment_M->setErrorStatus(sErr);
    DefaultExperiment_M->setStopRequested(1);
  }

  LibDestroy(&DefaultExperiment_DW.UDPReceiveREDClock_NetworkLib[0U], 0);
  DestroyUDPInterface(&DefaultExperiment_DW.UDPReceiveREDClock_NetworkLib[0U]);
  ...
  sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPReceiveBLACKClock_NetworkLib[0U]);
  LibTerminate(&DefaultExperiment_DW.UDPReceiveBLACKClock_NetworkLib[0U]);
  if (*sErr != 0) {
    DefaultExperiment_M->setErrorStatus(sErr);
    DefaultExperiment_M->setStopRequested(1);
  }

  LibDestroy(&DefaultExperiment_DW.UDPReceiveBLACKClock_NetworkLib[0U], 0);
  DestroyUDPInterface(&DefaultExperiment_DW.UDPReceiveBLACKClock_NetworkLib[0U]);
  ...
  sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPReceiveBLUEClock_NetworkLib[0U]);
  LibTerminate(&DefaultExperiment_DW.UDPReceiveBLUEClock_NetworkLib[0U]);
  if (*sErr != 0) {
    DefaultExperiment_M->setErrorStatus(sErr);
    DefaultExperiment_M->setStopRequested(1);
  }

  LibDestroy(&DefaultExperiment_DW.UDPReceiveBLUEClock_NetworkLib[0U], 0);
  DestroyUDPInterface(&DefaultExperiment_DW.UDPReceiveBLUEClock_NetworkLib[0U]);
  ...
  Defa_ChangeBLACKBehavior_h_Term(DefaultExperiment_M,
    &DefaultExperiment_DW.ChangeBLACKBehavior_e);
  ...
  if (!DefaultExperiment_DW.obj_dk.matlabCodegenIsDeleted) {
    DefaultExperiment_DW.obj_dk.matlabCodegenIsDeleted = true;
  }
  ...
  sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPReceive_NetworkLib[0U]);
  LibTerminate(&DefaultExperiment_DW.UDPReceive_NetworkLib[0U]);
  if (*sErr != 0) {
    DefaultExperiment_M->setErrorStatus(sErr);
    DefaultExperiment_M->setStopRequested(1);
  }

  LibDestroy(&DefaultExperiment_DW.UDPReceive_NetworkLib[0U], 0);
  DestroyUDPInterface(&DefaultExperiment_DW.UDPReceive_NetworkLib[0U]);
  ...
  if (!DefaultExperiment_DW.obj_n.matlabCodegenIsDeleted) {
    DefaultExperiment_DW.obj_n.matlabCodegenIsDeleted = true;
    if ((DefaultExperiment_DW.obj_n.isInitialized == 1) &&
        DefaultExperiment_DW.obj_n.isSetupComplete) {
      terminate_dynamixel();
    }
  }
  ...
  sErr = GetErrorBuffer(&DefaultExperiment_DW.UDPSend_NetworkLib_m[0U]);
  LibTerminate(&DefaultExperiment_DW.UDPSend_NetworkLib_m[0U]);
  if (*sErr != 0) {
    DefaultExperiment_M->setErrorStatus(sErr);
    DefaultExperiment_M->setStopRequested(1);
  }

  LibDestroy(&DefaultExperiment_DW.UDPSend_NetworkLib_m[0U], 1);
  DestroyUDPInterface(&DefaultExperiment_DW.UDPSend_NetworkLib_m[0U]);
  ...
  Defa_ChangeBLACKBehavior_l_Term(DefaultExperiment_M,
    &DefaultExperiment_DW.ChangeBLACKBehavior_i);
...
time_T** RT_MODEL_DefaultExperiment_T::getTPtrPtr()
{
  return &(Timing.t);
}

boolean_T RT_MODEL_DefaultExperiment_T::getStopRequested() const
{
  return (Timing.stopRequestedFlag);
}

void RT_MODEL_DefaultExperiment_T::setStopRequested(boolean_T aStopRequested)
{
  (Timing.stopRequestedFlag = aStopRequested);
}

const char_T* RT_MODEL_DefaultExperiment_T::getErrorStatus() const
{
  return (errorStatus);
}

void RT_MODEL_DefaultExperiment_T::setErrorStatus(const char_T* const
  aErrorStatus)
{
  (errorStatus = aErrorStatus);
}

time_T* RT_MODEL_DefaultExperiment_T::getTPtr() const
{
  return (Timing.t);
}

void RT_MODEL_DefaultExperiment_T::setTPtr(time_T* aTPtr)
{
  (Timing.t = aTPtr);
}

boolean_T* RT_MODEL_DefaultExperiment_T::getStopRequestedPtr()
{
  return (&(Timing.stopRequestedFlag));
}

const char_T** RT_MODEL_DefaultExperiment_T::getErrorStatusPtr()
{
  return &errorStatus;
}

boolean_T RT_MODEL_DefaultExperiment_T::isMajorTimeStep() const
{
  return ((Timing.simTimeStep) == MAJOR_TIME_STEP);
}

boolean_T RT_MODEL_DefaultExperiment_T::isMinorTimeStep() const
{
